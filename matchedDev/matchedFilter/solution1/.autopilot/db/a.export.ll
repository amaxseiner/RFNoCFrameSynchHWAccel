; ModuleID = '/home/ece492fa18/RFNoCFrameSynchHWAccel/matchedDev/matchedFilter/solution1/.autopilot/db/a.o.2.bc'
...
@averaging_str = internal unnamed_addr constant [10 x i8] c"averaging\00"
...
; <label>:0                                       ; preds = %.preheader171.preheader
  %tmp_1 = call i1 @_ssdm_op_BitSelect.i1.i24.i32(i24 %p_Val2_s, i32 11)
  br i1 %tmp_1, label %1, label %._crit_edge197
...
; <label>:2                                       ; preds = %.preheader171.preheader
  %data_reg_q_V_load = load i16* getelementptr inbounds ([16 x i16]* @data_reg_q_V, i64 0, i64 11), align 2
  %p_Result_3 = call i32 @_ssdm_op_BitConcatenate.i32.i16.i16(i16 %data_reg_i_V_11_load, i16 %data_reg_q_V_load)
  call void @_ssdm_op_Write.axis.volatile.i32P.i1P(i32* %o_data_V_data_V, i1* %o_data_V_last_V, i32 %p_Result_3, i1 undef)
  br label %._crit_edge196

._crit_edge196:                                   ; preds = %2, %._crit_edge197
  %tmp_2 = trunc i24 %p_Val2_s to i23
  %p_Result_4 = call i24 @llvm.part.set.i24.i23(i24 %p_Val2_s, i23 %tmp_2, i32 1, i32 23)
...
; <label>:3                                       ; preds = %._crit_edge196
  br i1 %start_V_read, label %4, label %._crit_edge199
...
.preheader.0:                                     ; preds = %6
  %data_reg_i_V_14_load = load i16* @data_reg_i_V_14, align 4
  ...
  %data_reg_i_V_12_load = load i16* @data_reg_i_V_12, align 8
  ...
  %data_reg_i_V_10_load = load i16* @data_reg_i_V_10, align 4
  ...
  %data_reg_i_V_8_load = load i16* @data_reg_i_V_8, align 16
  ...
  %data_reg_i_V_6_load = load i16* @data_reg_i_V_6, align 4
  ...
  %data_reg_i_V_4_load = load i16* @data_reg_i_V_4, align 8
  ...
  %data_reg_i_V_2_load = load i16* @data_reg_i_V_2, align 4
  ...
  %data_reg_i_V_0_load = load i16* @data_reg_i_V_0, align 16
...
.loopexit:                                        ; preds = %.preheader.0, %6
  ...
  %tmp_4 = trunc i32 %tmp_data_V to i16
  store i16 %tmp_4, i16* getelementptr inbounds ([16 x i16]* @data_reg_q_V, i64 0, i64 0), align 16
  %p_Result_2 = call i16 @_ssdm_op_PartSelect.i16.i32.i32.i32(i32 %tmp_data_V, i32 16, i32 31)
  store i16 %p_Result_2, i16* @data_reg_i_V_0, align 16
  %p_Result_1 = call i24 @_ssdm_op_BitConcatenate.i24.i23.i1(i23 %tmp_2, i1 true)
...
mergeST:                                          ; preds = %7, %.loopexit, %._crit_edge199
  %data_valid_reg_V_new_1 = phi i24 [ %p_Result_4, %._crit_edge199 ], [ %p_Result_1, %.loopexit ], [ %p_Result_s, %7 ]
...
entry:
  ...
  %empty_13 = zext i16 %1 to i32
  %empty_14 = shl i32 %empty, 16
...
entry:
  ...
  %empty_16 = zext i1 %1 to i24
  %empty_17 = shl i24 %empty, 1
