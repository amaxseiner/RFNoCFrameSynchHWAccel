; ModuleID = '/home/alex/Documents/RFNoCFrameSynchHWAccel/CorrelatorPreamble/solution1/.autopilot/db/a.o.2.bc'
...
.preheader.0:                                     ; preds = %0
  ...
  %tmp1 = add i16 %cor_phaseClass15i_V_19, %cor_phaseClass15i_V_18
  %tmp2 = add i16 %cor_phaseClass15i_V_20, %cor_phaseClass15i_V_21
  %tmp = add i16 %tmp2, %tmp1
  %tmp4 = add i16 %cor_phaseClass15i_V_23, %cor_phaseClass15i_V_25
  %tmp5 = add i16 %cor_phaseClass15i_V_26, %cor_phaseClass15i_V_28
  %tmp3 = add i16 %tmp5, %tmp4
  %corHelperIPos_V_15_2 = add i16 %tmp3, %tmp
  %cor_phaseClass15q_V_28 = load i16* @cor_phaseClass15q_V_1, align 2
  %tmp7 = add i16 %cor_phaseClass15q_V_19, %cor_phaseClass15q_V_18
  %tmp8 = add i16 %cor_phaseClass15q_V_20, %cor_phaseClass15q_V_21
  %tmp6 = add i16 %tmp8, %tmp7
  %tmp10 = add i16 %cor_phaseClass15q_V_23, %cor_phaseClass15q_V_25
  %tmp11 = add i16 %cor_phaseClass15q_V_26, %cor_phaseClass15q_V_28
  %tmp9 = add i16 %tmp11, %tmp10
  %corHelperQPos_V_15_2 = add i16 %tmp9, %tmp6
  %cor_phaseClass15i_V_29 = load i16* @cor_phaseClass15i_V_s, align 16
  %tmp13 = add i16 %cor_phaseClass15i_V_15, %cor_phaseClass15i_V_s
  %tmp14 = add i16 %cor_phaseClass15i_V_16, %cor_phaseClass15i_V_17
  %tmp12 = add i16 %tmp14, %tmp13
  %tmp16 = add i16 %cor_phaseClass15i_V_22, %cor_phaseClass15i_V_24
  %tmp17 = add i16 %cor_phaseClass15i_V_27, %cor_phaseClass15i_V_29
  %tmp15 = add i16 %tmp17, %tmp16
  %corHelperINeg_V_15_5 = add i16 %tmp15, %tmp12
  %cor_phaseClass15q_V_29 = load i16* @cor_phaseClass15q_V_s, align 16
  %tmp19 = add i16 %cor_phaseClass15q_V_15, %cor_phaseClass15q_V_s
  %tmp20 = add i16 %cor_phaseClass15q_V_16, %cor_phaseClass15q_V_17
  %tmp18 = add i16 %tmp20, %tmp19
  %tmp22 = add i16 %cor_phaseClass15q_V_22, %cor_phaseClass15q_V_24
  %tmp23 = add i16 %cor_phaseClass15q_V_27, %cor_phaseClass15q_V_29
  %tmp21 = add i16 %tmp23, %tmp22
  %corHelperQNeg_V_15_5 = add i16 %tmp21, %tmp18
  br label %.loopexit
...
.preheader2911.0:                                 ; preds = %0
  ...
  %tmp25 = add i16 %cor_phaseClass14i_V_19, %cor_phaseClass14i_V_18
  %tmp26 = add i16 %cor_phaseClass14i_V_20, %cor_phaseClass14i_V_21
  %tmp24 = add i16 %tmp26, %tmp25
  %tmp28 = add i16 %cor_phaseClass14i_V_23, %cor_phaseClass14i_V_25
  %tmp29 = add i16 %cor_phaseClass14i_V_26, %cor_phaseClass14i_V_28
  %tmp27 = add i16 %tmp29, %tmp28
  %corHelperIPos_V_14_2 = add i16 %tmp27, %tmp24
  %cor_phaseClass14q_V_28 = load i16* @cor_phaseClass14q_V_1, align 2
  %tmp31 = add i16 %cor_phaseClass14q_V_19, %cor_phaseClass14q_V_18
  %tmp32 = add i16 %cor_phaseClass14q_V_20, %cor_phaseClass14q_V_21
  %tmp30 = add i16 %tmp32, %tmp31
  %tmp34 = add i16 %cor_phaseClass14q_V_23, %cor_phaseClass14q_V_25
  %tmp35 = add i16 %cor_phaseClass14q_V_26, %cor_phaseClass14q_V_28
  %tmp33 = add i16 %tmp35, %tmp34
  %corHelperQPos_V_14_2 = add i16 %tmp33, %tmp30
  %cor_phaseClass14i_V_29 = load i16* @cor_phaseClass14i_V_s, align 16
  %tmp37 = add i16 %cor_phaseClass14i_V_15, %cor_phaseClass14i_V_s
  %tmp38 = add i16 %cor_phaseClass14i_V_16, %cor_phaseClass14i_V_17
  %tmp36 = add i16 %tmp38, %tmp37
  %tmp40 = add i16 %cor_phaseClass14i_V_22, %cor_phaseClass14i_V_24
  %tmp41 = add i16 %cor_phaseClass14i_V_27, %cor_phaseClass14i_V_29
  %tmp39 = add i16 %tmp41, %tmp40
  %corHelperINeg_V_14_5 = add i16 %tmp39, %tmp36
  %cor_phaseClass14q_V_29 = load i16* @cor_phaseClass14q_V_s, align 16
  %tmp43 = add i16 %cor_phaseClass14q_V_15, %cor_phaseClass14q_V_s
  %tmp44 = add i16 %cor_phaseClass14q_V_16, %cor_phaseClass14q_V_17
  %tmp42 = add i16 %tmp44, %tmp43
  %tmp46 = add i16 %cor_phaseClass14q_V_22, %cor_phaseClass14q_V_24
  %tmp47 = add i16 %cor_phaseClass14q_V_27, %cor_phaseClass14q_V_29
  %tmp45 = add i16 %tmp47, %tmp46
  %corHelperQNeg_V_14_5 = add i16 %tmp45, %tmp42
  br label %.loopexit
...
.preheader2913.0:                                 ; preds = %0
  ...
  %tmp49 = add i16 %cor_phaseClass13i_V_19, %cor_phaseClass13i_V_18
  %tmp50 = add i16 %cor_phaseClass13i_V_20, %cor_phaseClass13i_V_21
  %tmp48 = add i16 %tmp50, %tmp49
  %tmp52 = add i16 %cor_phaseClass13i_V_23, %cor_phaseClass13i_V_25
  %tmp53 = add i16 %cor_phaseClass13i_V_26, %cor_phaseClass13i_V_28
  %tmp51 = add i16 %tmp53, %tmp52
  %corHelperIPos_V_13_2 = add i16 %tmp51, %tmp48
  %cor_phaseClass13q_V_28 = load i16* @cor_phaseClass13q_V_1, align 2
  %tmp55 = add i16 %cor_phaseClass13q_V_19, %cor_phaseClass13q_V_18
  %tmp56 = add i16 %cor_phaseClass13q_V_20, %cor_phaseClass13q_V_21
  %tmp54 = add i16 %tmp56, %tmp55
  %tmp58 = add i16 %cor_phaseClass13q_V_23, %cor_phaseClass13q_V_25
  %tmp59 = add i16 %cor_phaseClass13q_V_26, %cor_phaseClass13q_V_28
  %tmp57 = add i16 %tmp59, %tmp58
  %corHelperQPos_V_13_2 = add i16 %tmp57, %tmp54
  %cor_phaseClass13i_V_29 = load i16* @cor_phaseClass13i_V_s, align 16
  %tmp61 = add i16 %cor_phaseClass13i_V_15, %cor_phaseClass13i_V_s
  %tmp62 = add i16 %cor_phaseClass13i_V_16, %cor_phaseClass13i_V_17
  %tmp60 = add i16 %tmp62, %tmp61
  %tmp64 = add i16 %cor_phaseClass13i_V_22, %cor_phaseClass13i_V_24
  %tmp65 = add i16 %cor_phaseClass13i_V_27, %cor_phaseClass13i_V_29
  %tmp63 = add i16 %tmp65, %tmp64
  %corHelperINeg_V_13_5 = add i16 %tmp63, %tmp60
  %cor_phaseClass13q_V_29 = load i16* @cor_phaseClass13q_V_s, align 16
  %tmp67 = add i16 %cor_phaseClass13q_V_15, %cor_phaseClass13q_V_s
  %tmp68 = add i16 %cor_phaseClass13q_V_16, %cor_phaseClass13q_V_17
  %tmp66 = add i16 %tmp68, %tmp67
  %tmp70 = add i16 %cor_phaseClass13q_V_22, %cor_phaseClass13q_V_24
  %tmp71 = add i16 %cor_phaseClass13q_V_27, %cor_phaseClass13q_V_29
  %tmp69 = add i16 %tmp71, %tmp70
  %corHelperQNeg_V_13_5 = add i16 %tmp69, %tmp66
  br label %.loopexit
...
.preheader2915.0:                                 ; preds = %0
  ...
  %tmp73 = add i16 %cor_phaseClass12i_V_19, %cor_phaseClass12i_V_18
  %tmp74 = add i16 %cor_phaseClass12i_V_20, %cor_phaseClass12i_V_21
  %tmp72 = add i16 %tmp74, %tmp73
  %tmp76 = add i16 %cor_phaseClass12i_V_23, %cor_phaseClass12i_V_25
  %tmp77 = add i16 %cor_phaseClass12i_V_26, %cor_phaseClass12i_V_28
  %tmp75 = add i16 %tmp77, %tmp76
  %corHelperIPos_V_12_2 = add i16 %tmp75, %tmp72
  %cor_phaseClass12q_V_28 = load i16* @cor_phaseClass12q_V_1, align 2
  %tmp79 = add i16 %cor_phaseClass12q_V_19, %cor_phaseClass12q_V_18
  %tmp80 = add i16 %cor_phaseClass12q_V_20, %cor_phaseClass12q_V_21
  %tmp78 = add i16 %tmp80, %tmp79
  %tmp82 = add i16 %cor_phaseClass12q_V_23, %cor_phaseClass12q_V_25
  %tmp83 = add i16 %cor_phaseClass12q_V_26, %cor_phaseClass12q_V_28
  %tmp81 = add i16 %tmp83, %tmp82
  %corHelperQPos_V_12_2 = add i16 %tmp81, %tmp78
  %cor_phaseClass12i_V_29 = load i16* @cor_phaseClass12i_V_s, align 16
  %tmp85 = add i16 %cor_phaseClass12i_V_15, %cor_phaseClass12i_V_s
  %tmp86 = add i16 %cor_phaseClass12i_V_16, %cor_phaseClass12i_V_17
  %tmp84 = add i16 %tmp86, %tmp85
  %tmp88 = add i16 %cor_phaseClass12i_V_22, %cor_phaseClass12i_V_24
  %tmp89 = add i16 %cor_phaseClass12i_V_27, %cor_phaseClass12i_V_29
  %tmp87 = add i16 %tmp89, %tmp88
  %corHelperINeg_V_12_5 = add i16 %tmp87, %tmp84
  %cor_phaseClass12q_V_29 = load i16* @cor_phaseClass12q_V_s, align 16
  %tmp91 = add i16 %cor_phaseClass12q_V_15, %cor_phaseClass12q_V_s
  %tmp92 = add i16 %cor_phaseClass12q_V_16, %cor_phaseClass12q_V_17
  %tmp90 = add i16 %tmp92, %tmp91
  %tmp94 = add i16 %cor_phaseClass12q_V_22, %cor_phaseClass12q_V_24
  %tmp95 = add i16 %cor_phaseClass12q_V_27, %cor_phaseClass12q_V_29
  %tmp93 = add i16 %tmp95, %tmp94
  %corHelperQNeg_V_12_5 = add i16 %tmp93, %tmp90
  br label %.loopexit
...
.preheader2917.0:                                 ; preds = %0
  ...
  %tmp97 = add i16 %cor_phaseClass11i_V_19, %cor_phaseClass11i_V_18
  %tmp98 = add i16 %cor_phaseClass11i_V_20, %cor_phaseClass11i_V_21
  %tmp96 = add i16 %tmp98, %tmp97
  %tmp100 = add i16 %cor_phaseClass11i_V_23, %cor_phaseClass11i_V_25
  %tmp101 = add i16 %cor_phaseClass11i_V_26, %cor_phaseClass11i_V_28
  %tmp99 = add i16 %tmp101, %tmp100
  %corHelperIPos_V_11_2 = add i16 %tmp99, %tmp96
  %cor_phaseClass11q_V_28 = load i16* @cor_phaseClass11q_V_1, align 2
  %tmp103 = add i16 %cor_phaseClass11q_V_19, %cor_phaseClass11q_V_18
  %tmp104 = add i16 %cor_phaseClass11q_V_20, %cor_phaseClass11q_V_21
  %tmp102 = add i16 %tmp104, %tmp103
  %tmp106 = add i16 %cor_phaseClass11q_V_23, %cor_phaseClass11q_V_25
  %tmp107 = add i16 %cor_phaseClass11q_V_26, %cor_phaseClass11q_V_28
  %tmp105 = add i16 %tmp107, %tmp106
  %corHelperQPos_V_11_2 = add i16 %tmp105, %tmp102
  %cor_phaseClass11i_V_29 = load i16* @cor_phaseClass11i_V_s, align 16
  %tmp109 = add i16 %cor_phaseClass11i_V_15, %cor_phaseClass11i_V_s
  %tmp110 = add i16 %cor_phaseClass11i_V_16, %cor_phaseClass11i_V_17
  %tmp108 = add i16 %tmp110, %tmp109
  %tmp112 = add i16 %cor_phaseClass11i_V_22, %cor_phaseClass11i_V_24
  %tmp113 = add i16 %cor_phaseClass11i_V_27, %cor_phaseClass11i_V_29
  %tmp111 = add i16 %tmp113, %tmp112
  %corHelperINeg_V_11_5 = add i16 %tmp111, %tmp108
  %cor_phaseClass11q_V_29 = load i16* @cor_phaseClass11q_V_s, align 16
  %tmp115 = add i16 %cor_phaseClass11q_V_15, %cor_phaseClass11q_V_s
  %tmp116 = add i16 %cor_phaseClass11q_V_16, %cor_phaseClass11q_V_17
  %tmp114 = add i16 %tmp116, %tmp115
  %tmp118 = add i16 %cor_phaseClass11q_V_22, %cor_phaseClass11q_V_24
  %tmp119 = add i16 %cor_phaseClass11q_V_27, %cor_phaseClass11q_V_29
  %tmp117 = add i16 %tmp119, %tmp118
  %corHelperQNeg_V_11_5 = add i16 %tmp117, %tmp114
  br label %.loopexit
...
.preheader2919.0:                                 ; preds = %0
  ...
  %tmp121 = add i16 %cor_phaseClass10i_V_19, %cor_phaseClass10i_V_18
  %tmp122 = add i16 %cor_phaseClass10i_V_20, %cor_phaseClass10i_V_21
  %tmp120 = add i16 %tmp122, %tmp121
  %tmp124 = add i16 %cor_phaseClass10i_V_23, %cor_phaseClass10i_V_25
  %tmp125 = add i16 %cor_phaseClass10i_V_26, %cor_phaseClass10i_V_28
  %tmp123 = add i16 %tmp125, %tmp124
  %corHelperIPos_V_10_2 = add i16 %tmp123, %tmp120
  %cor_phaseClass10q_V_28 = load i16* @cor_phaseClass10q_V_1, align 2
  %tmp127 = add i16 %cor_phaseClass10q_V_19, %cor_phaseClass10q_V_18
  %tmp128 = add i16 %cor_phaseClass10q_V_20, %cor_phaseClass10q_V_21
  %tmp126 = add i16 %tmp128, %tmp127
  %tmp130 = add i16 %cor_phaseClass10q_V_23, %cor_phaseClass10q_V_25
  %tmp131 = add i16 %cor_phaseClass10q_V_26, %cor_phaseClass10q_V_28
  %tmp129 = add i16 %tmp131, %tmp130
  %corHelperQPos_V_10_2 = add i16 %tmp129, %tmp126
  %cor_phaseClass10i_V_29 = load i16* @cor_phaseClass10i_V_s, align 16
  %tmp133 = add i16 %cor_phaseClass10i_V_15, %cor_phaseClass10i_V_s
  %tmp134 = add i16 %cor_phaseClass10i_V_16, %cor_phaseClass10i_V_17
  %tmp132 = add i16 %tmp134, %tmp133
  %tmp136 = add i16 %cor_phaseClass10i_V_22, %cor_phaseClass10i_V_24
  %tmp137 = add i16 %cor_phaseClass10i_V_27, %cor_phaseClass10i_V_29
  %tmp135 = add i16 %tmp137, %tmp136
  %corHelperINeg_V_10_5 = add i16 %tmp135, %tmp132
  %cor_phaseClass10q_V_29 = load i16* @cor_phaseClass10q_V_s, align 16
  %tmp139 = add i16 %cor_phaseClass10q_V_15, %cor_phaseClass10q_V_s
  %tmp140 = add i16 %cor_phaseClass10q_V_16, %cor_phaseClass10q_V_17
  %tmp138 = add i16 %tmp140, %tmp139
  %tmp142 = add i16 %cor_phaseClass10q_V_22, %cor_phaseClass10q_V_24
  %tmp143 = add i16 %cor_phaseClass10q_V_27, %cor_phaseClass10q_V_29
  %tmp141 = add i16 %tmp143, %tmp142
  %corHelperQNeg_V_10_5 = add i16 %tmp141, %tmp138
  br label %.loopexit
...
.preheader2921.0:                                 ; preds = %0
  ...
  %tmp145 = add i16 %cor_phaseClass9i_V_1_10, %cor_phaseClass9i_V_1_9
  %tmp146 = add i16 %cor_phaseClass9i_V_9, %cor_phaseClass9i_V_8
  %tmp144 = add i16 %tmp146, %tmp145
  %tmp148 = add i16 %cor_phaseClass9i_V_6, %cor_phaseClass9i_V_4
  %tmp149 = add i16 %cor_phaseClass9i_V_3, %cor_phaseClass9i_V_1_11
  %tmp147 = add i16 %tmp149, %tmp148
  %corHelperIPos_V_9_2 = add i16 %tmp147, %tmp144
  %cor_phaseClass9q_V_1_11 = load i16* @cor_phaseClass9q_V_1, align 2
  %tmp151 = add i16 %cor_phaseClass9q_V_1_10, %cor_phaseClass9q_V_1_9
  %tmp152 = add i16 %cor_phaseClass9q_V_9, %cor_phaseClass9q_V_8
  %tmp150 = add i16 %tmp152, %tmp151
  %tmp154 = add i16 %cor_phaseClass9q_V_6, %cor_phaseClass9q_V_4
  %tmp155 = add i16 %cor_phaseClass9q_V_3, %cor_phaseClass9q_V_1_11
  %tmp153 = add i16 %tmp155, %tmp154
  %corHelperQPos_V_9_2 = add i16 %tmp153, %tmp150
  %cor_phaseClass9i_V_0 = load i16* @cor_phaseClass9i_V_0, align 16
  %tmp157 = add i16 %cor_phaseClass9i_V_1_6, %cor_phaseClass9i_V_1
  %tmp158 = add i16 %cor_phaseClass9i_V_1_7, %cor_phaseClass9i_V_1_8
  %tmp156 = add i16 %tmp158, %tmp157
  %tmp160 = add i16 %cor_phaseClass9i_V_7, %cor_phaseClass9i_V_5
  %tmp161 = add i16 %cor_phaseClass9i_V_2, %cor_phaseClass9i_V_0
  %tmp159 = add i16 %tmp161, %tmp160
  %corHelperINeg_V_9_5 = add i16 %tmp159, %tmp156
  %cor_phaseClass9q_V_0 = load i16* @cor_phaseClass9q_V_0, align 16
  %tmp163 = add i16 %cor_phaseClass9q_V_1_6, %cor_phaseClass9q_V_1
  %tmp164 = add i16 %cor_phaseClass9q_V_1_7, %cor_phaseClass9q_V_1_8
  %tmp162 = add i16 %tmp164, %tmp163
  %tmp166 = add i16 %cor_phaseClass9q_V_7, %cor_phaseClass9q_V_5
  %tmp167 = add i16 %cor_phaseClass9q_V_2, %cor_phaseClass9q_V_0
  %tmp165 = add i16 %tmp167, %tmp166
  %corHelperQNeg_V_9_5 = add i16 %tmp165, %tmp162
  br label %.loopexit
...
.preheader2923.0:                                 ; preds = %0
  ...
  %tmp169 = add i16 %cor_phaseClass8i_V_1_10, %cor_phaseClass8i_V_1_9
  %tmp170 = add i16 %cor_phaseClass8i_V_9, %cor_phaseClass8i_V_8
  %tmp168 = add i16 %tmp170, %tmp169
  %tmp172 = add i16 %cor_phaseClass8i_V_6, %cor_phaseClass8i_V_4
  %tmp173 = add i16 %cor_phaseClass8i_V_3, %cor_phaseClass8i_V_1_11
  %tmp171 = add i16 %tmp173, %tmp172
  %corHelperIPos_V_8_2 = add i16 %tmp171, %tmp168
  %cor_phaseClass8q_V_1_11 = load i16* @cor_phaseClass8q_V_1, align 2
  %tmp175 = add i16 %cor_phaseClass8q_V_1_10, %cor_phaseClass8q_V_1_9
  %tmp176 = add i16 %cor_phaseClass8q_V_9, %cor_phaseClass8q_V_8
  %tmp174 = add i16 %tmp176, %tmp175
  %tmp178 = add i16 %cor_phaseClass8q_V_6, %cor_phaseClass8q_V_4
  %tmp179 = add i16 %cor_phaseClass8q_V_3, %cor_phaseClass8q_V_1_11
  %tmp177 = add i16 %tmp179, %tmp178
  %corHelperQPos_V_8_2 = add i16 %tmp177, %tmp174
  %cor_phaseClass8i_V_0 = load i16* @cor_phaseClass8i_V_0, align 16
  %tmp181 = add i16 %cor_phaseClass8i_V_1_6, %cor_phaseClass8i_V_1
  %tmp182 = add i16 %cor_phaseClass8i_V_1_7, %cor_phaseClass8i_V_1_8
  %tmp180 = add i16 %tmp182, %tmp181
  %tmp184 = add i16 %cor_phaseClass8i_V_7, %cor_phaseClass8i_V_5
  %tmp185 = add i16 %cor_phaseClass8i_V_2, %cor_phaseClass8i_V_0
  %tmp183 = add i16 %tmp185, %tmp184
  %corHelperINeg_V_8_5 = add i16 %tmp183, %tmp180
  %cor_phaseClass8q_V_0 = load i16* @cor_phaseClass8q_V_0, align 16
  %tmp187 = add i16 %cor_phaseClass8q_V_1_6, %cor_phaseClass8q_V_1
  %tmp188 = add i16 %cor_phaseClass8q_V_1_7, %cor_phaseClass8q_V_1_8
  %tmp186 = add i16 %tmp188, %tmp187
  %tmp190 = add i16 %cor_phaseClass8q_V_7, %cor_phaseClass8q_V_5
  %tmp191 = add i16 %cor_phaseClass8q_V_2, %cor_phaseClass8q_V_0
  %tmp189 = add i16 %tmp191, %tmp190
  %corHelperQNeg_V_8_5 = add i16 %tmp189, %tmp186
  br label %.loopexit
...
.preheader2925.0:                                 ; preds = %0
  ...
  %tmp193 = add i16 %cor_phaseClass7i_V_1_10, %cor_phaseClass7i_V_1_9
  %tmp194 = add i16 %cor_phaseClass7i_V_9, %cor_phaseClass7i_V_8
  %tmp192 = add i16 %tmp194, %tmp193
  %tmp196 = add i16 %cor_phaseClass7i_V_6, %cor_phaseClass7i_V_4
  %tmp197 = add i16 %cor_phaseClass7i_V_3, %cor_phaseClass7i_V_1_11
  %tmp195 = add i16 %tmp197, %tmp196
  %corHelperIPos_V_7_2 = add i16 %tmp195, %tmp192
  %cor_phaseClass7q_V_1_11 = load i16* @cor_phaseClass7q_V_1, align 2
  %tmp199 = add i16 %cor_phaseClass7q_V_1_10, %cor_phaseClass7q_V_1_9
  %tmp200 = add i16 %cor_phaseClass7q_V_9, %cor_phaseClass7q_V_8
  %tmp198 = add i16 %tmp200, %tmp199
  %tmp202 = add i16 %cor_phaseClass7q_V_6, %cor_phaseClass7q_V_4
  %tmp203 = add i16 %cor_phaseClass7q_V_3, %cor_phaseClass7q_V_1_11
  %tmp201 = add i16 %tmp203, %tmp202
  %corHelperQPos_V_7_2 = add i16 %tmp201, %tmp198
  %cor_phaseClass7i_V_0 = load i16* @cor_phaseClass7i_V_0, align 16
  %tmp205 = add i16 %cor_phaseClass7i_V_1_6, %cor_phaseClass7i_V_1
  %tmp206 = add i16 %cor_phaseClass7i_V_1_7, %cor_phaseClass7i_V_1_8
  %tmp204 = add i16 %tmp206, %tmp205
  %tmp208 = add i16 %cor_phaseClass7i_V_7, %cor_phaseClass7i_V_5
  %tmp209 = add i16 %cor_phaseClass7i_V_2, %cor_phaseClass7i_V_0
  %tmp207 = add i16 %tmp209, %tmp208
  %corHelperINeg_V_7_5 = add i16 %tmp207, %tmp204
  %cor_phaseClass7q_V_0 = load i16* @cor_phaseClass7q_V_0, align 16
  %tmp211 = add i16 %cor_phaseClass7q_V_1_6, %cor_phaseClass7q_V_1
  %tmp212 = add i16 %cor_phaseClass7q_V_1_7, %cor_phaseClass7q_V_1_8
  %tmp210 = add i16 %tmp212, %tmp211
  %tmp214 = add i16 %cor_phaseClass7q_V_7, %cor_phaseClass7q_V_5
  %tmp215 = add i16 %cor_phaseClass7q_V_2, %cor_phaseClass7q_V_0
  %tmp213 = add i16 %tmp215, %tmp214
  %corHelperQNeg_V_7_5 = add i16 %tmp213, %tmp210
  br label %.loopexit
...
.preheader2927.0:                                 ; preds = %0
  ...
  %tmp217 = add i16 %cor_phaseClass6i_V_1_10, %cor_phaseClass6i_V_1_9
  %tmp218 = add i16 %cor_phaseClass6i_V_9, %cor_phaseClass6i_V_8
  %tmp216 = add i16 %tmp218, %tmp217
  %tmp220 = add i16 %cor_phaseClass6i_V_6, %cor_phaseClass6i_V_4
  %tmp221 = add i16 %cor_phaseClass6i_V_3, %cor_phaseClass6i_V_1_11
  %tmp219 = add i16 %tmp221, %tmp220
  %corHelperIPos_V_6_2 = add i16 %tmp219, %tmp216
  %cor_phaseClass6q_V_1_11 = load i16* @cor_phaseClass6q_V_1, align 2
  %tmp223 = add i16 %cor_phaseClass6q_V_1_10, %cor_phaseClass6q_V_1_9
  %tmp224 = add i16 %cor_phaseClass6q_V_9, %cor_phaseClass6q_V_8
  %tmp222 = add i16 %tmp224, %tmp223
  %tmp226 = add i16 %cor_phaseClass6q_V_6, %cor_phaseClass6q_V_4
  %tmp227 = add i16 %cor_phaseClass6q_V_3, %cor_phaseClass6q_V_1_11
  %tmp225 = add i16 %tmp227, %tmp226
  %corHelperQPos_V_6_2 = add i16 %tmp225, %tmp222
  %cor_phaseClass6i_V_0 = load i16* @cor_phaseClass6i_V_0, align 16
  %tmp229 = add i16 %cor_phaseClass6i_V_1_6, %cor_phaseClass6i_V_1
  %tmp230 = add i16 %cor_phaseClass6i_V_1_7, %cor_phaseClass6i_V_1_8
  %tmp228 = add i16 %tmp230, %tmp229
  %tmp232 = add i16 %cor_phaseClass6i_V_7, %cor_phaseClass6i_V_5
  %tmp233 = add i16 %cor_phaseClass6i_V_2, %cor_phaseClass6i_V_0
  %tmp231 = add i16 %tmp233, %tmp232
  %corHelperINeg_V_6_5 = add i16 %tmp231, %tmp228
  %cor_phaseClass6q_V_0 = load i16* @cor_phaseClass6q_V_0, align 16
  %tmp235 = add i16 %cor_phaseClass6q_V_1_6, %cor_phaseClass6q_V_1
  %tmp236 = add i16 %cor_phaseClass6q_V_1_7, %cor_phaseClass6q_V_1_8
  %tmp234 = add i16 %tmp236, %tmp235
  %tmp238 = add i16 %cor_phaseClass6q_V_7, %cor_phaseClass6q_V_5
  %tmp239 = add i16 %cor_phaseClass6q_V_2, %cor_phaseClass6q_V_0
  %tmp237 = add i16 %tmp239, %tmp238
  %corHelperQNeg_V_6_5 = add i16 %tmp237, %tmp234
  br label %.loopexit
...
.preheader2929.0:                                 ; preds = %0
  ...
  %tmp241 = add i16 %cor_phaseClass5i_V_1_10, %cor_phaseClass5i_V_1_9
  %tmp242 = add i16 %cor_phaseClass5i_V_9, %cor_phaseClass5i_V_8
  %tmp240 = add i16 %tmp242, %tmp241
  %tmp244 = add i16 %cor_phaseClass5i_V_6, %cor_phaseClass5i_V_4
  %tmp245 = add i16 %cor_phaseClass5i_V_3, %cor_phaseClass5i_V_1_11
  %tmp243 = add i16 %tmp245, %tmp244
  %corHelperIPos_V_5_2 = add i16 %tmp243, %tmp240
  %cor_phaseClass5q_V_1_11 = load i16* @cor_phaseClass5q_V_1, align 2
  %tmp247 = add i16 %cor_phaseClass5q_V_1_10, %cor_phaseClass5q_V_1_9
  %tmp248 = add i16 %cor_phaseClass5q_V_9, %cor_phaseClass5q_V_8
  %tmp246 = add i16 %tmp248, %tmp247
  %tmp250 = add i16 %cor_phaseClass5q_V_6, %cor_phaseClass5q_V_4
  %tmp251 = add i16 %cor_phaseClass5q_V_3, %cor_phaseClass5q_V_1_11
  %tmp249 = add i16 %tmp251, %tmp250
  %corHelperQPos_V_5_2 = add i16 %tmp249, %tmp246
  %cor_phaseClass5i_V_0 = load i16* @cor_phaseClass5i_V_0, align 16
  %tmp253 = add i16 %cor_phaseClass5i_V_1_6, %cor_phaseClass5i_V_1
  %tmp254 = add i16 %cor_phaseClass5i_V_1_7, %cor_phaseClass5i_V_1_8
  %tmp252 = add i16 %tmp254, %tmp253
  %tmp256 = add i16 %cor_phaseClass5i_V_7, %cor_phaseClass5i_V_5
  %tmp257 = add i16 %cor_phaseClass5i_V_2, %cor_phaseClass5i_V_0
  %tmp255 = add i16 %tmp257, %tmp256
  %corHelperINeg_V_5_5 = add i16 %tmp255, %tmp252
  %cor_phaseClass5q_V_0 = load i16* @cor_phaseClass5q_V_0, align 16
  %tmp259 = add i16 %cor_phaseClass5q_V_1_6, %cor_phaseClass5q_V_1
  %tmp260 = add i16 %cor_phaseClass5q_V_1_7, %cor_phaseClass5q_V_1_8
  %tmp258 = add i16 %tmp260, %tmp259
  %tmp262 = add i16 %cor_phaseClass5q_V_7, %cor_phaseClass5q_V_5
  %tmp263 = add i16 %cor_phaseClass5q_V_2, %cor_phaseClass5q_V_0
  %tmp261 = add i16 %tmp263, %tmp262
  %corHelperQNeg_V_5_5 = add i16 %tmp261, %tmp258
  br label %.loopexit
...
.preheader2931.0:                                 ; preds = %0
  ...
  %tmp265 = add i16 %cor_phaseClass4i_V_1_10, %cor_phaseClass4i_V_1_9
  %tmp266 = add i16 %cor_phaseClass4i_V_9, %cor_phaseClass4i_V_8
  %tmp264 = add i16 %tmp266, %tmp265
  %tmp268 = add i16 %cor_phaseClass4i_V_6, %cor_phaseClass4i_V_4
  %tmp269 = add i16 %cor_phaseClass4i_V_3, %cor_phaseClass4i_V_1_11
  %tmp267 = add i16 %tmp269, %tmp268
  %corHelperIPos_V_4_2 = add i16 %tmp267, %tmp264
  %cor_phaseClass4q_V_1_11 = load i16* @cor_phaseClass4q_V_1, align 2
  %tmp271 = add i16 %cor_phaseClass4q_V_1_10, %cor_phaseClass4q_V_1_9
  %tmp272 = add i16 %cor_phaseClass4q_V_9, %cor_phaseClass4q_V_8
  %tmp270 = add i16 %tmp272, %tmp271
  %tmp274 = add i16 %cor_phaseClass4q_V_6, %cor_phaseClass4q_V_4
  %tmp275 = add i16 %cor_phaseClass4q_V_3, %cor_phaseClass4q_V_1_11
  %tmp273 = add i16 %tmp275, %tmp274
  %corHelperQPos_V_4_2 = add i16 %tmp273, %tmp270
  %cor_phaseClass4i_V_0 = load i16* @cor_phaseClass4i_V_0, align 16
  %tmp277 = add i16 %cor_phaseClass4i_V_1_6, %cor_phaseClass4i_V_1
  %tmp278 = add i16 %cor_phaseClass4i_V_1_7, %cor_phaseClass4i_V_1_8
  %tmp276 = add i16 %tmp278, %tmp277
  %tmp280 = add i16 %cor_phaseClass4i_V_7, %cor_phaseClass4i_V_5
  %tmp281 = add i16 %cor_phaseClass4i_V_2, %cor_phaseClass4i_V_0
  %tmp279 = add i16 %tmp281, %tmp280
  %corHelperINeg_V_4_5 = add i16 %tmp279, %tmp276
  %cor_phaseClass4q_V_0 = load i16* @cor_phaseClass4q_V_0, align 16
  %tmp283 = add i16 %cor_phaseClass4q_V_1_6, %cor_phaseClass4q_V_1
  %tmp284 = add i16 %cor_phaseClass4q_V_1_7, %cor_phaseClass4q_V_1_8
  %tmp282 = add i16 %tmp284, %tmp283
  %tmp286 = add i16 %cor_phaseClass4q_V_7, %cor_phaseClass4q_V_5
  %tmp287 = add i16 %cor_phaseClass4q_V_2, %cor_phaseClass4q_V_0
  %tmp285 = add i16 %tmp287, %tmp286
  %corHelperQNeg_V_4_5 = add i16 %tmp285, %tmp282
  br label %.loopexit
...
.preheader2933.0:                                 ; preds = %0
  ...
  %tmp289 = add i16 %cor_phaseClass3i_V_1_10, %cor_phaseClass3i_V_1_9
  %tmp290 = add i16 %cor_phaseClass3i_V_9, %cor_phaseClass3i_V_8
  %tmp288 = add i16 %tmp290, %tmp289
  %tmp292 = add i16 %cor_phaseClass3i_V_6, %cor_phaseClass3i_V_4
  %tmp293 = add i16 %cor_phaseClass3i_V_3, %cor_phaseClass3i_V_1_11
  %tmp291 = add i16 %tmp293, %tmp292
  %corHelperIPos_V_3_2 = add i16 %tmp291, %tmp288
  %cor_phaseClass3q_V_1_11 = load i16* @cor_phaseClass3q_V_1, align 2
  %tmp295 = add i16 %cor_phaseClass3q_V_1_10, %cor_phaseClass3q_V_1_9
  %tmp296 = add i16 %cor_phaseClass3q_V_9, %cor_phaseClass3q_V_8
  %tmp294 = add i16 %tmp296, %tmp295
  %tmp298 = add i16 %cor_phaseClass3q_V_6, %cor_phaseClass3q_V_4
  %tmp299 = add i16 %cor_phaseClass3q_V_3, %cor_phaseClass3q_V_1_11
  %tmp297 = add i16 %tmp299, %tmp298
  %corHelperQPos_V_3_2 = add i16 %tmp297, %tmp294
  %cor_phaseClass3i_V_0 = load i16* @cor_phaseClass3i_V_0, align 16
  %tmp301 = add i16 %cor_phaseClass3i_V_1_6, %cor_phaseClass3i_V_1
  %tmp302 = add i16 %cor_phaseClass3i_V_1_7, %cor_phaseClass3i_V_1_8
  %tmp300 = add i16 %tmp302, %tmp301
  %tmp304 = add i16 %cor_phaseClass3i_V_7, %cor_phaseClass3i_V_5
  %tmp305 = add i16 %cor_phaseClass3i_V_2, %cor_phaseClass3i_V_0
  %tmp303 = add i16 %tmp305, %tmp304
  %corHelperINeg_V_3_5 = add i16 %tmp303, %tmp300
  %cor_phaseClass3q_V_0 = load i16* @cor_phaseClass3q_V_0, align 16
  %tmp307 = add i16 %cor_phaseClass3q_V_1_6, %cor_phaseClass3q_V_1
  %tmp308 = add i16 %cor_phaseClass3q_V_1_7, %cor_phaseClass3q_V_1_8
  %tmp306 = add i16 %tmp308, %tmp307
  %tmp310 = add i16 %cor_phaseClass3q_V_7, %cor_phaseClass3q_V_5
  %tmp311 = add i16 %cor_phaseClass3q_V_2, %cor_phaseClass3q_V_0
  %tmp309 = add i16 %tmp311, %tmp310
  %corHelperQNeg_V_3_5 = add i16 %tmp309, %tmp306
  br label %.loopexit
...
.preheader2935.0:                                 ; preds = %0
  ...
  %tmp313 = add i16 %cor_phaseClass2i_V_1_10, %cor_phaseClass2i_V_1_9
  %tmp314 = add i16 %cor_phaseClass2i_V_9, %cor_phaseClass2i_V_8
  %tmp312 = add i16 %tmp314, %tmp313
  %tmp316 = add i16 %cor_phaseClass2i_V_6, %cor_phaseClass2i_V_4
  %tmp317 = add i16 %cor_phaseClass2i_V_3, %cor_phaseClass2i_V_1_11
  %tmp315 = add i16 %tmp317, %tmp316
  %corHelperIPos_V_2_2 = add i16 %tmp315, %tmp312
  %cor_phaseClass2q_V_1_11 = load i16* @cor_phaseClass2q_V_1, align 2
  %tmp319 = add i16 %cor_phaseClass2q_V_1_10, %cor_phaseClass2q_V_1_9
  %tmp320 = add i16 %cor_phaseClass2q_V_9, %cor_phaseClass2q_V_8
  %tmp318 = add i16 %tmp320, %tmp319
  %tmp322 = add i16 %cor_phaseClass2q_V_6, %cor_phaseClass2q_V_4
  %tmp323 = add i16 %cor_phaseClass2q_V_3, %cor_phaseClass2q_V_1_11
  %tmp321 = add i16 %tmp323, %tmp322
  %corHelperQPos_V_2_2 = add i16 %tmp321, %tmp318
  %cor_phaseClass2i_V_0 = load i16* @cor_phaseClass2i_V_0, align 16
  %tmp325 = add i16 %cor_phaseClass2i_V_1_6, %cor_phaseClass2i_V_1
  %tmp326 = add i16 %cor_phaseClass2i_V_1_7, %cor_phaseClass2i_V_1_8
  %tmp324 = add i16 %tmp326, %tmp325
  %tmp328 = add i16 %cor_phaseClass2i_V_7, %cor_phaseClass2i_V_5
  %tmp329 = add i16 %cor_phaseClass2i_V_2, %cor_phaseClass2i_V_0
  %tmp327 = add i16 %tmp329, %tmp328
  %corHelperINeg_V_2_5 = add i16 %tmp327, %tmp324
  %cor_phaseClass2q_V_0 = load i16* @cor_phaseClass2q_V_0, align 16
  %tmp331 = add i16 %cor_phaseClass2q_V_1_6, %cor_phaseClass2q_V_1
  %tmp332 = add i16 %cor_phaseClass2q_V_1_7, %cor_phaseClass2q_V_1_8
  %tmp330 = add i16 %tmp332, %tmp331
  %tmp334 = add i16 %cor_phaseClass2q_V_7, %cor_phaseClass2q_V_5
  %tmp335 = add i16 %cor_phaseClass2q_V_2, %cor_phaseClass2q_V_0
  %tmp333 = add i16 %tmp335, %tmp334
  %corHelperQNeg_V_2_5 = add i16 %tmp333, %tmp330
  br label %.loopexit
...
.preheader2937.0:                                 ; preds = %0
  ...
  %tmp337 = add i16 %cor_phaseClass1i_V_1_10, %cor_phaseClass1i_V_1_9
  %tmp338 = add i16 %cor_phaseClass1i_V_9, %cor_phaseClass1i_V_8
  %tmp336 = add i16 %tmp338, %tmp337
  %tmp340 = add i16 %cor_phaseClass1i_V_6, %cor_phaseClass1i_V_4
  %tmp341 = add i16 %cor_phaseClass1i_V_3, %cor_phaseClass1i_V_1_11
  %tmp339 = add i16 %tmp341, %tmp340
  %corHelperIPos_V_1_2 = add i16 %tmp339, %tmp336
  %cor_phaseClass1q_V_1_11 = load i16* @cor_phaseClass1q_V_1, align 2
  %tmp343 = add i16 %cor_phaseClass1q_V_1_10, %cor_phaseClass1q_V_1_9
  %tmp344 = add i16 %cor_phaseClass1q_V_9, %cor_phaseClass1q_V_8
  %tmp342 = add i16 %tmp344, %tmp343
  %tmp346 = add i16 %cor_phaseClass1q_V_6, %cor_phaseClass1q_V_4
  %tmp347 = add i16 %cor_phaseClass1q_V_3, %cor_phaseClass1q_V_1_11
  %tmp345 = add i16 %tmp347, %tmp346
  %corHelperQPos_V_1_2 = add i16 %tmp345, %tmp342
  %cor_phaseClass1i_V_0 = load i16* @cor_phaseClass1i_V_0, align 16
  %tmp349 = add i16 %cor_phaseClass1i_V_1_6, %cor_phaseClass1i_V_1
  %tmp350 = add i16 %cor_phaseClass1i_V_1_7, %cor_phaseClass1i_V_1_8
  %tmp348 = add i16 %tmp350, %tmp349
  %tmp352 = add i16 %cor_phaseClass1i_V_7, %cor_phaseClass1i_V_5
  %tmp353 = add i16 %cor_phaseClass1i_V_2, %cor_phaseClass1i_V_0
  %tmp351 = add i16 %tmp353, %tmp352
  %corHelperINeg_V_1_5 = add i16 %tmp351, %tmp348
  %cor_phaseClass1q_V_0 = load i16* @cor_phaseClass1q_V_0, align 16
  %tmp355 = add i16 %cor_phaseClass1q_V_1_6, %cor_phaseClass1q_V_1
  %tmp356 = add i16 %cor_phaseClass1q_V_1_7, %cor_phaseClass1q_V_1_8
  %tmp354 = add i16 %tmp356, %tmp355
  %tmp358 = add i16 %cor_phaseClass1q_V_7, %cor_phaseClass1q_V_5
  %tmp359 = add i16 %cor_phaseClass1q_V_2, %cor_phaseClass1q_V_0
  %tmp357 = add i16 %tmp359, %tmp358
  %corHelperQNeg_V_1_5 = add i16 %tmp357, %tmp354
  br label %.loopexit
...
.preheader2939.0:                                 ; preds = %0
  ...
  %tmp361 = add i16 %cor_phaseClass0i_V_1_10, %cor_phaseClass0i_V_1_9
  %tmp362 = add i16 %cor_phaseClass0i_V_9, %cor_phaseClass0i_V_8
  %tmp360 = add i16 %tmp362, %tmp361
  %tmp364 = add i16 %cor_phaseClass0i_V_6, %cor_phaseClass0i_V_4
  %tmp365 = add i16 %cor_phaseClass0i_V_3, %cor_phaseClass0i_V_1_11
  %tmp363 = add i16 %tmp365, %tmp364
  %corHelperIPos_V_6 = add i16 %tmp363, %tmp360
  %cor_phaseClass0q_V_1_11 = load i16* @cor_phaseClass0q_V_1, align 2
  %tmp367 = add i16 %cor_phaseClass0q_V_1_10, %cor_phaseClass0q_V_1_9
  %tmp368 = add i16 %cor_phaseClass0q_V_9, %cor_phaseClass0q_V_8
  %tmp366 = add i16 %tmp368, %tmp367
  %tmp370 = add i16 %cor_phaseClass0q_V_6, %cor_phaseClass0q_V_4
  %tmp371 = add i16 %cor_phaseClass0q_V_3, %cor_phaseClass0q_V_1_11
  %tmp369 = add i16 %tmp371, %tmp370
  %corHelperQPos_V_6 = add i16 %tmp369, %tmp366
  %cor_phaseClass0i_V_0 = load i16* @cor_phaseClass0i_V_0, align 16
  %tmp373 = add i16 %cor_phaseClass0i_V_1_6, %cor_phaseClass0i_V_1
  %tmp374 = add i16 %cor_phaseClass0i_V_1_7, %cor_phaseClass0i_V_1_8
  %tmp372 = add i16 %tmp374, %tmp373
  %tmp376 = add i16 %cor_phaseClass0i_V_7, %cor_phaseClass0i_V_5
  %tmp377 = add i16 %cor_phaseClass0i_V_2, %cor_phaseClass0i_V_0
  %tmp375 = add i16 %tmp377, %tmp376
  %corHelperINeg_V_6 = add i16 %tmp375, %tmp372
  %cor_phaseClass0q_V_0 = load i16* @cor_phaseClass0q_V_0, align 16
  %tmp379 = add i16 %cor_phaseClass0q_V_1_6, %cor_phaseClass0q_V_1
  %tmp380 = add i16 %cor_phaseClass0q_V_1_7, %cor_phaseClass0q_V_1_8
  %tmp378 = add i16 %tmp380, %tmp379
  %tmp382 = add i16 %cor_phaseClass0q_V_7, %cor_phaseClass0q_V_5
  %tmp383 = add i16 %cor_phaseClass0q_V_2, %cor_phaseClass0q_V_0
  %tmp381 = add i16 %tmp383, %tmp382
  %corHelperQNeg_V_6 = add i16 %tmp381, %tmp378
  br label %.loopexit
...
._crit_edge182:                                   ; preds = %codeRepl
  ...
  %tmp_data_V = call fastcc i32 @correlatorPre(i4 %phaseClass_V_load)
