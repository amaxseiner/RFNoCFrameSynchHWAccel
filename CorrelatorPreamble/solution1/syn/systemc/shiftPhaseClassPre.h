...
#ifndef _shiftPhaseClassPre_HH_
#define _shiftPhaseClassPre_HH_
...
struct shiftPhaseClassPre : public sc_module {
    // Port declarations 761
    sc_in_clk ap_clk;
    ...
    // Module declarations
    shiftPhaseClassPre(sc_module_name name);
    SC_HAS_PROCESS(shiftPhaseClassPre);
