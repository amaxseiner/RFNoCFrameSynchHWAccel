...
#ifndef __correlateTopPreambkb__HH__
#define __correlateTopPreambkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(correlateTopPreambkb) {
    ...
    SC_CTOR(correlateTopPreambkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
