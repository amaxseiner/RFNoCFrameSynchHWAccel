...
set DataType0 [list "axis_fixed" "struct axis_fixed" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "axis_fixed" "struct axis_fixed" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
