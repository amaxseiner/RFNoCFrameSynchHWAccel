...
(* CORE_GENERATION_INFO="matchFilter,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.038000,HLS_SYN_LAT=897,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=2,HLS_SYN_FF=295,HLS_SYN_LUT=1119}" *)
...
wire   [0:0] exitcond_i_fu_272_p2;
wire    ap_CS_fsm_state10;
reg   [31:0] tmp_data_V_reg_641;
reg   [0:0] tmp_last_V_reg_646;
wire   [6:0] a_1_fu_254_p2;
reg   [6:0] a_1_reg_655;
wire    ap_CS_fsm_state3;
wire   [0:0] tmp_s_fu_248_p2;
wire   [31:0] buffIn_data_V_q0;
reg   [31:0] buffIn_data_V_load_reg_670;
wire    ap_CS_fsm_state4;
wire   [0:0] buffIn_last_V_q0;
reg   [0:0] buffIn_last_V_load_reg_675;
wire   [7:0] b_fu_278_p2;
reg   [7:0] b_reg_683;
reg    ap_block_state6_io;
wire   [6:0] tmp_4_fu_289_p1;
reg   [6:0] tmp_4_reg_693;
wire   [31:0] p_Result_s_fu_293_p3;
wire  signed [20:0] tmp_fu_577_p1;
...
reg   [15:0] p_Val2_1_reg_217;
reg   [7:0] b_i_reg_229;
wire   [63:0] tmp_8_fu_260_p1;
wire   [63:0] tmp_7_fu_266_p1;
wire   [63:0] tmp_2_i_fu_284_p1;
reg    ap_block_state10;
wire   [15:0] merge_i_fu_316_p130;
wire  signed [15:0] inI_V_fu_302_p4;
wire  signed [15:0] inQ_V_fu_312_p1;
wire  signed [20:0] grp_fu_623_p3;
wire  signed [20:0] grp_fu_632_p3;
wire  signed [15:0] grp_fu_623_p0;
wire   [20:0] grp_fu_623_p2;
wire  signed [15:0] grp_fu_632_p0;
wire   [20:0] grp_fu_632_p2;
reg   [9:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((in_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        a_reg_193 <= 7'd127;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        b_i_reg_229 <= 8'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        p_Val2_1_reg_217 <= {{grp_fu_623_p3[20:5]}};
    end else if (((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        p_Val2_1_reg_217 <= 16'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        p_Val2_3_reg_205 <= {{grp_fu_632_p3[20:5]}};
    end else if (((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        p_Val2_3_reg_205 <= 16'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_s_fu_248_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_272_p2 == 1'd0) & (1'b0 == ap_block_state6_io) & (1'b1 == ap_CS_fsm_state6))) begin
        tmp_4_reg_693 <= tmp_4_fu_289_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((in_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        buffIn_data_V_address0 = tmp_2_i_fu_284_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        buffIn_data_V_address0 = tmp_7_fu_266_p1;
    end else if (((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        buffIn_data_V_address0 = 64'd0;
    end else if (((tmp_s_fu_248_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        buffIn_data_V_address0 = tmp_8_fu_260_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | ((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3)) | ((tmp_s_fu_248_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3)) | ((1'b0 == ap_block_state6_io) & (1'b1 == ap_CS_fsm_state6)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | ((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        buffIn_last_V_address0 = tmp_7_fu_266_p1;
    end else if (((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        buffIn_last_V_address0 = 64'd0;
    end else if (((tmp_s_fu_248_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        buffIn_last_V_address0 = tmp_8_fu_260_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | ((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3)) | ((tmp_s_fu_248_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    if (((exitcond_i_fu_272_p2 == 1'd1) & (1'b0 == ap_block_state6_io) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state10) | ((exitcond_i_fu_272_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state6)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((tmp_s_fu_248_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        ap_ST_fsm_state6 : begin
            ...
            end else if (((exitcond_i_fu_272_p2 == 1'd0) & (1'b0 == ap_block_state6_io) & (1'b1 == ap_CS_fsm_state6))) begin
        ...
        ap_ST_fsm_state10 : begin
            if ((~((out_V_last_V_1_ack_in == 1'b0) | (out_V_data_V_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state10))) begin
...
assign a_1_fu_254_p2 = ($signed(a_reg_193) + $signed(7'd127));
...
always @ (*) begin
    ap_block_state10 = ((out_V_last_V_1_ack_in == 1'b0) | (out_V_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((exitcond_i_fu_272_p2 == 1'd1) & (out_V_data_V_1_ack_in == 1'b0));
end
...
assign b_fu_278_p2 = (b_i_reg_229 + 8'd1);

assign exitcond_i_fu_272_p2 = ((b_i_reg_229 == 8'd128) ? 1'b1 : 1'b0);

assign grp_fu_623_p0 = tmp_fu_577_p1;

assign grp_fu_623_p2 = {{p_Val2_1_reg_217}, {5'd0}};

assign grp_fu_632_p0 = tmp_fu_577_p1;

assign grp_fu_632_p2 = {{p_Val2_3_reg_205}, {5'd0}};

assign inI_V_fu_302_p4 = {{buffIn_data_V_q0[31:16]}};

assign inQ_V_fu_312_p1 = buffIn_data_V_q0[15:0];
...
assign p_Result_s_fu_293_p3 = {{p_Val2_1_reg_217}, {p_Val2_3_reg_205}};

assign tmp_2_i_fu_284_p1 = b_i_reg_229;

assign tmp_4_fu_289_p1 = b_i_reg_229[6:0];

assign tmp_7_fu_266_p1 = a_reg_193;

assign tmp_8_fu_260_p1 = a_1_fu_254_p2;

assign tmp_fu_577_p1 = $signed(merge_i_fu_316_p130);

assign tmp_s_fu_248_p2 = ((a_reg_193 == 7'd0) ? 1'b1 : 1'b0);
