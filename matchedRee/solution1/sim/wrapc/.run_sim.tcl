...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matchFilter.autotvin.dat"
	set constFileTvOut       "matchFilter.autotvout.dat"
	set constFileHdlTvIn     "matchFilter.autohdltvin.dat"
	set constFileHdlTvOut    "matchFilter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
