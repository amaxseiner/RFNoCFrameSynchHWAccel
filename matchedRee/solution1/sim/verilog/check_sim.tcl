...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matchFilter.autotvin_in_data_V.dat"
         "c.matchFilter.autotvin_in_last_V.dat"
         "c.matchFilter.autotvin_out_data_V.dat"
         "c.matchFilter.autotvin_out_last_V.dat"
         "c.matchFilter.autotvout_out_data_V.dat"
         "c.matchFilter.autotvout_out_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matchFilter.autotvout_out_data_V.dat"
         "rtl.matchFilter.autotvout_out_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
