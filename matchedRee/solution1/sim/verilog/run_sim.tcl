...
if {[file isfile matchFilter.autotvin.dat]} {
	file delete -force matchFilter.autotvin.dat
}

if {[file isfile matchFilter.autotvout.dat]} {
	file delete -force matchFilter.autotvout.dat
}
