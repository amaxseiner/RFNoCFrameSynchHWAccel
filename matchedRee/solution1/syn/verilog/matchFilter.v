...
(* CORE_GENERATION_INFO="matchFilter,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.325667,HLS_SYN_LAT=897,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=2,HLS_SYN_FF=2404,HLS_SYN_LUT=1011}" *)
...
wire   [31:0] a_cast2_fu_236_p1;
reg   [31:0] a_cast2_reg_637;
wire    ap_CS_fsm_state2;
wire   [6:0] a_1_fu_246_p2;
reg   [6:0] a_1_reg_646;
wire   [0:0] tmp_fu_240_p2;
wire   [31:0] buffIn_data_V_q0;
reg   [31:0] buffIn_data_V_load_reg_661;
wire    ap_CS_fsm_state3;
reg   [0:0] out_last_V_1_reg_666;
wire   [7:0] b_fu_279_p2;
reg   [7:0] b_reg_674;
reg    ap_block_state6_io;
wire   [6:0] tmp_6_fu_285_p1;
reg   [6:0] tmp_6_reg_684;
wire   [31:0] p_Result_s_fu_289_p3;
wire  signed [20:0] tmp_2_fu_573_p1;
...
reg   [15:0] p_Val2_3_reg_201;
reg   [15:0] p_Val2_1_reg_213;
reg   [7:0] b_i_reg_225;
wire   [31:0] a_1_cast_fu_252_p1;
wire   [31:0] b_i_cast1_fu_268_p1;
reg    ap_block_state10;
wire   [15:0] tmp_1_fu_312_p130;
wire  signed [15:0] inI_V_fu_298_p4;
wire  signed [15:0] inQ_V_fu_308_p1;
wire  signed [20:0] grp_fu_619_p3;
wire  signed [20:0] grp_fu_628_p3;
wire  signed [15:0] grp_fu_619_p0;
wire   [20:0] grp_fu_619_p2;
wire  signed [15:0] grp_fu_628_p0;
wire   [20:0] grp_fu_628_p2;
reg   [9:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1))) begin
        b_i_reg_225 <= 8'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        p_Val2_1_reg_213 <= {{grp_fu_619_p3[20:5]}};
    end else if (((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1))) begin
        p_Val2_1_reg_213 <= 16'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        p_Val2_3_reg_201 <= {{grp_fu_628_p3[20:5]}};
    end else if (((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1))) begin
        p_Val2_3_reg_201 <= 16'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == tmp_fu_240_p2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        a_cast2_reg_637[6 : 0] <= a_cast2_fu_236_p1[6 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1))) begin
        out_last_V_1_reg_666 <= in_last_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (ap_block_state6_io == 1'b0) & (1'd0 == exitcond_i_fu_273_p2))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        buffIn_data_V_address0 = b_i_cast1_fu_268_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        buffIn_data_V_address0 = 32'd0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        buffIn_data_V_address0 = a_cast2_reg_637;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buffIn_data_V_address0 = a_1_cast_fu_252_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1)) | ((1'b1 == ap_CS_fsm_state6) & (ap_block_state6_io == 1'b0)) | (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1)) | (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        buffIn_last_V_address0 = a_cast2_reg_637;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buffIn_last_V_address0 = a_1_cast_fu_252_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | (1'b1 == ap_CS_fsm_state3) | ((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((1'b1 == ap_CS_fsm_state5) & (in_data_V_0_vld_out == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) & (1'd1 == exitcond_i_fu_273_p2) & (ap_block_state6_io == 1'b0))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state6) & (1'd1 == exitcond_i_fu_273_p2)) | (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (1'd1 == tmp_fu_240_p2))) begin
        ...
        ap_ST_fsm_state6 : begin
            ...
            end else if (((1'b1 == ap_CS_fsm_state6) & (ap_block_state6_io == 1'b0) & (1'd0 == exitcond_i_fu_273_p2))) begin
        ...
        ap_ST_fsm_state10 : begin
            if (((1'b1 == ap_CS_fsm_state10) & ~((1'b0 == out_data_V_1_ack_in) | (1'b0 == out_last_V_1_ack_in)))) begin
...
assign a_1_cast_fu_252_p1 = a_1_fu_246_p2;

assign a_1_fu_246_p2 = ($signed(a_reg_190) + $signed(7'd127));

assign a_cast2_fu_236_p1 = a_reg_190;
...
always @ (*) begin
    ap_block_state10 = ((1'b0 == out_data_V_1_ack_in) | (1'b0 == out_last_V_1_ack_in));
end

always @ (*) begin
    ap_block_state6_io = ((1'd1 == exitcond_i_fu_273_p2) & (1'b0 == out_data_V_1_ack_in));
end
...
assign b_fu_279_p2 = (b_i_reg_225 + 8'd1);

assign b_i_cast1_fu_268_p1 = b_i_reg_225;

assign exitcond_i_fu_273_p2 = ((b_i_reg_225 == 8'd128) ? 1'b1 : 1'b0);

assign grp_fu_619_p0 = tmp_2_fu_573_p1;

assign grp_fu_619_p2 = {{p_Val2_1_reg_213}, {5'd0}};

assign grp_fu_628_p0 = tmp_2_fu_573_p1;

assign grp_fu_628_p2 = {{p_Val2_3_reg_201}, {5'd0}};

assign inI_V_fu_298_p4 = {{buffIn_data_V_q0[31:16]}};

assign inQ_V_fu_308_p1 = buffIn_data_V_q0[15:0];
...
assign p_Result_s_fu_289_p3 = {{p_Val2_1_reg_213}, {p_Val2_3_reg_201}};

assign tmp_2_fu_573_p1 = $signed(tmp_1_fu_312_p130);

assign tmp_6_fu_285_p1 = b_i_reg_225[6:0];

assign tmp_fu_240_p2 = ((a_reg_190 == 7'd0) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    a_cast2_reg_637[31:7] <= 25'b0000000000000000000000000;
end
