...
#ifndef __MatcherRee_mac_mucud__HH__
#define __MatcherRee_mac_mucud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(MatcherRee_mac_mucud) {
    ...
    SC_CTOR(MatcherRee_mac_mucud):  simcore_mac_1_U ("simcore_mac_1_U") {
