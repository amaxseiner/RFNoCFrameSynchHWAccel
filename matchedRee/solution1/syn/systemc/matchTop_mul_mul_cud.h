...
#ifndef __matchTop_mul_mul_cud__HH__
#define __matchTop_mul_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mul_mul_cud) {
    ...
    SC_CTOR(matchTop_mul_mul_cud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
