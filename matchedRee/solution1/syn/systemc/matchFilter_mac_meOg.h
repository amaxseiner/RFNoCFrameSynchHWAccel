...
#ifndef __matchFilter_mac_meOg__HH__
#define __matchFilter_mac_meOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchFilter_mac_meOg) {
    ...
    SC_CTOR(matchFilter_mac_meOg):  simcore_mac_0_U ("simcore_mac_0_U") {
