...
const sc_lv<8> matchFilter::ap_ST_fsm_state1 = "1";
const sc_lv<8> matchFilter::ap_ST_fsm_state2 = "10";
const sc_lv<8> matchFilter::ap_ST_fsm_state3 = "100";
const sc_lv<8> matchFilter::ap_ST_fsm_state4 = "1000";
const sc_lv<8> matchFilter::ap_ST_fsm_state5 = "10000";
const sc_lv<8> matchFilter::ap_ST_fsm_state6 = "100000";
const sc_lv<8> matchFilter::ap_ST_fsm_state7 = "1000000";
const sc_lv<8> matchFilter::ap_ST_fsm_state8 = "10000000";
...
const sc_lv<32> matchFilter::ap_const_lv32_7 = "111";
...
matchFilter::matchFilter(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_a_1_fu_200_p2);
    sensitive << ( a_reg_147 );
    ...
    sensitive << ( exitcond_i_fu_228_p2 );
    ...
    sensitive << ( tmp_4_fu_206_p1 );
    sensitive << ( tmp_s_fu_212_p1 );
    sensitive << ( tmp_2_i_fu_240_p1 );
    ...
    sensitive << ( ap_CS_fsm_state5 );
    sensitive << ( buffIn_data_V_load_reg_298 );
    sensitive << ( ap_CS_fsm_state4 );
    ...
    sensitive << ( ap_CS_fsm_state5 );
    sensitive << ( buffIn_last_V_load_reg_303 );
    sensitive << ( ap_CS_fsm_state4 );
    ...
    SC_METHOD(thread_exitcond_i_fu_228_p2);
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( ap_block_state6_io );
    sensitive << ( b_i_reg_183 );
    ...
    sensitive << ( p_Val2_3_reg_159 );
    sensitive << ( p_Val2_1_reg_171 );

    SC_METHOD(thread_p_Val2_2_fu_254_p4);
    sensitive << ( buffIn_data_V_q0 );

    SC_METHOD(thread_p_Val2_4_fu_264_p1);
    sensitive << ( buffIn_data_V_q0 );

    SC_METHOD(thread_tempI_V_fu_268_p2);
    sensitive << ( p_Val2_1_reg_171 );
    sensitive << ( p_Val2_2_fu_254_p4 );

    SC_METHOD(thread_tempQ_V_fu_274_p2);
    sensitive << ( p_Val2_3_reg_159 );
    sensitive << ( p_Val2_4_fu_264_p1 );

    SC_METHOD(thread_tmp_2_i_fu_240_p1);
    sensitive << ( b_i_reg_183 );

    SC_METHOD(thread_tmp_4_fu_206_p1);
    sensitive << ( a_1_fu_200_p2 );
    ...
    sc_trace(mVcdFile, exitcond_i_fu_228_p2, "exitcond_i_fu_228_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state8, "ap_CS_fsm_state8");
    sc_trace(mVcdFile, a_1_fu_200_p2, "a_1_fu_200_p2");
    sc_trace(mVcdFile, a_1_reg_283, "a_1_reg_283");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, tmp_fu_194_p2, "tmp_fu_194_p2");
    sc_trace(mVcdFile, buffIn_data_V_q0, "buffIn_data_V_q0");
    sc_trace(mVcdFile, buffIn_data_V_load_reg_298, "buffIn_data_V_load_reg_298");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, buffIn_last_V_q0, "buffIn_last_V_q0");
    sc_trace(mVcdFile, buffIn_last_V_load_reg_303, "buffIn_last_V_load_reg_303");
    sc_trace(mVcdFile, out_last_V_1_reg_308, "out_last_V_1_reg_308");
    sc_trace(mVcdFile, b_fu_234_p2, "b_fu_234_p2");
    sc_trace(mVcdFile, b_reg_316, "b_reg_316");
    sc_trace(mVcdFile, ap_block_state6_io, "ap_block_state6_io");
    sc_trace(mVcdFile, p_Result_s_fu_245_p3, "p_Result_s_fu_245_p3");
    sc_trace(mVcdFile, tempI_V_fu_268_p2, "tempI_V_fu_268_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state7, "ap_CS_fsm_state7");
    sc_trace(mVcdFile, tempQ_V_fu_274_p2, "tempQ_V_fu_274_p2");
    ...
    sc_trace(mVcdFile, a_reg_147, "a_reg_147");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, ap_CS_fsm_state1, "ap_CS_fsm_state1");
    sc_trace(mVcdFile, p_Val2_3_reg_159, "p_Val2_3_reg_159");
    sc_trace(mVcdFile, p_Val2_1_reg_171, "p_Val2_1_reg_171");
    sc_trace(mVcdFile, b_i_reg_183, "b_i_reg_183");
    sc_trace(mVcdFile, tmp_4_fu_206_p1, "tmp_4_fu_206_p1");
    sc_trace(mVcdFile, tmp_s_fu_212_p1, "tmp_s_fu_212_p1");
    sc_trace(mVcdFile, tmp_2_i_fu_240_p1, "tmp_2_i_fu_240_p1");
    sc_trace(mVcdFile, ap_block_state8, "ap_block_state8");
    sc_trace(mVcdFile, p_Val2_2_fu_254_p4, "p_Val2_2_fu_254_p4");
    sc_trace(mVcdFile, p_Val2_4_fu_264_p1, "p_Val2_4_fu_264_p1");
...
void matchFilter::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        p_Val2_1_reg_171 = tempI_V_fu_268_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
                esl_seteq<1,1,1>(in_data_V_0_vld_out.read(), ap_const_logic_1))) {
        p_Val2_1_reg_171 = ap_const_lv16_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        p_Val2_3_reg_159 = tempQ_V_fu_274_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
                esl_seteq<1,1,1>(in_data_V_0_vld_out.read(), ap_const_logic_1))) {
        p_Val2_3_reg_159 = ap_const_lv16_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_194_p2.read()))) {
        a_1_reg_283 = a_1_fu_200_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && esl_seteq<1,1,1>(ap_block_state6_io.read(), ap_const_boolean_0))) {
        b_reg_316 = b_fu_234_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        buffIn_data_V_load_reg_298 = buffIn_data_V_q0.read();
        buffIn_last_V_load_reg_303 = buffIn_last_V_q0.read();
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_data_V_1_load_A.read())) {
        out_data_V_1_payload_A = p_Result_s_fu_245_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_data_V_1_load_B.read())) {
        out_data_V_1_payload_B = p_Result_s_fu_245_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_last_V_1_load_A.read())) {
        out_last_V_1_payload_A = out_last_V_1_reg_308.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_last_V_1_load_B.read())) {
        out_last_V_1_payload_B = out_last_V_1_reg_308.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && esl_seteq<1,1,1>(in_data_V_0_vld_out.read(), ap_const_logic_1))) {
        out_last_V_1_reg_308 = in_last_V_0_data_out.read();
    }
}

void matchFilter::thread_a_1_fu_200_p2() {
    a_1_fu_200_p2 = (!a_reg_147.read().is_01() || !ap_const_lv7_7F.is_01())? sc_lv<7>(): (sc_biguint<7>(a_reg_147.read()) + sc_bigint<7>(ap_const_lv7_7F));
}
...
void matchFilter::thread_ap_CS_fsm_state8() {
    ap_CS_fsm_state8 = ap_CS_fsm.read()[7];
}

void matchFilter::thread_ap_block_state6_io() {
    ap_block_state6_io = (esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_i_fu_228_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, out_data_V_1_ack_in.read()));
}

void matchFilter::thread_ap_block_state8() {
    ap_block_state8 = (esl_seteq<1,1,1>(ap_const_logic_0, out_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_last_V_1_ack_in.read()));
}
...
void matchFilter::thread_b_fu_234_p2() {
    b_fu_234_p2 = (!b_i_reg_183.read().is_01() || !ap_const_lv8_1.is_01())? sc_lv<8>(): (sc_biguint<8>(b_i_reg_183.read()) + sc_biguint<8>(ap_const_lv8_1));
}

void matchFilter::thread_buffIn_data_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        buffIn_data_V_address0 =  (sc_lv<7>) (tmp_2_i_fu_240_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        buffIn_data_V_address0 =  (sc_lv<7>) (ap_const_lv64_0);
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        buffIn_data_V_address0 =  (sc_lv<7>) (tmp_s_fu_212_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        buffIn_data_V_address0 =  (sc_lv<7>) (tmp_4_fu_206_p1.read());
    } else {
...
void matchFilter::thread_buffIn_data_V_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        ...
        buffIn_data_V_d0 = buffIn_data_V_load_reg_298.read();
    } else {
...
void matchFilter::thread_buffIn_last_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        ...
        buffIn_last_V_address0 =  (sc_lv<7>) (tmp_s_fu_212_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        buffIn_last_V_address0 =  (sc_lv<7>) (tmp_4_fu_206_p1.read());
    } else {
...
void matchFilter::thread_buffIn_last_V_d0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        ...
        buffIn_last_V_d0 = buffIn_last_V_load_reg_303.read();
    } else {
...
void matchFilter::thread_exitcond_i_fu_228_p2() {
    exitcond_i_fu_228_p2 = (!b_i_reg_183.read().is_01() || !ap_const_lv8_80.is_01())? sc_lv<1>(): sc_lv<1>(b_i_reg_183.read() == ap_const_lv8_80);
}
...
void matchFilter::thread_out_data_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_i_fu_228_p2.read()) && 
         esl_seteq<1,1,1>(ap_block_state6_io.read(), ap_const_boolean_0))) {
...
void matchFilter::thread_p_Result_s_fu_245_p3() {
    p_Result_s_fu_245_p3 = esl_concat<16,16>(p_Val2_1_reg_171.read(), p_Val2_3_reg_159.read());
}

void matchFilter::thread_p_Val2_2_fu_254_p4() {
    p_Val2_2_fu_254_p4 = buffIn_data_V_q0.read().range(31, 16);
}

void matchFilter::thread_p_Val2_4_fu_264_p1() {
    p_Val2_4_fu_264_p1 = buffIn_data_V_q0.read().range(16-1, 0);
}

void matchFilter::thread_tempI_V_fu_268_p2() {
    tempI_V_fu_268_p2 = (!p_Val2_1_reg_171.read().is_01() || !p_Val2_2_fu_254_p4.read().is_01())? sc_lv<16>(): (sc_biguint<16>(p_Val2_1_reg_171.read()) + sc_biguint<16>(p_Val2_2_fu_254_p4.read()));
}

void matchFilter::thread_tempQ_V_fu_274_p2() {
    tempQ_V_fu_274_p2 = (!p_Val2_3_reg_159.read().is_01() || !p_Val2_4_fu_264_p1.read().is_01())? sc_lv<16>(): (sc_biguint<16>(p_Val2_3_reg_159.read()) + sc_biguint<16>(p_Val2_4_fu_264_p1.read()));
}

void matchFilter::thread_tmp_2_i_fu_240_p1() {
    tmp_2_i_fu_240_p1 = esl_zext<64,8>(b_i_reg_183.read());
}

void matchFilter::thread_tmp_4_fu_206_p1() {
    tmp_4_fu_206_p1 = esl_zext<64,7>(a_1_fu_200_p2.read());
}

void matchFilter::thread_tmp_fu_194_p2() {
    tmp_fu_194_p2 = (!a_reg_147.read().is_01() || !ap_const_lv7_0.is_01())? sc_lv<1>(): sc_lv<1>(a_reg_147.read() == ap_const_lv7_0);
}

void matchFilter::thread_tmp_s_fu_212_p1() {
    tmp_s_fu_212_p1 = esl_zext<64,7>(a_reg_147.read());
}
...
void matchFilter::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_fu_194_p2.read()))) {
        ...
        case 16 : 
            ...
            break;
        case 32 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_i_fu_228_p2.read()) && esl_seteq<1,1,1>(ap_block_state6_io.read(), ap_const_boolean_0))) {
                ap_NS_fsm = ap_ST_fsm_state8;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && esl_seteq<1,1,1>(ap_block_state6_io.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_228_p2.read()))) {
        ...
        case 64 : 
            ...
            break;
        case 128 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, out_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_last_V_1_ack_in.read())))) {
