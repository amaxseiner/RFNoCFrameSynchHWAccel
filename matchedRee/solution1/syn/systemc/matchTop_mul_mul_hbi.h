...
#ifndef __matchTop_mul_mul_hbi__HH__
#define __matchTop_mul_mul_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mul_mul_hbi) {
    ...
    SC_CTOR(matchTop_mul_mul_hbi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
