...
#ifndef __matchTop_mac_mulafYi__HH__
#define __matchTop_mac_mulafYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mac_mulafYi) {
    ...
    SC_CTOR(matchTop_mac_mulafYi):  simcore_mac_3_U ("simcore_mac_3_U") {
