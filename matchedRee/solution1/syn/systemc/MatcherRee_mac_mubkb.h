...
#ifndef __MatcherRee_mac_mubkb__HH__
#define __MatcherRee_mac_mubkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(MatcherRee_mac_mubkb) {
    ...
    SC_CTOR(MatcherRee_mac_mubkb):  simcore_mac_0_U ("simcore_mac_0_U") {
