...
#ifndef __matchTop_mul_mul_ocq__HH__
#define __matchTop_mul_mul_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mul_mul_ocq) {
    ...
    SC_CTOR(matchTop_mul_mul_ocq):  ACMP_mul_us_U ("ACMP_mul_us_U") {
