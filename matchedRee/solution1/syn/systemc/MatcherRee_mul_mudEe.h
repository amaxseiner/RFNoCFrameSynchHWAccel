...
#ifndef __MatcherRee_mul_mudEe__HH__
#define __MatcherRee_mul_mudEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MatcherRee_mul_mudEe) {
    ...
    SC_CTOR(MatcherRee_mul_mudEe):  ACMP_smul_us_U ("ACMP_smul_us_U") {
