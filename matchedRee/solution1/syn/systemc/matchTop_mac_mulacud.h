...
#ifndef __matchTop_mac_mulacud__HH__
#define __matchTop_mac_mulacud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mac_mulacud) {
    ...
    SC_CTOR(matchTop_mac_mulacud):  simcore_mac_0_U ("simcore_mac_0_U") {
