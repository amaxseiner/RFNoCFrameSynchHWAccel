...
#ifndef __matchTop_mul_mul_ncg__HH__
#define __matchTop_mul_mul_ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mul_mul_ncg) {
    ...
    SC_CTOR(matchTop_mul_mul_ncg):  ACMP_mul_us_U ("ACMP_mul_us_U") {
