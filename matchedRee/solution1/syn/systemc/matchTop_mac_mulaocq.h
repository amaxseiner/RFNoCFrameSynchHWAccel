...
#ifndef __matchTop_mac_mulaocq__HH__
#define __matchTop_mac_mulaocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mac_mulaocq) {
    ...
    SC_CTOR(matchTop_mac_mulaocq):  simcore_mac_12_U ("simcore_mac_12_U") {
