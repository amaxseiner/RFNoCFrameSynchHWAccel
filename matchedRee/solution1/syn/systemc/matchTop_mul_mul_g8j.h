...
#ifndef __matchTop_mul_mul_g8j__HH__
#define __matchTop_mul_mul_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mul_mul_g8j) {
    ...
    SC_CTOR(matchTop_mul_mul_g8j):  ACMP_mul_us_U ("ACMP_mul_us_U") {
