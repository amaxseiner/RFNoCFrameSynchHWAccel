...
#ifndef __matchTop_mul_mul_kbM__HH__
#define __matchTop_mul_mul_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mul_mul_kbM) {
    ...
    SC_CTOR(matchTop_mul_mul_kbM):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
