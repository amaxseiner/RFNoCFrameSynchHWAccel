...
#ifndef __matchTop_mac_mulahbi__HH__
#define __matchTop_mac_mulahbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mac_mulahbi) {
    ...
    SC_CTOR(matchTop_mac_mulahbi):  simcore_mac_5_U ("simcore_mac_5_U") {
