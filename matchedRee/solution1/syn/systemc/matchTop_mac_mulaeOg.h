...
#ifndef __matchTop_mac_mulaeOg__HH__
#define __matchTop_mac_mulaeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matchTop_mac_mulaeOg) {
    ...
    SC_CTOR(matchTop_mac_mulaeOg):  simcore_mac_2_U ("simcore_mac_2_U") {
