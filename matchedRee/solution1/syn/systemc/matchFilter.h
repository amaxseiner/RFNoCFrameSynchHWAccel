...
struct matchFilter : public sc_module {
    ...
    sc_signal< sc_logic > ap_var_for_const18;
    ...
    matchFilter_mux_1dEe<1,1,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,7,16>* matchFilter_mux_1dEe_U1;
    matchFilter_mac_meOg<1,3,16,16,21,21>* matchFilter_mac_meOg_U2;
    matchFilter_mac_meOg<1,3,16,16,21,21>* matchFilter_mac_meOg_U3;
    ...
    sc_signal< sc_lv<1> > exitcond_i_fu_272_p2;
    sc_signal< sc_logic > ap_CS_fsm_state10;
    sc_signal< sc_lv<32> > tmp_data_V_reg_641;
    sc_signal< sc_lv<1> > tmp_last_V_reg_646;
    sc_signal< sc_lv<7> > a_1_fu_254_p2;
    sc_signal< sc_lv<7> > a_1_reg_655;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<1> > tmp_s_fu_248_p2;
    sc_signal< sc_lv<32> > buffIn_data_V_q0;
    sc_signal< sc_lv<32> > buffIn_data_V_load_reg_670;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<1> > buffIn_last_V_q0;
    sc_signal< sc_lv<1> > buffIn_last_V_load_reg_675;
    sc_signal< sc_lv<8> > b_fu_278_p2;
    sc_signal< sc_lv<8> > b_reg_683;
    sc_signal< bool > ap_block_state6_io;
    sc_signal< sc_lv<7> > tmp_4_fu_289_p1;
    sc_signal< sc_lv<7> > tmp_4_reg_693;
    sc_signal< sc_lv<32> > p_Result_s_fu_293_p3;
    sc_signal< sc_lv<21> > tmp_fu_577_p1;
    ...
    sc_signal< sc_lv<7> > a_reg_193;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< sc_lv<16> > p_Val2_3_reg_205;
    sc_signal< sc_lv<16> > p_Val2_1_reg_217;
    sc_signal< sc_lv<8> > b_i_reg_229;
    sc_signal< sc_lv<64> > tmp_8_fu_260_p1;
    sc_signal< sc_lv<64> > tmp_7_fu_266_p1;
    sc_signal< sc_lv<64> > tmp_2_i_fu_284_p1;
    sc_signal< bool > ap_block_state10;
    sc_signal< sc_lv<16> > merge_i_fu_316_p130;
    sc_signal< sc_lv<16> > inI_V_fu_302_p4;
    sc_signal< sc_lv<16> > inQ_V_fu_312_p1;
    sc_signal< sc_lv<21> > grp_fu_623_p3;
    sc_signal< sc_lv<21> > grp_fu_632_p3;
    sc_signal< sc_lv<16> > grp_fu_623_p0;
    sc_signal< sc_lv<21> > grp_fu_623_p2;
    sc_signal< sc_lv<16> > grp_fu_632_p0;
    sc_signal< sc_lv<21> > grp_fu_632_p2;
