...
#ifndef __correlateTopSynchbkb__HH__
#define __correlateTopSynchbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(correlateTopSynchbkb) {
    ...
    SC_CTOR(correlateTopSynchbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
