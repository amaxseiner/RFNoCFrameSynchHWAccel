...
architecture behav of correlator is 
    ...
    "correlator,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=6.576000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=384,HLS_SYN_LUT=446}";
    ...
    signal currentState_load_load_fu_171_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp3_fu_251_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp3_reg_545 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp6_fu_269_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp6_reg_550 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp14_fu_311_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp14_reg_555 : STD_LOGIC_VECTOR (15 downto 0);
    signal cond_fu_331_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_data_V_fu_524_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal tmp_15_fu_321_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_Val2_3_s_fu_507_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp2_fu_245_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp1_fu_239_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp5_fu_263_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp4_fu_257_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp9_fu_281_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp8_fu_275_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp12_fu_299_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp11_fu_293_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp13_fu_305_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp10_fu_287_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp7_fu_503_p2 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((currentState = ap_const_lv2_1) and (tmp_nbreadreq_fu_130_p4 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((currentState = ap_const_lv2_1) and (cond_fu_331_p2 = ap_const_lv1_1) and (tmp_nbreadreq_fu_130_p4 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
                    currentState <= ap_const_lv2_2;
                elsif ((((currentState_load_load_fu_171_p1 = ap_const_lv2_0) and (start_V_read_read_fu_124_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((currentState_load_load_fu_171_p1 = ap_const_lv2_2) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((currentState = ap_const_lv2_1) and (cond_fu_331_p2 = ap_const_lv1_1) and (tmp_nbreadreq_fu_130_p4 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((currentState_load_load_fu_171_p1 = ap_const_lv2_2) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter2, ap_predicate_op41_read_state1)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((o_data_V_last_V_1_ack_in = ap_const_logic_0) or (o_data_V_data_V_1_ack_in = ap_const_logic_0))) or ((ap_predicate_op41_read_state1 = ap_const_boolean_1) and (i_data_TVALID = ap_const_logic_0) and (ap_const_logic_1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_predicate_op41_read_state1, ap_block_state2_io, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state3_io) or (o_data_V_last_V_1_ack_in = ap_const_logic_0) or (o_data_V_data_V_1_ack_in = ap_const_logic_0))) or ((ap_const_boolean_1 = ap_block_state2_io) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op41_read_state1 = ap_const_boolean_1) and (i_data_TVALID = ap_const_logic_0) and (ap_const_logic_1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_predicate_op41_read_state1, ap_block_state2_io, ap_block_state3_io)
    begin
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(i_data_TVALID, ap_predicate_op41_read_state1)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_predicate_op41_read_state1 = ap_const_boolean_1) and (i_data_TVALID = ap_const_logic_0));
    end process;


    ap_block_state2_io_assign_proc : process(o_data_V_data_V_1_ack_in, currentState_load_reg_541)
    begin
                ap_block_state2_io <= ((currentState_load_reg_541 = ap_const_lv2_2) and (o_data_V_data_V_1_ack_in = ap_const_logic_0));
    end process;

        ap_block_state2_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_io_assign_proc : process(o_data_V_data_V_1_ack_in, ap_reg_pp0_iter1_currentState_load_reg_541)
    begin
                ap_block_state3_io <= ((ap_reg_pp0_iter1_currentState_load_reg_541 = ap_const_lv2_2) and (o_data_V_data_V_1_ack_in = ap_const_logic_0));
    end process;
    ...
    ap_predicate_op41_read_state1_assign_proc : process(currentState, tmp_nbreadreq_fu_130_p4)
    begin
                ap_predicate_op41_read_state1 <= ((currentState = ap_const_lv2_1) and (tmp_nbreadreq_fu_130_p4 = ap_const_lv1_1));
    end process;
    ...
    cond_fu_331_p2 <= "1" when (phaseClass_V = ap_const_lv4_0) else "0";
    currentState_load_load_fu_171_p1 <= currentState;
    ...
    i_data_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_predicate_op41_read_state1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_predicate_op41_read_state1 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    o_data_TDATA_blk_n_assign_proc : process(o_data_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_541, ap_enable_reg_pp0_iter2, ap_reg_pp0_iter1_currentState_load_reg_541)
    begin
        if ((((ap_reg_pp0_iter1_currentState_load_reg_541 = ap_const_lv2_2) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((currentState_load_reg_541 = ap_const_lv2_2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0)))) then 
    ...
    o_data_V_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_541, ap_block_pp0_stage0_11001)
    begin
        if (((currentState_load_reg_541 = ap_const_lv2_2) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    o_data_V_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_541, ap_block_pp0_stage0_11001)
    begin
        if (((currentState_load_reg_541 = ap_const_lv2_2) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    p_Val2_3_s_fu_507_p2 <= std_logic_vector(unsigned(tmp14_reg_555) + unsigned(tmp7_fu_503_p2));
    start_V_read_read_fu_124_p2 <= start_V;
    tmp10_fu_287_p2 <= std_logic_vector(unsigned(tmp9_fu_281_p2) + unsigned(tmp8_fu_275_p2));
    tmp11_fu_293_p2 <= std_logic_vector(unsigned(phaseClass0_V_12) + unsigned(phaseClass0_V_9));
    tmp12_fu_299_p2 <= std_logic_vector(unsigned(phaseClass0_V_10) + unsigned(phaseClass0_V_0));
    tmp13_fu_305_p2 <= std_logic_vector(unsigned(tmp12_fu_299_p2) + unsigned(tmp11_fu_293_p2));
    tmp14_fu_311_p2 <= std_logic_vector(unsigned(tmp13_fu_305_p2) + unsigned(tmp10_fu_287_p2));
    tmp1_fu_239_p2 <= std_logic_vector(unsigned(phaseClass0_V_2) + unsigned(phaseClass0_V_1));
    tmp2_fu_245_p2 <= std_logic_vector(unsigned(phaseClass0_V_3) + unsigned(phaseClass0_V_4));
    tmp3_fu_251_p2 <= std_logic_vector(unsigned(tmp2_fu_245_p2) + unsigned(tmp1_fu_239_p2));
    tmp4_fu_257_p2 <= std_logic_vector(unsigned(phaseClass0_V_7) + unsigned(phaseClass0_V_8));
    tmp5_fu_263_p2 <= std_logic_vector(unsigned(phaseClass0_V_5) + unsigned(phaseClass0_V_6));
    tmp6_fu_269_p2 <= std_logic_vector(unsigned(tmp5_fu_263_p2) + unsigned(tmp4_fu_257_p2));
    tmp7_fu_503_p2 <= std_logic_vector(unsigned(tmp6_reg_550) + unsigned(tmp3_reg_545));
    tmp8_fu_275_p2 <= std_logic_vector(unsigned(phaseClass0_V_15) + unsigned(phaseClass0_V_13));
    tmp9_fu_281_p2 <= std_logic_vector(unsigned(phaseClass0_V_14) + unsigned(phaseClass0_V_11));
    tmp_15_fu_321_p1 <= i_data_TDATA(16 - 1 downto 0);
    tmp_data_V_fu_524_p5 <= (ap_const_lv32_0(31 downto 16) & p_Val2_3_s_fu_507_p2);
