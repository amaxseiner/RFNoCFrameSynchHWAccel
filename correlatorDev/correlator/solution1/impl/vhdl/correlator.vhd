...
architecture behav of correlator is 
    ...
    "correlator,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=8.693000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=370,HLS_SYN_LUT=353}";
    ...
    signal currentState_load_load_fu_178_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_1_fu_186_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_1_reg_532 : STD_LOGIC_VECTOR (15 downto 0);
    signal cond_fu_196_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal cond_reg_537 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_s_fu_374_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_phi_mux_storemerge_phi_fu_164_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_phi_reg_pp0_iter0_storemerge_reg_161 : STD_LOGIC_VECTOR (1 downto 0);
    signal p_Val2_3_4_fu_356_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp9_fu_320_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp8_fu_314_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp2_fu_338_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp3_fu_344_p2 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
            ...
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_const_boolean_1 = ap_condition_269)) then
                    if (((currentState_load_reg_524 = ap_const_lv2_1) and (tmp_reg_528 = ap_const_lv1_1))) then 
                        ...
                        corHelperI_V <= p_Val2_3_4_fu_356_p2;
                    end if;
                end if; 
            end if;
        end if;
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((currentState = ap_const_lv2_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    currentState <= ap_phi_mux_storemerge_phi_fu_164_p4;
                elsif ((((currentState_load_load_fu_178_p1 = ap_const_lv2_0) and (start_V_read_read_fu_126_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((currentState_load_load_fu_178_p1 = ap_const_lv2_2) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((currentState_load_reg_524 = ap_const_lv2_1) and (cond_reg_537 = ap_const_lv1_1) and (tmp_reg_528 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    phaseClass0_V_0 <= tmp_1_reg_532;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_predicate_op11_read_state1 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                cond_reg_537 <= cond_fu_196_p2;
                tmp_1_reg_532 <= tmp_1_fu_186_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((o_data_V_data_V_1_load_A = ap_const_logic_1)) then
                o_data_V_data_V_1_payload_A <= p_Result_s_fu_374_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((o_data_V_data_V_1_load_B = ap_const_logic_1)) then
                o_data_V_data_V_1_payload_B <= p_Result_s_fu_374_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((currentState = ap_const_lv2_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_reg_528 <= tmp_nbreadreq_fu_132_p4;
            end if;
        end if;
    end process;
    ...
    ap_block_state2_io_assign_proc : process(o_data_V_data_V_1_ack_in, currentState_load_reg_524)
    begin
                ap_block_state2_io <= ((currentState_load_reg_524 = ap_const_lv2_2) and (o_data_V_data_V_1_ack_in = ap_const_logic_0));
    end process;

        ap_block_state2_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_io_assign_proc : process(o_data_V_data_V_1_ack_in, ap_reg_pp0_iter1_currentState_load_reg_524)
    begin
                ap_block_state3_io <= ((ap_reg_pp0_iter1_currentState_load_reg_524 = ap_const_lv2_2) and (o_data_V_data_V_1_ack_in = ap_const_logic_0));
    end process;
    ...
    begin
                ap_condition_269 <= ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;


    ap_condition_423_assign_proc : process(currentState, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0)
    begin
                ap_condition_423 <= ((currentState = ap_const_lv2_1) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0));
    end process;
    ...
    ap_phi_mux_storemerge_phi_fu_164_p4_assign_proc : process(tmp_nbreadreq_fu_132_p4, ap_phi_reg_pp0_iter0_storemerge_reg_161, ap_condition_423)
    begin
        if ((ap_const_boolean_1 = ap_condition_423)) then
            if ((tmp_nbreadreq_fu_132_p4 = ap_const_lv1_1)) then 
                ap_phi_mux_storemerge_phi_fu_164_p4 <= ap_const_lv2_2;
            elsif ((tmp_nbreadreq_fu_132_p4 = ap_const_lv1_0)) then 
                ap_phi_mux_storemerge_phi_fu_164_p4 <= ap_const_lv2_1;
            else 
                ap_phi_mux_storemerge_phi_fu_164_p4 <= ap_phi_reg_pp0_iter0_storemerge_reg_161;
            end if;
        else 
            ap_phi_mux_storemerge_phi_fu_164_p4 <= ap_phi_reg_pp0_iter0_storemerge_reg_161;
        end if; 
    ...
    ap_phi_reg_pp0_iter0_storemerge_reg_161 <= "XX";

    ap_predicate_op11_read_state1_assign_proc : process(currentState, tmp_nbreadreq_fu_132_p4)
    begin
                ap_predicate_op11_read_state1 <= ((currentState = ap_const_lv2_1) and (tmp_nbreadreq_fu_132_p4 = ap_const_lv1_1));
    end process;
    ...
    cond_fu_196_p2 <= "1" when (phaseClass_V = ap_const_lv4_0) else "0";
    currentState_load_load_fu_178_p1 <= currentState;
    ...
    o_data_TDATA_blk_n_assign_proc : process(o_data_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_524, ap_enable_reg_pp0_iter2, ap_reg_pp0_iter1_currentState_load_reg_524)
    begin
        if ((((ap_reg_pp0_iter1_currentState_load_reg_524 = ap_const_lv2_2) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((currentState_load_reg_524 = ap_const_lv2_2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0)))) then 
    ...
    o_data_V_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_524, ap_block_pp0_stage0_11001)
    begin
        if (((currentState_load_reg_524 = ap_const_lv2_2) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    o_data_V_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_524, ap_block_pp0_stage0_11001)
    begin
        if (((currentState_load_reg_524 = ap_const_lv2_2) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    p_Result_s_fu_374_p5 <= (ap_const_lv32_0(31 downto 16) & p_Val2_3_4_fu_356_p2);
    p_Val2_3_4_fu_356_p2 <= std_logic_vector(unsigned(tmp4_fu_350_p2) + unsigned(tmp7_fu_326_p2));
    start_V_read_read_fu_126_p2 <= start_V;
    tmp1_fu_332_p2 <= std_logic_vector(unsigned(corHelperI_V) + unsigned(phaseClass0_V_15));
    tmp2_fu_338_p2 <= std_logic_vector(unsigned(phaseClass0_V_13) + unsigned(phaseClass0_V_0));
    tmp3_fu_344_p2 <= std_logic_vector(unsigned(tmp2_fu_338_p2) + unsigned(phaseClass0_V_10));
    tmp4_fu_350_p2 <= std_logic_vector(unsigned(tmp3_fu_344_p2) + unsigned(tmp1_fu_332_p2));
    tmp7_fu_326_p2 <= std_logic_vector(unsigned(tmp9_fu_320_p2) + unsigned(tmp8_fu_314_p2));
    tmp8_fu_314_p2 <= std_logic_vector(unsigned(phaseClass0_V_2) + unsigned(phaseClass0_V_1));
    tmp9_fu_320_p2 <= std_logic_vector(unsigned(phaseClass0_V_3) + unsigned(phaseClass0_V_8));
    tmp_1_fu_186_p1 <= i_data_TDATA(16 - 1 downto 0);
