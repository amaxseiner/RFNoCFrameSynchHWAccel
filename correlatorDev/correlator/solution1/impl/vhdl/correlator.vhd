...
architecture behav of correlator is 
    ...
    "correlator,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=7.574125,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=411,HLS_SYN_LUT=492}";
    ...
    signal currentState_load_load_fu_458_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_nbreadreq_fu_424_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal o_data_TDATA_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal currentState_load_reg_2124 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_reg_2128 : STD_LOGIC_VECTOR (0 downto 0);
    signal phaseClass_V_read_reg_2116 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_reg_pp0_iter1_currentState_load_reg_2124 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_reg_pp0_iter1_tmp_reg_2128 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_reg_pp0_iter1_phaseClass_V_read_reg_2116 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_predicate_op12_read_state1 : BOOLEAN;
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_predicate_op351_write_state2 : BOOLEAN;
    signal ap_block_state2_io : BOOLEAN;
    signal ap_block_state3_pp0_stage0_iter2 : BOOLEAN;
    signal ap_predicate_op375_write_state3 : BOOLEAN;
    signal ap_block_state3_io : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal start_V_read_read_fu_418_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_last_V_reg_2132 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_fu_470_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_1_reg_2137 : STD_LOGIC_VECTOR (15 downto 0);
    signal loc_V_fu_2081_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal tmp_s_fu_2104_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_2_fu_1854_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_2_fu_1866_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_5_fu_1878_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_7_fu_1890_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_s_fu_1942_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_1_fu_1964_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_3_fu_1986_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_4_fu_2008_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_71_1_cast_fu_1972_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_71_cast_fu_1950_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_71_3_cast_fu_1994_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp9_fu_2025_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp8_fu_2019_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp9_cast_fu_2031_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_cast_fu_1862_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_71_7_cast_fu_1898_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp1_fu_2041_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_71_4_cast_fu_2015_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_71_2_cast_fu_1874_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp2_fu_2051_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_71_5_cast_fu_1886_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp13_cast_fu_2057_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp3_fu_2061_p2 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp11_cast_fu_2047_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp12_cast_fu_2067_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp4_fu_2071_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp7_fu_2035_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp10_cast_fu_2077_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op351_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    corHelperI_V <= loc_V_fu_2081_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_reg_pp0_iter1_tmp_reg_2128 = ap_const_lv1_1) and (ap_reg_pp0_iter1_currentState_load_reg_2124 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
                    loadCount_V <= tmp_s_fu_2104_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op351_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    phaseClass0_V_0 <= tmp_1_reg_2137;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ap_reg_pp0_iter1_currentState_load_reg_2124 <= currentState_load_reg_2124;
                ap_reg_pp0_iter1_phaseClass_V_read_reg_2116 <= phaseClass_V_read_reg_2116;
                ap_reg_pp0_iter1_tmp_reg_2128 <= tmp_reg_2128;
                currentState_load_reg_2124 <= currentState;
                phaseClass_V_read_reg_2116 <= phaseClass_V;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((o_data_V_data_V_1_load_A = ap_const_logic_1)) then
                o_data_V_data_V_1_payload_A <= loc_V_fu_2081_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((o_data_V_data_V_1_load_B = ap_const_logic_1)) then
                o_data_V_data_V_1_payload_B <= loc_V_fu_2081_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((o_data_V_last_V_1_load_A = ap_const_logic_1)) then
                o_data_V_last_V_1_payload_A <= tmp_last_V_reg_2132;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((o_data_V_last_V_1_load_B = ap_const_logic_1)) then
                o_data_V_last_V_1_payload_B <= tmp_last_V_reg_2132;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op12_read_state1 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_1_reg_2137 <= tmp_1_fu_470_p1;
                tmp_last_V_reg_2132 <= i_data_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((currentState = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_reg_2128 <= tmp_nbreadreq_fu_424_p4;
            end if;
        end if;
    end process;
    ...
    ap_block_state2_io_assign_proc : process(o_data_V_data_V_1_ack_in, ap_predicate_op351_write_state2)
    begin
                ap_block_state2_io <= ((ap_predicate_op351_write_state2 = ap_const_boolean_1) and (o_data_V_data_V_1_ack_in = ap_const_logic_0));
    end process;

        ap_block_state2_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_io_assign_proc : process(o_data_V_data_V_1_ack_in, ap_predicate_op375_write_state3)
    begin
                ap_block_state3_io <= ((ap_predicate_op375_write_state3 = ap_const_boolean_1) and (o_data_V_data_V_1_ack_in = ap_const_logic_0));
    end process;
    ...
    ap_predicate_op12_read_state1_assign_proc : process(currentState, tmp_nbreadreq_fu_424_p4)
    begin
                ap_predicate_op12_read_state1 <= ((tmp_nbreadreq_fu_424_p4 = ap_const_lv1_1) and (currentState = ap_const_lv1_1));
    end process;


    ap_predicate_op351_write_state2_assign_proc : process(currentState_load_reg_2124, tmp_reg_2128, phaseClass_V_read_reg_2116)
    begin
                ap_predicate_op351_write_state2 <= ((tmp_reg_2128 = ap_const_lv1_1) and (currentState_load_reg_2124 = ap_const_lv1_1) and (phaseClass_V_read_reg_2116 = ap_const_lv4_0));
    end process;


    ap_predicate_op375_write_state3_assign_proc : process(ap_reg_pp0_iter1_currentState_load_reg_2124, ap_reg_pp0_iter1_tmp_reg_2128, ap_reg_pp0_iter1_phaseClass_V_read_reg_2116)
    begin
                ap_predicate_op375_write_state3 <= ((ap_reg_pp0_iter1_tmp_reg_2128 = ap_const_lv1_1) and (ap_reg_pp0_iter1_currentState_load_reg_2124 = ap_const_lv1_1) and (ap_reg_pp0_iter1_phaseClass_V_read_reg_2116 = ap_const_lv4_0));
    end process;
    ...
    currentState_load_load_fu_458_p1 <= currentState;

    i_data_TDATA_blk_n_assign_proc : process(i_data_TVALID, currentState, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, tmp_nbreadreq_fu_424_p4)
    begin
        if (((tmp_nbreadreq_fu_424_p4 = ap_const_lv1_1) and (currentState = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op12_read_state1 = ap_const_boolean_1) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    loc_V_fu_2081_p2 <= std_logic_vector(unsigned(tmp7_fu_2035_p2) + unsigned(tmp10_cast_fu_2077_p1));
    o_data_TDATA <= o_data_V_data_V_1_data_out;

    o_data_TDATA_blk_n_assign_proc : process(o_data_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_2124, tmp_reg_2128, phaseClass_V_read_reg_2116, ap_enable_reg_pp0_iter2, ap_reg_pp0_iter1_currentState_load_reg_2124, ap_reg_pp0_iter1_tmp_reg_2128, ap_reg_pp0_iter1_phaseClass_V_read_reg_2116)
    begin
        if ((((ap_reg_pp0_iter1_tmp_reg_2128 = ap_const_lv1_1) and (ap_reg_pp0_iter1_currentState_load_reg_2124 = ap_const_lv1_1) and (ap_reg_pp0_iter1_phaseClass_V_read_reg_2116 = ap_const_lv4_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((tmp_reg_2128 = ap_const_lv1_1) and (currentState_load_reg_2124 = ap_const_lv1_1) and (phaseClass_V_read_reg_2116 = ap_const_lv4_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    o_data_V_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op351_write_state2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op351_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    o_data_V_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op351_write_state2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op351_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    start_V_read_read_fu_418_p2 <= start_V;
        tmp10_cast_fu_2077_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp4_fu_2071_p2),32));

        tmp11_cast_fu_2047_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp1_fu_2041_p2),24));

        tmp12_cast_fu_2067_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp3_fu_2061_p2),24));

        tmp13_cast_fu_2057_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp2_fu_2051_p2),23));

    tmp1_fu_2041_p2 <= std_logic_vector(signed(tmp_2_cast_fu_1862_p1) + signed(tmp_71_7_cast_fu_1898_p1));
    tmp2_fu_2051_p2 <= std_logic_vector(signed(tmp_71_4_cast_fu_2015_p1) + signed(tmp_71_2_cast_fu_1874_p1));
    tmp3_fu_2061_p2 <= std_logic_vector(signed(tmp_71_5_cast_fu_1886_p1) + signed(tmp13_cast_fu_2057_p1));
    tmp4_fu_2071_p2 <= std_logic_vector(signed(tmp11_cast_fu_2047_p1) + signed(tmp12_cast_fu_2067_p1));
    tmp7_fu_2035_p2 <= std_logic_vector(unsigned(tmp8_fu_2019_p2) + unsigned(tmp9_cast_fu_2031_p1));
    tmp8_fu_2019_p2 <= std_logic_vector(signed(tmp_71_1_cast_fu_1972_p1) + signed(corHelperI_V));
        tmp9_cast_fu_2031_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp9_fu_2025_p2),32));

    tmp9_fu_2025_p2 <= std_logic_vector(signed(tmp_71_cast_fu_1950_p1) + signed(tmp_71_3_cast_fu_1994_p1));
    tmp_1_fu_470_p1 <= i_data_TDATA(16 - 1 downto 0);
        tmp_2_cast_fu_1862_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_2_fu_1854_p3),22));

    tmp_2_fu_1854_p3 <= (phaseClass0_V_14 & ap_const_lv5_0);
        tmp_71_1_cast_fu_1972_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_71_1_fu_1964_p3),32));

    tmp_71_1_fu_1964_p3 <= (phaseClass0_V_1 & ap_const_lv5_0);
        tmp_71_2_cast_fu_1874_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_71_2_fu_1866_p3),22));

    tmp_71_2_fu_1866_p3 <= (phaseClass0_V_12 & ap_const_lv5_0);
        tmp_71_3_cast_fu_1994_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_71_3_fu_1986_p3),22));

    tmp_71_3_fu_1986_p3 <= (phaseClass0_V_0 & ap_const_lv5_0);
        tmp_71_4_cast_fu_2015_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_71_4_fu_2008_p3),22));

    tmp_71_4_fu_2008_p3 <= (tmp_1_reg_2137 & ap_const_lv5_0);
        tmp_71_5_cast_fu_1886_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_71_5_fu_1878_p3),23));

    tmp_71_5_fu_1878_p3 <= (phaseClass0_V_9 & ap_const_lv5_0);
        tmp_71_7_cast_fu_1898_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_71_7_fu_1890_p3),22));

    tmp_71_7_fu_1890_p3 <= (phaseClass0_V_7 & ap_const_lv5_0);
        tmp_71_cast_fu_1950_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_71_s_fu_1942_p3),22));

    tmp_71_s_fu_1942_p3 <= (phaseClass0_V_2 & ap_const_lv5_0);
    tmp_nbreadreq_fu_424_p4 <= (0=>(i_data_TVALID), others=>'-');
    tmp_s_fu_2104_p2 <= std_logic_vector(unsigned(loadCount_V) + unsigned(ap_const_lv32_1));
end behav;
