...
(* CORE_GENERATION_INFO="correlator,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=8.693000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=370,HLS_SYN_LUT=353}" *)
...
wire   [1:0] currentState_load_load_fu_178_p1;
...
reg   [0:0] tmp_reg_528;
wire   [15:0] tmp_1_fu_186_p1;
reg   [15:0] tmp_1_reg_532;
wire   [0:0] cond_fu_196_p2;
reg   [0:0] cond_reg_537;
wire   [31:0] p_Result_s_fu_374_p5;
reg    ap_block_pp0_stage0_subdone;
reg   [1:0] ap_phi_mux_storemerge_phi_fu_164_p4;
wire   [1:0] ap_phi_reg_pp0_iter0_storemerge_reg_161;
wire   [15:0] p_Val2_3_4_fu_356_p2;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] tmp9_fu_320_p2;
wire   [15:0] tmp8_fu_314_p2;
wire   [15:0] tmp2_fu_338_p2;
wire   [15:0] tmp3_fu_344_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((currentState_load_load_fu_178_p1 == 2'd0) & (start_V_read_read_fu_126_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((currentState_load_load_fu_178_p1 == 2'd2) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
            currentState <= 2'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((currentState_load_reg_524 == 2'd1) & (cond_reg_537 == 1'd1) & (tmp_reg_528 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_423)) begin
        if ((tmp_nbreadreq_fu_132_p4 == 1'd1)) begin
            ap_phi_mux_storemerge_phi_fu_164_p4 = 2'd2;
        end else if ((tmp_nbreadreq_fu_132_p4 == 1'd0)) begin
            ap_phi_mux_storemerge_phi_fu_164_p4 = 2'd1;
        end else begin
...
always @ (*) begin
    if (((currentState == 2'd1) & (tmp_nbreadreq_fu_132_p4 == 1'd1) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((((ap_reg_pp0_iter1_currentState_load_reg_524 == 2'd2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0)) | ((currentState_load_reg_524 == 2'd2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    if (((currentState_load_reg_524 == 2'd2) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_state2_io = ((currentState_load_reg_524 == 2'd2) & (o_data_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state2_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_io = ((ap_reg_pp0_iter1_currentState_load_reg_524 == 2'd2) & (o_data_V_data_V_1_ack_in == 1'b0));
end
...
always @ (*) begin
    ap_condition_269 = ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

always @ (*) begin
    ap_condition_423 = ((currentState == 2'd1) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_phi_reg_pp0_iter0_storemerge_reg_161 = 'bx;

always @ (*) begin
    ap_predicate_op11_read_state1 = ((currentState == 2'd1) & (tmp_nbreadreq_fu_132_p4 == 1'd1));
end
...
assign cond_fu_196_p2 = ((phaseClass_V == 4'd0) ? 1'b1 : 1'b0);

assign currentState_load_load_fu_178_p1 = currentState;
...
assign p_Result_s_fu_374_p5 = {{ap_const_lv32_0[31:16]}, {p_Val2_3_4_fu_356_p2}};

assign p_Val2_3_4_fu_356_p2 = (tmp4_fu_350_p2 + tmp7_fu_326_p2);

assign start_V_read_read_fu_126_p2 = start_V;

assign tmp1_fu_332_p2 = (corHelperI_V + phaseClass0_V_15);

assign tmp2_fu_338_p2 = (phaseClass0_V_13 + phaseClass0_V_0);

assign tmp3_fu_344_p2 = (tmp2_fu_338_p2 + phaseClass0_V_10);

assign tmp4_fu_350_p2 = (tmp3_fu_344_p2 + tmp1_fu_332_p2);

assign tmp7_fu_326_p2 = (tmp9_fu_320_p2 + tmp8_fu_314_p2);

assign tmp8_fu_314_p2 = (phaseClass0_V_2 + phaseClass0_V_1);

assign tmp9_fu_320_p2 = (phaseClass0_V_3 + phaseClass0_V_8);

assign tmp_1_fu_186_p1 = i_data_TDATA[15:0];
