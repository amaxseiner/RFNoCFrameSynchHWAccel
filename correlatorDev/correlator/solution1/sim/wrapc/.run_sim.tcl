...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "correlateTop.autotvin.dat"
	set constFileTvOut       "correlateTop.autotvout.dat"
	set constFileHdlTvIn     "correlateTop.autohdltvin.dat"
	set constFileHdlTvOut    "correlateTop.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
