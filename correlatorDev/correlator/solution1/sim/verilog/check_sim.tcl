...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.correlateTop.autotvin_i_data_data_V.dat"
         ...
         "c.correlateTop.autotvin_phaseClass_V.dat"
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.correlateTop.autotvout_o_data_data_V.dat"
         "rtl.correlateTop.autotvout_o_data_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
