...
if {[file isfile correlateTop.autotvin.dat]} {
	file delete -force correlateTop.autotvin.dat
}

if {[file isfile correlateTop.autotvout.dat]} {
	file delete -force correlateTop.autotvout.dat
}
