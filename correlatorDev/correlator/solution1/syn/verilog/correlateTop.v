...
(* CORE_GENERATION_INFO="correlateTop,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=7.637000,HLS_SYN_LAT=3,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=621,HLS_SYN_LUT=782}" *)
...
reg   [0:0] currentState_load_reg_463;
reg    o_data_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] ap_reg_pp0_iter1_currentState_load_reg_463;
reg    ap_enable_reg_pp0_iter3;
reg   [0:0] ap_reg_pp0_iter2_currentState_load_reg_463;
wire   [0:0] start_V_read_read_fu_92_p2;
reg   [0:0] start_V_read_reg_459;
...
reg   [0:0] ap_reg_pp0_iter1_start_V_read_reg_459;
reg   [0:0] ap_reg_pp0_iter2_start_V_read_reg_459;
wire   [0:0] currentState_load_load_fu_144_p1;
wire   [0:0] cond_i_fu_148_p2;
reg   [0:0] cond_i_reg_467;
reg   [0:0] i_data_last_V_tmp_reg_471;
wire   [15:0] p_Val2_5_1_i_fu_358_p2;
wire   [15:0] p_Val2_2_4_i_fu_400_p2;
wire  signed [31:0] o_data_data_V_tmp_fu_432_p1;
reg    ap_block_pp0_stage0_subdone;
wire   [15:0] ap_phi_reg_pp0_iter0_p_Val2_1_reg_116;
reg   [15:0] ap_phi_reg_pp0_iter1_p_Val2_1_reg_116;
reg   [15:0] ap_phi_reg_pp0_iter2_p_Val2_1_reg_116;
wire   [15:0] ap_phi_reg_pp0_iter0_p_Val2_2_reg_127;
reg   [15:0] ap_phi_reg_pp0_iter1_p_Val2_2_reg_127;
reg   [15:0] ap_phi_reg_pp0_iter2_p_Val2_2_reg_127;
wire   [31:0] tmp_2_fu_447_p2;
wire   [15:0] tmp_1_fu_162_p1;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] tmp2_fu_328_p2;
wire   [15:0] tmp1_fu_322_p2;
wire   [15:0] tmp5_fu_346_p2;
wire   [15:0] tmp4_fu_340_p2;
wire   [15:0] tmp3_fu_352_p2;
wire   [15:0] tmp_fu_334_p2;
wire   [15:0] tmp8_fu_370_p2;
wire   [15:0] tmp7_fu_364_p2;
wire   [15:0] tmp11_fu_388_p2;
wire   [15:0] tmp10_fu_382_p2;
wire   [15:0] tmp9_fu_394_p2;
wire   [15:0] tmp6_fu_376_p2;
wire   [0:0] tmp_i_fu_406_p2;
wire   [15:0] p_Val2_8_i_fu_418_p2;
wire   [15:0] p_Val2_9_i_fu_412_p2;
wire   [15:0] res_V_fu_424_p3;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((cond_i_reg_467 == 1'd1) & (currentState_load_reg_463 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((start_V_read_read_fu_92_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (currentState_load_load_fu_144_p1 == 1'd0) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((currentState_load_load_fu_144_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
            currentState <= 1'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
            if ((ap_reg_pp0_iter2_currentState_load_reg_463 == 1'd1)) begin
                loadCount_V <= tmp_2_fu_447_p2;
            end else if (((ap_reg_pp0_iter2_start_V_read_reg_459 == 1'd1) & (ap_reg_pp0_iter2_currentState_load_reg_463 == 1'd0))) begin
                loadCount_V <= 32'd0;
            end
        end
    end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_365)) begin
        if (((currentState_load_load_fu_144_p1 == 1'd1) & (cond_i_fu_148_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_p_Val2_1_reg_116 <= 16'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_365)) begin
        if (((currentState_load_load_fu_144_p1 == 1'd1) & (cond_i_fu_148_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_p_Val2_2_reg_127 <= 16'd0;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_367)) begin
        if (((cond_i_reg_467 == 1'd1) & (currentState_load_reg_463 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((currentState_load_load_fu_144_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((currentState_load_reg_463 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((currentState_load_reg_463 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((currentState_load_reg_463 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((ap_reg_pp0_iter2_currentState_load_reg_463 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((ap_reg_pp0_iter1_currentState_load_reg_463 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    if (((ap_reg_pp0_iter1_currentState_load_reg_463 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter3 == 1'b1) & ((o_data_last_V_1_ack_in == 1'b0) | (o_data_data_V_1_ack_in == 1'b0))) | ((currentState_load_reg_463 == 1'd1) & (i_data_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter3 == 1'b1) & ((o_data_last_V_1_ack_in == 1'b0) | (o_data_data_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state4_io))) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((currentState_load_reg_463 == 1'd1) & (i_data_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter3 == 1'b1) & ((o_data_last_V_1_ack_in == 1'b0) | (o_data_data_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state4_io))) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((currentState_load_reg_463 == 1'd1) & (i_data_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((currentState_load_reg_463 == 1'd1) & (i_data_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((ap_reg_pp0_iter1_currentState_load_reg_463 == 1'd1) & (o_data_data_V_1_ack_in == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((ap_reg_pp0_iter2_currentState_load_reg_463 == 1'd1) & (o_data_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter3 = ((o_data_last_V_1_ack_in == 1'b0) | (o_data_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_condition_365 = ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

always @ (*) begin
    ap_condition_367 = ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_phi_reg_pp0_iter0_p_Val2_1_reg_116 = 'bx;

assign ap_phi_reg_pp0_iter0_p_Val2_2_reg_127 = 'bx;

always @ (*) begin
    ap_rst_n_inv = ~ap_rst_n;
end

assign cond_i_fu_148_p2 = ((phaseClass_V == 4'd8) ? 1'b1 : 1'b0);

assign currentState_load_load_fu_144_p1 = currentState;
...
assign o_data_data_V_tmp_fu_432_p1 = $signed(res_V_fu_424_p3);
...
assign p_Val2_2_4_i_fu_400_p2 = (tmp9_fu_394_p2 + tmp6_fu_376_p2);

assign p_Val2_5_1_i_fu_358_p2 = (tmp3_fu_352_p2 + tmp_fu_334_p2);

assign p_Val2_8_i_fu_418_p2 = (ap_phi_reg_pp0_iter2_p_Val2_2_reg_127 - ap_phi_reg_pp0_iter2_p_Val2_1_reg_116);

assign p_Val2_9_i_fu_412_p2 = (ap_phi_reg_pp0_iter2_p_Val2_1_reg_116 - ap_phi_reg_pp0_iter2_p_Val2_2_reg_127);

assign res_V_fu_424_p3 = ((tmp_i_fu_406_p2[0:0] === 1'b1) ? p_Val2_8_i_fu_418_p2 : p_Val2_9_i_fu_412_p2);

assign start_V_read_read_fu_92_p2 = start_V;

assign tmp10_fu_382_p2 = (cor_phaseClass0_V_2 + cor_phaseClass0_V_1);

assign tmp11_fu_388_p2 = (cor_phaseClass0_V_0 + tmp_1_fu_162_p1);

assign tmp1_fu_322_p2 = (cor_phaseClass0_V_11 + cor_phaseClass0_V_13);

assign tmp2_fu_328_p2 = (cor_phaseClass0_V_10 + cor_phaseClass0_V_8);

assign tmp3_fu_352_p2 = (tmp5_fu_346_p2 + tmp4_fu_340_p2);

assign tmp4_fu_340_p2 = (cor_phaseClass0_V_6 + cor_phaseClass0_V_5);

assign tmp5_fu_346_p2 = (cor_phaseClass0_V_4 + cor_phaseClass0_V_3);

assign tmp6_fu_376_p2 = (tmp8_fu_370_p2 + tmp7_fu_364_p2);

assign tmp7_fu_364_p2 = (cor_phaseClass0_V_12 + cor_phaseClass0_V_14);

assign tmp8_fu_370_p2 = (cor_phaseClass0_V_9 + cor_phaseClass0_V_7);

assign tmp9_fu_394_p2 = (tmp11_fu_388_p2 + tmp10_fu_382_p2);

assign tmp_1_fu_162_p1 = i_data_data_V_0_data_out[15:0];

assign tmp_2_fu_447_p2 = (32'd1 + loadCount_V);

assign tmp_fu_334_p2 = (tmp2_fu_328_p2 + tmp1_fu_322_p2);

assign tmp_i_fu_406_p2 = (($signed(ap_phi_reg_pp0_iter2_p_Val2_2_reg_127) > $signed(ap_phi_reg_pp0_iter2_p_Val2_1_reg_116)) ? 1'b1 : 1'b0);
