...
(* CORE_GENERATION_INFO="correlator,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=4.223667,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=90,HLS_SYN_LUT=107}" *)
...
wire   [1:0] currentState_load_load_fu_164_p1;
wire   [0:0] tmp_nbreadreq_fu_130_p4;
reg    o_data_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter1;
reg   [1:0] currentState_load_reg_517;
reg   [0:0] tmp_reg_521;
reg    ap_enable_reg_pp0_iter2;
reg   [1:0] ap_reg_pp0_iter1_currentState_load_reg_517;
reg   [0:0] ap_reg_pp0_iter1_tmp_reg_521;
reg   [3:0] phaseClass_V_read_reg_508;
...
wire   [31:0] p_Result_s_fu_496_p5;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (1'b1 == ap_predicate_op47_read_state1) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
            currentState <= 2'd2;
        end else if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (2'd2 == currentState_load_load_fu_164_p1)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (2'd1 == currentState) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'd0 == tmp_nbreadreq_fu_130_p4)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (2'd0 == currentState_load_load_fu_164_p1) & (1'd1 == start_V_read_read_fu_124_p2)))) begin
            currentState <= 2'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_predicate_op47_read_state1) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (2'd1 == currentState) & (1'd1 == tmp_nbreadreq_fu_130_p4))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (2'd1 == currentState_load_reg_517) & (1'd1 == tmp_reg_521)) | ((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (2'd1 == ap_reg_pp0_iter1_currentState_load_reg_517) & (1'd1 == ap_reg_pp0_iter1_tmp_reg_521)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_flag00001001 = (((1'b1 == 1'b1) & (1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op47_read_state1)) | ((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == o_data_V_data_V_1_ack_in) | (1'b0 == o_data_V_last_V_1_ack_in))));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011001 = (((1'b1 == 1'b1) & (1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op47_read_state1)) | ((1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_block_state2_io)) | ((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == o_data_V_data_V_1_ack_in) | (1'b0 == o_data_V_last_V_1_ack_in) | (1'b1 == ap_block_state3_io))));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011011 = (((1'b1 == 1'b1) & (1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op47_read_state1)) | ((1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_block_state2_io)) | ((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == o_data_V_data_V_1_ack_in) | (1'b0 == o_data_V_last_V_1_ack_in) | (1'b1 == ap_block_state3_io))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op47_read_state1));
end
...
always @ (*) begin
    ap_predicate_op102_write_state3 = ((2'd1 == ap_reg_pp0_iter1_currentState_load_reg_517) & (1'd1 == ap_reg_pp0_iter1_tmp_reg_521));
end

always @ (*) begin
    ap_predicate_op47_read_state1 = ((2'd1 == currentState) & (1'd1 == tmp_nbreadreq_fu_130_p4));
end

always @ (*) begin
    ap_predicate_op80_write_state2 = ((2'd1 == currentState_load_reg_517) & (1'd1 == tmp_reg_521));
end
...
assign currentState_load_load_fu_164_p1 = currentState;
...
assign p_Result_s_fu_496_p5 = {{ap_const_lv32_0[31:4]}, {phaseClass_V_read_reg_508}};
