...
(* CORE_GENERATION_INFO="correlator,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=4.223667,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=511,HLS_SYN_LUT=241}" *)
...
wire   [1:0] currentState_load_load_fu_166_p1;
wire   [0:0] tmp_nbreadreq_fu_126_p4;
reg    o_data_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter1;
reg   [1:0] currentState_load_reg_527;
reg    ap_enable_reg_pp0_iter2;
reg   [1:0] ap_reg_pp0_iter1_currentState_load_reg_527;
wire   [0:0] start_V_read_read_fu_120_p2;
...
wire   [31:0] p_Result_s_fu_510_p5;
reg    ap_block_pp0_stage0_flag00011011;
wire   [1:0] ap_phi_precharge_reg_pp0_iter0_storemerge_reg_155;
reg   [1:0] storemerge_phi_fu_158_p4;
wire   [15:0] tmp_1_fu_356_p1;
wire   [15:0] p_Val2_3_4_fu_328_p2;
reg    ap_block_pp0_stage0_flag00001001;
wire   [15:0] tmp8_fu_298_p2;
wire   [15:0] tmp7_fu_292_p2;
wire   [15:0] tmp2_fu_316_p2;
wire   [15:0] tmp1_fu_310_p2;
wire   [15:0] tmp9_fu_322_p2;
wire   [15:0] tmp6_fu_304_p2;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (2'd2 == currentState_load_load_fu_166_p1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((ap_condition_243 == 1'b1)) begin
            if (((2'd0 == currentState_load_load_fu_166_p1) & (1'd1 == start_V_read_read_fu_120_p2))) begin
                currentState <= 2'd1;
            end else if ((2'd1 == currentState)) begin
                currentState <= storemerge_phi_fu_158_p4;
            end else if ((2'd2 == currentState_load_load_fu_166_p1)) begin
                currentState <= 2'd3;
            end
        end
    end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (1'b1 == ap_predicate_op45_read_state1) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (2'd1 == currentState) & (1'd1 == tmp_nbreadreq_fu_126_p4))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (2'd3 == currentState_load_reg_527)) | ((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (2'd3 == ap_reg_pp0_iter1_currentState_load_reg_527)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (2'd3 == currentState_load_reg_527) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
...
always @ (*) begin
    if ((ap_condition_405 == 1'b1)) begin
        if ((1'd0 == tmp_nbreadreq_fu_126_p4)) begin
            storemerge_phi_fu_158_p4 = 2'd1;
        end else if ((1'd1 == tmp_nbreadreq_fu_126_p4)) begin
            storemerge_phi_fu_158_p4 = 2'd2;
        end else begin
...
always @ (*) begin
    ap_block_pp0_stage0_flag00001001 = (((1'b1 == 1'b1) & (1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op45_read_state1)) | ((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == o_data_V_data_V_1_ack_in) | (1'b0 == o_data_V_last_V_1_ack_in))));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011001 = (((1'b1 == 1'b1) & (1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op45_read_state1)) | ((1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_block_state2_io)) | ((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == o_data_V_data_V_1_ack_in) | (1'b0 == o_data_V_last_V_1_ack_in) | (1'b1 == ap_block_state3_io))));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011011 = (((1'b1 == 1'b1) & (1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op45_read_state1)) | ((1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_block_state2_io)) | ((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == o_data_V_data_V_1_ack_in) | (1'b0 == o_data_V_last_V_1_ack_in) | (1'b1 == ap_block_state3_io))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((1'b0 == i_data_TVALID) & (1'b1 == ap_predicate_op45_read_state1));
end

always @ (*) begin
    ap_block_state2_io = ((2'd3 == currentState_load_reg_527) & (1'b0 == o_data_V_data_V_1_ack_in));
end

assign ap_block_state2_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_io = ((2'd3 == ap_reg_pp0_iter1_currentState_load_reg_527) & (1'b0 == o_data_V_data_V_1_ack_in));
end
...
always @ (*) begin
    ap_condition_243 = ((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1) & (ap_block_pp0_stage0_flag00011001 == 1'b0));
end
...
assign ap_phi_precharge_reg_pp0_iter0_storemerge_reg_155 = 'bx;

always @ (*) begin
    ap_predicate_op45_read_state1 = ((2'd1 == currentState) & (1'd1 == tmp_nbreadreq_fu_126_p4));
end
...
assign currentState_load_load_fu_166_p1 = currentState;
...
assign p_Result_s_fu_510_p5 = {{ap_const_lv32_0[31:16]}, {corHelperI_V}};

assign p_Val2_3_4_fu_328_p2 = (tmp9_fu_322_p2 + tmp6_fu_304_p2);

assign start_V_read_read_fu_120_p2 = start_V;

assign tmp1_fu_310_p2 = (phaseClass0_V_13 + phaseClass0_V_10);

assign tmp2_fu_316_p2 = (phaseClass0_V_15 + phaseClass0_V_0);

assign tmp6_fu_304_p2 = (tmp8_fu_298_p2 + tmp7_fu_292_p2);

assign tmp7_fu_292_p2 = (phaseClass0_V_2 + phaseClass0_V_1);

assign tmp8_fu_298_p2 = (phaseClass0_V_3 + phaseClass0_V_8);

assign tmp9_fu_322_p2 = (tmp2_fu_316_p2 + tmp1_fu_310_p2);

assign tmp_1_fu_356_p1 = i_data_TDATA[15:0];

assign tmp_nbreadreq_fu_126_p4 = i_data_TVALID;
