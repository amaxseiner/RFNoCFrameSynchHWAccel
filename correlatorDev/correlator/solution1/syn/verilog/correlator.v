...
(* CORE_GENERATION_INFO="correlator,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=8.693000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=294,HLS_SYN_LUT=402}" *)
...
reg   [0:0] ap_reg_pp0_iter1_tmp_reg_545;
...
wire   [15:0] p_Val2_1_fu_357_p1;
reg   [15:0] p_Val2_1_reg_554;
wire   [0:0] cond_fu_373_p2;
wire   [31:0] p_Result_s_fu_525_p5;
reg    ap_block_pp0_stage0_subdone;
reg   [1:0] ap_phi_mux_storemerge_phi_fu_165_p4;
wire   [1:0] ap_phi_reg_pp0_iter0_storemerge_reg_162;
wire   [15:0] tmp_s_fu_505_p3;
wire   [15:0] p_Val2_3_4_fu_331_p2;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] tmp9_fu_295_p2;
wire   [15:0] tmp8_fu_289_p2;
wire   [15:0] tmp2_fu_313_p2;
wire   [15:0] tmp3_fu_319_p2;
wire   [15:0] tmp1_fu_307_p2;
wire   [15:0] tmp4_fu_325_p2;
wire   [15:0] tmp7_fu_301_p2;
wire   [10:0] tmp_2_fu_501_p1;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((1'b1 == ap_condition_265)) begin
            if ((ap_predicate_op44_read_state1 == 1'b1)) begin
                corHelperI_V <= 16'd0;
            end else if ((currentState_load_load_fu_179_p1 == 2'd2)) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((currentState == 2'd1) & (cond_fu_373_p2 == 1'd1) & (tmp_nbreadreq_fu_134_p4 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
                        phaseClass0_V_0[15 : 5] <= tmp_s_fu_505_p3[15 : 5];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_predicate_op44_read_state1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_predicate_op44_read_state1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_data_TREADY = 1'b1;
    end else begin
        i_data_TREADY = 1'b0;
    end
...
always @ (*) begin
    if ((((ap_reg_pp0_iter1_currentState_load_reg_541 == 2'd1) & (ap_reg_pp0_iter1_tmp_reg_545 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0)) | ((currentState_load_reg_541 == 2'd1) & (tmp_reg_545 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    if (((ap_predicate_op84_write_state2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((o_data_V_last_V_1_ack_in == 1'b0) | (o_data_V_data_V_1_ack_in == 1'b0))) | ((ap_predicate_op44_read_state1 == 1'b1) & (i_data_TVALID == 1'b0) & (1'b1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | (o_data_V_last_V_1_ack_in == 1'b0) | (o_data_V_data_V_1_ack_in == 1'b0))) | ((1'b1 == ap_block_state2_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op44_read_state1 == 1'b1) & (i_data_TVALID == 1'b0) & (1'b1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | (o_data_V_last_V_1_ack_in == 1'b0) | (o_data_V_data_V_1_ack_in == 1'b0))) | ((1'b1 == ap_block_state2_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op44_read_state1 == 1'b1) & (i_data_TVALID == 1'b0) & (1'b1 == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_predicate_op44_read_state1 == 1'b1) & (i_data_TVALID == 1'b0));
end

always @ (*) begin
    ap_block_state2_io = ((ap_predicate_op84_write_state2 == 1'b1) & (o_data_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state2_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_io = ((ap_predicate_op107_write_state3 == 1'b1) & (o_data_V_data_V_1_ack_in == 1'b0));
end
...
always @ (*) begin
    ap_condition_265 = ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
always @ (*) begin
    ap_predicate_op107_write_state3 = ((ap_reg_pp0_iter1_currentState_load_reg_541 == 2'd1) & (ap_reg_pp0_iter1_tmp_reg_545 == 1'd1));
end

always @ (*) begin
    ap_predicate_op44_read_state1 = ((currentState == 2'd1) & (tmp_nbreadreq_fu_134_p4 == 1'd1));
end

always @ (*) begin
    ap_predicate_op84_write_state2 = ((currentState_load_reg_541 == 2'd1) & (tmp_reg_545 == 1'd1));
end
...
assign cond_fu_373_p2 = ((phaseClass_V == 4'd0) ? 1'b1 : 1'b0);
...
assign p_Result_s_fu_525_p5 = {{ap_const_lv32_0[31:16]}, {p_Val2_1_reg_554}};

assign p_Val2_1_fu_357_p1 = i_data_TDATA[15:0];

assign p_Val2_3_4_fu_331_p2 = (tmp4_fu_325_p2 + tmp7_fu_301_p2);

assign start_V_read_read_fu_128_p2 = start_V;

assign tmp1_fu_307_p2 = (corHelperI_V + phaseClass0_V_15);

assign tmp2_fu_313_p2 = (phaseClass0_V_13 + phaseClass0_V_0);

assign tmp3_fu_319_p2 = (tmp2_fu_313_p2 + phaseClass0_V_10);

assign tmp4_fu_325_p2 = (tmp3_fu_319_p2 + tmp1_fu_307_p2);

assign tmp7_fu_301_p2 = (tmp9_fu_295_p2 + tmp8_fu_289_p2);

assign tmp8_fu_289_p2 = (phaseClass0_V_2 + phaseClass0_V_1);

assign tmp9_fu_295_p2 = (phaseClass0_V_3 + phaseClass0_V_8);

assign tmp_2_fu_501_p1 = i_data_TDATA[10:0];

assign tmp_nbreadreq_fu_134_p4 = i_data_TVALID;

assign tmp_s_fu_505_p3 = {{tmp_2_fu_501_p1}, {5'd0}};
