...
architecture behav of correlator is 
    ...
    "correlator,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=4.223667,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=511,HLS_SYN_LUT=241}";
    ...
    signal currentState_load_load_fu_166_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_nbreadreq_fu_126_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal o_data_TDATA_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal currentState_load_reg_527 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_reg_pp0_iter1_currentState_load_reg_527 : STD_LOGIC_VECTOR (1 downto 0);
    signal start_V_read_read_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Result_s_fu_510_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_flag00011011 : BOOLEAN;
    signal ap_phi_precharge_reg_pp0_iter0_storemerge_reg_155 : STD_LOGIC_VECTOR (1 downto 0);
    signal storemerge_phi_fu_158_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_1_fu_356_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_Val2_3_4_fu_328_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_flag00001001 : BOOLEAN;
    signal tmp8_fu_298_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp7_fu_292_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp2_fu_316_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp1_fu_310_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp9_fu_322_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp6_fu_304_p2 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0) and (ap_const_lv2_2 = currentState_load_load_fu_166_p1))) then 
                    corHelperI_V <= p_Val2_3_4_fu_328_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_condition_243 = ap_const_boolean_1)) then
                    if (((ap_const_lv2_0 = currentState_load_load_fu_166_p1) and (ap_const_lv1_1 = start_V_read_read_fu_120_p2))) then 
                        currentState <= ap_const_lv2_1;
                    elsif ((ap_const_lv2_1 = currentState)) then 
                        currentState <= storemerge_phi_fu_158_p4;
                    elsif ((ap_const_lv2_2 = currentState_load_load_fu_166_p1)) then 
                        currentState <= ap_const_lv2_3;
                    end if;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_predicate_op45_read_state1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
                    phaseClass0_V_0 <= tmp_1_fu_356_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then
                ap_reg_pp0_iter1_currentState_load_reg_527 <= currentState_load_reg_527;
                currentState_load_reg_527 <= currentState;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = o_data_V_data_V_1_load_A)) then
                o_data_V_data_V_1_payload_A <= p_Result_s_fu_510_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = o_data_V_data_V_1_load_B)) then
                o_data_V_data_V_1_payload_B <= p_Result_s_fu_510_p5;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_flag00001001_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter2, ap_predicate_op45_read_state1)
    begin
                ap_block_pp0_stage0_flag00001001 <= (((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op45_read_state1)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = o_data_V_data_V_1_ack_in) or (ap_const_logic_0 = o_data_V_last_V_1_ack_in))));
    end process;


    ap_block_pp0_stage0_flag00011001_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_predicate_op45_read_state1, ap_block_state2_io, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_flag00011001 <= (((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op45_read_state1)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_block_state2_io)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = o_data_V_data_V_1_ack_in) or (ap_const_logic_0 = o_data_V_last_V_1_ack_in) or (ap_const_boolean_1 = ap_block_state3_io))));
    end process;


    ap_block_pp0_stage0_flag00011011_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_predicate_op45_read_state1, ap_block_state2_io, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_flag00011011 <= (((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op45_read_state1)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_block_state2_io)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = o_data_V_data_V_1_ack_in) or (ap_const_logic_0 = o_data_V_last_V_1_ack_in) or (ap_const_boolean_1 = ap_block_state3_io))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(i_data_TVALID, ap_predicate_op45_read_state1)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op45_read_state1));
    end process;


    ap_block_state2_io_assign_proc : process(o_data_V_data_V_1_ack_in, currentState_load_reg_527)
    begin
                ap_block_state2_io <= ((ap_const_lv2_3 = currentState_load_reg_527) and (ap_const_logic_0 = o_data_V_data_V_1_ack_in));
    end process;

        ap_block_state2_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_io_assign_proc : process(o_data_V_data_V_1_ack_in, ap_reg_pp0_iter1_currentState_load_reg_527)
    begin
                ap_block_state3_io <= ((ap_const_lv2_3 = ap_reg_pp0_iter1_currentState_load_reg_527) and (ap_const_logic_0 = o_data_V_data_V_1_ack_in));
    end process;
    ...
    ap_condition_243_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
                ap_condition_243 <= ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0));
    end process;


    ap_condition_405_assign_proc : process(currentState, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00000000)
    begin
                ap_condition_405 <= ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv2_1 = currentState));
    end process;
    ...
    ap_phi_precharge_reg_pp0_iter0_storemerge_reg_155 <= "XX";

    ap_predicate_op45_read_state1_assign_proc : process(currentState, tmp_nbreadreq_fu_126_p4)
    begin
                ap_predicate_op45_read_state1 <= ((ap_const_lv2_1 = currentState) and (ap_const_lv1_1 = tmp_nbreadreq_fu_126_p4));
    end process;
    ...
    currentState_load_load_fu_166_p1 <= currentState;

    i_data_TDATA_blk_n_assign_proc : process(i_data_TVALID, currentState, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00000000, tmp_nbreadreq_fu_126_p4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv2_1 = currentState) and (ap_const_lv1_1 = tmp_nbreadreq_fu_126_p4))) then 
    ...
    i_data_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_predicate_op45_read_state1, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_predicate_op45_read_state1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    o_data_TDATA_blk_n_assign_proc : process(o_data_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00000000, ap_enable_reg_pp0_iter1, currentState_load_reg_527, ap_enable_reg_pp0_iter2, ap_reg_pp0_iter1_currentState_load_reg_527)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv2_3 = currentState_load_reg_527)) or ((ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter2) and (ap_const_lv2_3 = ap_reg_pp0_iter1_currentState_load_reg_527)))) then 
    ...
    o_data_V_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_527, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv2_3 = currentState_load_reg_527) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    o_data_V_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, currentState_load_reg_527, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv2_3 = currentState_load_reg_527) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    p_Result_s_fu_510_p5 <= (ap_const_lv32_0(31 downto 16) & corHelperI_V);
    p_Val2_3_4_fu_328_p2 <= std_logic_vector(unsigned(tmp9_fu_322_p2) + unsigned(tmp6_fu_304_p2));
    start_V_read_read_fu_120_p2 <= start_V;

    storemerge_phi_fu_158_p4_assign_proc : process(tmp_nbreadreq_fu_126_p4, ap_phi_precharge_reg_pp0_iter0_storemerge_reg_155, ap_condition_405)
    begin
        if ((ap_condition_405 = ap_const_boolean_1)) then
            if ((ap_const_lv1_0 = tmp_nbreadreq_fu_126_p4)) then 
                storemerge_phi_fu_158_p4 <= ap_const_lv2_1;
            elsif ((ap_const_lv1_1 = tmp_nbreadreq_fu_126_p4)) then 
                storemerge_phi_fu_158_p4 <= ap_const_lv2_2;
            else 
                storemerge_phi_fu_158_p4 <= ap_phi_precharge_reg_pp0_iter0_storemerge_reg_155;
            end if;
        else 
            storemerge_phi_fu_158_p4 <= ap_phi_precharge_reg_pp0_iter0_storemerge_reg_155;
        end if; 
    ...
    tmp1_fu_310_p2 <= std_logic_vector(unsigned(phaseClass0_V_13) + unsigned(phaseClass0_V_10));
    tmp2_fu_316_p2 <= std_logic_vector(unsigned(phaseClass0_V_15) + unsigned(phaseClass0_V_0));
    tmp6_fu_304_p2 <= std_logic_vector(unsigned(tmp8_fu_298_p2) + unsigned(tmp7_fu_292_p2));
    tmp7_fu_292_p2 <= std_logic_vector(unsigned(phaseClass0_V_2) + unsigned(phaseClass0_V_1));
    tmp8_fu_298_p2 <= std_logic_vector(unsigned(phaseClass0_V_3) + unsigned(phaseClass0_V_8));
    tmp9_fu_322_p2 <= std_logic_vector(unsigned(tmp2_fu_316_p2) + unsigned(tmp1_fu_310_p2));
    tmp_1_fu_356_p1 <= i_data_TDATA(16 - 1 downto 0);
    tmp_nbreadreq_fu_126_p4 <= (0=>(i_data_TVALID), others=>'-');
end behav;
