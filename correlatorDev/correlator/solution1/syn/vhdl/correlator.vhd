...
architecture behav of correlator is 
    ...
    "correlator,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=4.223667,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=90,HLS_SYN_LUT=132}";
    ...
    signal currentState_load_reg_536 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_reg_540 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_reg_pp0_iter1_currentState_load_reg_536 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_reg_pp0_iter1_tmp_reg_540 : STD_LOGIC_VECTOR (0 downto 0);
    signal phaseClass_V_read_reg_527 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_last_V_reg_544 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_s_fu_515_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_flag00011011 : BOOLEAN;
    signal ap_phi_precharge_reg_pp0_iter0_storemerge_reg_160 : STD_LOGIC_VECTOR (1 downto 0);
    signal storemerge_phi_fu_163_p4 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_condition_261 = ap_const_boolean_1)) then
                    if (((ap_const_lv2_0 = currentState_load_load_fu_171_p1) and (ap_const_lv1_1 = start_V_read_read_fu_126_p2))) then 
                        currentState <= ap_const_lv2_1;
                    elsif ((ap_const_lv2_1 = currentState)) then 
                        currentState <= storemerge_phi_fu_163_p4;
                    elsif ((ap_const_lv2_2 = currentState_load_load_fu_171_p1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then
                ap_reg_pp0_iter1_currentState_load_reg_536 <= currentState_load_reg_536;
                ap_reg_pp0_iter1_tmp_reg_540 <= tmp_reg_540;
                currentState_load_reg_536 <= currentState;
                phaseClass_V_read_reg_527 <= phaseClass_V;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = o_data_V_data_V_1_load_A)) then
                o_data_V_data_V_1_payload_A <= p_Result_s_fu_515_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = o_data_V_data_V_1_load_B)) then
                o_data_V_data_V_1_payload_B <= p_Result_s_fu_515_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = o_data_V_last_V_1_load_A)) then
                o_data_V_last_V_1_payload_A <= tmp_last_V_reg_544;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = o_data_V_last_V_1_load_B)) then
                o_data_V_last_V_1_payload_B <= tmp_last_V_reg_544;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_1 = ap_predicate_op46_read_state1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then
                tmp_last_V_reg_544 <= i_data_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_lv2_1 = currentState) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then
                tmp_reg_540 <= tmp_nbreadreq_fu_132_p4;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_flag00001001_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter2, ap_predicate_op46_read_state1)
    begin
                ap_block_pp0_stage0_flag00001001 <= (((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op46_read_state1)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = o_data_V_data_V_1_ack_in) or (ap_const_logic_0 = o_data_V_last_V_1_ack_in))));
    end process;


    ap_block_pp0_stage0_flag00011001_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_predicate_op46_read_state1, ap_block_state2_io, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_flag00011001 <= (((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op46_read_state1)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_block_state2_io)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = o_data_V_data_V_1_ack_in) or (ap_const_logic_0 = o_data_V_last_V_1_ack_in) or (ap_const_boolean_1 = ap_block_state3_io))));
    end process;


    ap_block_pp0_stage0_flag00011011_assign_proc : process(i_data_TVALID, o_data_V_data_V_1_ack_in, o_data_V_last_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_predicate_op46_read_state1, ap_block_state2_io, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_flag00011011 <= (((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op46_read_state1)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_block_state2_io)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = o_data_V_data_V_1_ack_in) or (ap_const_logic_0 = o_data_V_last_V_1_ack_in) or (ap_const_boolean_1 = ap_block_state3_io))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(i_data_TVALID, ap_predicate_op46_read_state1)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_const_logic_0 = i_data_TVALID) and (ap_const_boolean_1 = ap_predicate_op46_read_state1));
    end process;


    ap_block_state2_io_assign_proc : process(o_data_V_data_V_1_ack_in, ap_predicate_op81_write_state2)
    begin
                ap_block_state2_io <= ((ap_const_logic_0 = o_data_V_data_V_1_ack_in) and (ap_const_boolean_1 = ap_predicate_op81_write_state2));
    end process;
    ...
    ap_condition_261_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
                ap_condition_261 <= ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0));
    end process;


    ap_condition_425_assign_proc : process(currentState, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00000000)
    begin
                ap_condition_425 <= ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv2_1 = currentState));
    end process;
    ...
    ap_phi_precharge_reg_pp0_iter0_storemerge_reg_160 <= "XX";

    ap_predicate_op102_write_state3_assign_proc : process(ap_reg_pp0_iter1_currentState_load_reg_536, ap_reg_pp0_iter1_tmp_reg_540)
    begin
                ap_predicate_op102_write_state3 <= ((ap_const_lv2_1 = ap_reg_pp0_iter1_currentState_load_reg_536) and (ap_const_lv1_1 = ap_reg_pp0_iter1_tmp_reg_540));
    end process;


    ap_predicate_op46_read_state1_assign_proc : process(currentState, tmp_nbreadreq_fu_132_p4)
    begin
                ap_predicate_op46_read_state1 <= ((ap_const_lv2_1 = currentState) and (ap_const_lv1_1 = tmp_nbreadreq_fu_132_p4));
    end process;


    ap_predicate_op81_write_state2_assign_proc : process(currentState_load_reg_536, tmp_reg_540)
    begin
                ap_predicate_op81_write_state2 <= ((ap_const_lv2_1 = currentState_load_reg_536) and (ap_const_lv1_1 = tmp_reg_540));
    end process;
    ...
    i_data_TDATA_blk_n_assign_proc : process(i_data_TVALID, currentState, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00000000, tmp_nbreadreq_fu_132_p4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv2_1 = currentState) and (ap_const_lv1_1 = tmp_nbreadreq_fu_132_p4))) then 
    ...
    i_data_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_predicate_op46_read_state1, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_predicate_op46_read_state1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    o_data_TDATA_blk_n_assign_proc : process(o_data_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00000000, ap_enable_reg_pp0_iter1, currentState_load_reg_536, tmp_reg_540, ap_enable_reg_pp0_iter2, ap_reg_pp0_iter1_currentState_load_reg_536, ap_reg_pp0_iter1_tmp_reg_540)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv2_1 = currentState_load_reg_536) and (ap_const_lv1_1 = tmp_reg_540)) or ((ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter2) and (ap_const_lv2_1 = ap_reg_pp0_iter1_currentState_load_reg_536) and (ap_const_lv1_1 = ap_reg_pp0_iter1_tmp_reg_540)))) then 
    ...
    o_data_V_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op81_write_state2, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_predicate_op81_write_state2) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    o_data_V_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op81_write_state2, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_predicate_op81_write_state2) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    p_Result_s_fu_515_p5 <= (ap_const_lv32_0(31 downto 4) & phaseClass_V_read_reg_527);
    start_V_read_read_fu_126_p2 <= start_V;

    storemerge_phi_fu_163_p4_assign_proc : process(tmp_nbreadreq_fu_132_p4, ap_phi_precharge_reg_pp0_iter0_storemerge_reg_160, ap_condition_425)
    begin
        if ((ap_condition_425 = ap_const_boolean_1)) then
            if ((ap_const_lv1_0 = tmp_nbreadreq_fu_132_p4)) then 
                storemerge_phi_fu_163_p4 <= ap_const_lv2_1;
            elsif ((ap_const_lv1_1 = tmp_nbreadreq_fu_132_p4)) then 
                storemerge_phi_fu_163_p4 <= ap_const_lv2_2;
            else 
                storemerge_phi_fu_163_p4 <= ap_phi_precharge_reg_pp0_iter0_storemerge_reg_160;
            end if;
        else 
            storemerge_phi_fu_163_p4 <= ap_phi_precharge_reg_pp0_iter0_storemerge_reg_160;
        end if; 
