...
const sc_lv<32> correlateTop::ap_const_lv32_32000 = "110010000000000000";
...
correlateTop::correlateTop(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cor_phaseArray_phase_4_U->d0(extLd6_fu_341_p1);
    cor_phaseArray_phase_4_U->q0(cor_phaseArray_phase_4_q0);
    cor_phaseArray_phase_5_U = new correlateTop_cor_lbW("cor_phaseArray_phase_5_U");
    ...
    cor_phaseArray_phase_6_U = new correlateTop_cor_lbW("cor_phaseArray_phase_6_U");
    ...
    cor_phaseArray_phase_7_U = new correlateTop_cor_lbW("cor_phaseArray_phase_7_U");
    ...
    cor_phaseArray_phase_13_U = new correlateTop_cor_lbW("cor_phaseArray_phase_13_U");
    ...
    cor_phaseArray_phase_13_U->d0(ap_var_for_const0);
    ...
    SC_METHOD(thread_OP1_V_cast_fu_482_p1);
    sensitive << ( tmp_i_4_reg_634 );
    ...
    sensitive << ( currentState_load_reg_537 );
    ...
    sensitive << ( o_data_data_V_1_ack_in );
    sensitive << ( ap_reg_pp0_iter1_currentState_load_reg_537 );

    SC_METHOD(thread_ap_block_state5_pp0_stage0_iter2);

    SC_METHOD(thread_ap_block_state6_io);
    sensitive << ( o_data_data_V_1_ack_in );
    sensitive << ( ap_reg_pp0_iter2_currentState_load_reg_537 );
    ...
    SC_METHOD(thread_currentState_load_load_fu_319_p1);
    sensitive << ( currentState );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_block_pp0_stage0_flag00000000 );

    SC_METHOD(thread_extLd1_fu_350_p1);
    sensitive << ( cor_phaseArray_phase_7_q0 );

    SC_METHOD(thread_extLd3_fu_346_p1);
    sensitive << ( cor_phaseArray_phase_6_q0 );

    SC_METHOD(thread_extLd6_fu_341_p1);
    sensitive << ( cor_phaseArray_phase_5_q0 );

    SC_METHOD(thread_extLd_fu_354_p1);
    ...
    SC_METHOD(thread_o_data_data_V_tmp_fu_528_p3);
    ...
    SC_METHOD(thread_p_Val2_2_fu_485_p0);
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( ap_CS_fsm_pp0_stage1 );
    sensitive << ( ap_block_pp0_stage1_flag00000000 );
    sensitive << ( OP1_V_cast_fu_482_p1 );

    SC_METHOD(thread_p_Val2_2_fu_485_p1);
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( ap_CS_fsm_pp0_stage1 );
    sensitive << ( ap_block_pp0_stage1_flag00000000 );
    sensitive << ( OP1_V_cast_fu_482_p1 );

    SC_METHOD(thread_p_Val2_2_fu_485_p2);
    sensitive << ( p_Val2_2_fu_485_p0 );
    sensitive << ( p_Val2_2_fu_485_p1 );

    SC_METHOD(thread_p_Val2_3_2_i_fu_424_p2);
    sensitive << ( tmp4_fu_400_p2 );
    sensitive << ( tmp7_fu_418_p2 );

    SC_METHOD(thread_p_Val2_6_i_fu_388_p2);
    sensitive << ( tmp8_fu_364_p2 );
    sensitive << ( tmp2_fu_382_p2 );

    SC_METHOD(thread_p_Val2_9_i_fu_470_p2);
    sensitive << ( p_Val2_6_i_reg_615 );
    sensitive << ( p_Val2_3_2_i_reg_622 );
    ...
    sensitive << ( extLd3_fu_346_p1 );

    SC_METHOD(thread_tmp4_fu_400_p2);
    sensitive << ( extLd6_fu_341_p1 );
    ...
    SC_METHOD(thread_tmp6_fu_412_p2);
    sensitive << ( cor_phaseArray_phase_8_q0 );
    sensitive << ( extLd_fu_354_p1 );

    SC_METHOD(thread_tmp7_fu_418_p2);
    sensitive << ( tmp5_fu_406_p2 );
    sensitive << ( tmp6_fu_412_p2 );

    SC_METHOD(thread_tmp8_fu_364_p2);
    sensitive << ( cor_phaseArray_phase_3_q0 );
    sensitive << ( tmp9_fu_358_p2 );

    SC_METHOD(thread_tmp9_fu_358_p2);
    ...
    sensitive << ( ap_reg_pp0_iter1_currentState_load_reg_537 );
    sensitive << ( ap_block_pp0_stage0_flag00011001 );
    sensitive << ( res_V_reg_639 );

    SC_METHOD(thread_tmp_5_i_fu_462_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( currentState_load_reg_537 );
    sensitive << ( ap_block_pp0_stage0_flag00011001 );
    ...
    SC_METHOD(thread_tmp_i_4_fu_474_p3);
    sensitive << ( tmp_5_i_fu_462_p2 );
    ...
    sc_trace(mVcdFile, currentState_load_reg_537, "currentState_load_reg_537");
    sc_trace(mVcdFile, o_data_TDATA_blk_n, "o_data_TDATA_blk_n");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter2, "ap_enable_reg_pp0_iter2");
    sc_trace(mVcdFile, ap_reg_pp0_iter1_currentState_load_reg_537, "ap_reg_pp0_iter1_currentState_load_reg_537");
    sc_trace(mVcdFile, ap_CS_fsm_pp0_stage1, "ap_CS_fsm_pp0_stage1");
    sc_trace(mVcdFile, ap_block_pp0_stage1_flag00000000, "ap_block_pp0_stage1_flag00000000");
    sc_trace(mVcdFile, ap_reg_pp0_iter2_currentState_load_reg_537, "ap_reg_pp0_iter2_currentState_load_reg_537");
    sc_trace(mVcdFile, currentState_load_load_fu_319_p1, "currentState_load_load_fu_319_p1");
    ...
    sc_trace(mVcdFile, start_V_read_reg_611, "start_V_read_reg_611");
    ...
    sc_trace(mVcdFile, ap_reg_pp0_iter1_start_V_read_reg_611, "ap_reg_pp0_iter1_start_V_read_reg_611");
    sc_trace(mVcdFile, p_Val2_6_i_fu_388_p2, "p_Val2_6_i_fu_388_p2");
    sc_trace(mVcdFile, p_Val2_6_i_reg_615, "p_Val2_6_i_reg_615");
    sc_trace(mVcdFile, p_Val2_3_2_i_fu_424_p2, "p_Val2_3_2_i_fu_424_p2");
    sc_trace(mVcdFile, p_Val2_3_2_i_reg_622, "p_Val2_3_2_i_reg_622");
    sc_trace(mVcdFile, o_data_last_V_tmp_reg_629, "o_data_last_V_tmp_reg_629");
    sc_trace(mVcdFile, tmp_i_4_fu_474_p3, "tmp_i_4_fu_474_p3");
    sc_trace(mVcdFile, tmp_i_4_reg_634, "tmp_i_4_reg_634");
    sc_trace(mVcdFile, res_V_reg_639, "res_V_reg_639");
    sc_trace(mVcdFile, o_data_data_V_tmp_fu_528_p3, "o_data_data_V_tmp_fu_528_p3");
    ...
    sc_trace(mVcdFile, extLd6_fu_341_p1, "extLd6_fu_341_p1");
    sc_trace(mVcdFile, tmp9_fu_358_p2, "tmp9_fu_358_p2");
    sc_trace(mVcdFile, extLd1_fu_350_p1, "extLd1_fu_350_p1");
    sc_trace(mVcdFile, tmp_fu_370_p2, "tmp_fu_370_p2");
    sc_trace(mVcdFile, tmp1_fu_376_p2, "tmp1_fu_376_p2");
    sc_trace(mVcdFile, tmp8_fu_364_p2, "tmp8_fu_364_p2");
    sc_trace(mVcdFile, tmp2_fu_382_p2, "tmp2_fu_382_p2");
    sc_trace(mVcdFile, extLd3_fu_346_p1, "extLd3_fu_346_p1");
    sc_trace(mVcdFile, tmp3_fu_394_p2, "tmp3_fu_394_p2");
    sc_trace(mVcdFile, extLd_fu_354_p1, "extLd_fu_354_p1");
    sc_trace(mVcdFile, tmp5_fu_406_p2, "tmp5_fu_406_p2");
    sc_trace(mVcdFile, tmp6_fu_412_p2, "tmp6_fu_412_p2");
    sc_trace(mVcdFile, tmp4_fu_400_p2, "tmp4_fu_400_p2");
    sc_trace(mVcdFile, tmp7_fu_418_p2, "tmp7_fu_418_p2");
    sc_trace(mVcdFile, tmp_5_i_fu_462_p2, "tmp_5_i_fu_462_p2");
    sc_trace(mVcdFile, p_Val2_9_i_fu_470_p2, "p_Val2_9_i_fu_470_p2");
    sc_trace(mVcdFile, p_Val2_i_fu_466_p2, "p_Val2_i_fu_466_p2");
    sc_trace(mVcdFile, p_Val2_2_fu_485_p0, "p_Val2_2_fu_485_p0");
    sc_trace(mVcdFile, OP1_V_cast_fu_482_p1, "OP1_V_cast_fu_482_p1");
    sc_trace(mVcdFile, p_Val2_2_fu_485_p1, "p_Val2_2_fu_485_p1");
    sc_trace(mVcdFile, p_Val2_2_fu_485_p2, "p_Val2_2_fu_485_p2");
...
void correlateTop::thread_ap_var_for_const0() {
...
void correlateTop::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
              ...
              esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_load_fu_319_p1.read()) && 
              esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) || 
             (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
              esl_seteq<1,1,1>(ap_block_pp0_stage1_flag00011001.read(), ap_const_boolean_0) && 
              esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1) && 
              esl_seteq<1,1,1>(ap_const_lv1_0, currentState_load_reg_537.read()) && 
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_condition_526.read(), ap_const_boolean_1)) {
            if (esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_currentState_load_reg_537.read())) {
                loadCount_V = tmp_4_fu_511_p2.read();
            } else if ((esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter1_currentState_load_reg_537.read()) && 
                        esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_start_V_read_reg_611.read()))) {
                loadCount_V = ap_const_lv32_0;
            }
        }
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0))) {
        ap_reg_pp0_iter1_currentState_load_reg_537 = currentState_load_reg_537.read();
        ap_reg_pp0_iter2_currentState_load_reg_537 = ap_reg_pp0_iter1_currentState_load_reg_537.read();
        currentState_load_reg_537 = currentState.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage1_flag00011001.read(), ap_const_boolean_0))) {
        ap_reg_pp0_iter1_start_V_read_reg_611 = start_V_read_reg_611.read();
        start_V_read_reg_611 = start_V.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_load_fu_319_p1.read()))) {
        cor_phaseArray_phase_10_reg_566 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_12_reg_571 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_14_reg_576 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_16_reg_581 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_18_reg_586 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_20_reg_591 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_22_reg_596 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_24_reg_601 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_26_reg_606 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_2_reg_546 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_4_reg_551 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_6_reg_556 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_8_reg_561 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        cor_phaseArray_phase_reg_541 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_data_V_1_load_A.read())) {
        o_data_data_V_1_payload_A = o_data_data_V_tmp_fu_528_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_data_V_1_load_B.read())) {
        o_data_data_V_1_payload_B = o_data_data_V_tmp_fu_528_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_last_V_1_load_A.read())) {
        o_data_last_V_1_payload_A = o_data_last_V_tmp_reg_629.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_last_V_1_load_B.read())) {
        o_data_last_V_1_payload_B = o_data_last_V_tmp_reg_629.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_537.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0))) {
        o_data_last_V_tmp_reg_629 = i_data_last_V_0_data_out.read();
        tmp_i_4_reg_634 = tmp_i_4_fu_474_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_537.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage1_flag00011001.read(), ap_const_boolean_0))) {
        p_Val2_3_2_i_reg_622 = p_Val2_3_2_i_fu_424_p2.read();
        p_Val2_6_i_reg_615 = p_Val2_6_i_fu_388_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_currentState_load_reg_537.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage1_flag00011001.read(), ap_const_boolean_0))) {
        res_V_reg_639 = p_Val2_2_fu_485_p2.read().range(41, 10);
    }
}

void correlateTop::thread_OP1_V_cast_fu_482_p1() {
    OP1_V_cast_fu_482_p1 = esl_sext<42,32>(tmp_i_4_reg_634.read());
}
...
void correlateTop::thread_ap_block_pp0_stage0_flag00001001() {
    ap_block_pp0_stage0_flag00001001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_537.read()) && esl_seteq<1,1,1>(ap_const_logic_0, i_data_data_V_0_vld_out.read()));
}
...
void correlateTop::thread_ap_block_pp0_stage0_flag00011001() {
  ...
  esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_537.read()) && 
...
void correlateTop::thread_ap_block_pp0_stage1_flag00001001() {
    ap_block_pp0_stage1_flag00001001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && (esl_seteq<1,1,1>(ap_const_logic_0, o_data_data_V_1_ack_in.read()) || 
  esl_seteq<1,1,1>(ap_const_logic_0, o_data_last_V_1_ack_in.read())));
}

void correlateTop::thread_ap_block_pp0_stage1_flag00011001() {
    ap_block_pp0_stage1_flag00011001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && (esl_seteq<1,1,1>(ap_const_logic_0, o_data_data_V_1_ack_in.read()) || 
  esl_seteq<1,1,1>(ap_const_logic_0, o_data_last_V_1_ack_in.read()) || 
  esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state6_io.read())));
}

void correlateTop::thread_ap_block_pp0_stage1_flag00011011() {
    ap_block_pp0_stage1_flag00011011 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && (esl_seteq<1,1,1>(ap_const_logic_0, o_data_data_V_1_ack_in.read()) || 
  esl_seteq<1,1,1>(ap_const_logic_0, o_data_last_V_1_ack_in.read()) || 
  esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state6_io.read())));
}
...
void correlateTop::thread_ap_block_state3_pp0_stage0_iter1() {
    ap_block_state3_pp0_stage0_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_537.read()) && esl_seteq<1,1,1>(ap_const_logic_0, i_data_data_V_0_vld_out.read()));
}
...
void correlateTop::thread_ap_block_state5_io() {
    ap_block_state5_io = (esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_currentState_load_reg_537.read()) && esl_seteq<1,1,1>(ap_const_logic_0, o_data_data_V_1_ack_in.read()));
}
...
void correlateTop::thread_ap_block_state6_io() {
    ap_block_state6_io = (esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter2_currentState_load_reg_537.read()) && esl_seteq<1,1,1>(ap_const_logic_0, o_data_data_V_1_ack_in.read()));
}
...
void correlateTop::thread_ap_condition_526() {
    ap_condition_526 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0));
}
...
void correlateTop::thread_cor_phaseArray_phase_10_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_10_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
...
void correlateTop::thread_cor_phaseArray_phase_10_we0() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_537.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage1_flag00011001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_11_address0 = cor_phaseArray_phase_6_reg_556.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_11_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_12_address0 = cor_phaseArray_phase_8_reg_561.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_12_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_13_address0 = cor_phaseArray_phase_26_reg_606.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_13_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_1_address0 = cor_phaseArray_phase_12_reg_571.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_1_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_2_address0 = cor_phaseArray_phase_14_reg_576.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_2_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_3_address0 = cor_phaseArray_phase_16_reg_581.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_3_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_4_address0 = cor_phaseArray_phase_18_reg_586.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_4_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_5_address0 = cor_phaseArray_phase_20_reg_591.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_5_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_6_address0 = cor_phaseArray_phase_22_reg_596.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_6_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_7_address0 = cor_phaseArray_phase_24_reg_601.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_7_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_8_address0 = cor_phaseArray_phase_reg_541.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_8_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_9_address0 = cor_phaseArray_phase_2_reg_546.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_9_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)) {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
            ...
            cor_phaseArray_phase_address0 = cor_phaseArray_phase_10_reg_566.read();
                    ...
                    esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0))) {
            cor_phaseArray_phase_address0 =  (sc_lv<4>) (tmp_i_fu_323_p1.read());
        } else {
...
void correlateTop::thread_currentState_load_load_fu_319_p1() {
    currentState_load_load_fu_319_p1 = currentState.read();
}

void correlateTop::thread_extLd1_fu_350_p1() {
    extLd1_fu_350_p1 = esl_zext<32,1>(cor_phaseArray_phase_7_q0.read());
}

void correlateTop::thread_extLd3_fu_346_p1() {
    extLd3_fu_346_p1 = esl_zext<32,1>(cor_phaseArray_phase_6_q0.read());
}

void correlateTop::thread_extLd6_fu_341_p1() {
    extLd6_fu_341_p1 = esl_zext<32,1>(cor_phaseArray_phase_5_q0.read());
}

void correlateTop::thread_extLd_fu_354_p1() {
    extLd_fu_354_p1 = esl_zext<32,1>(cor_phaseArray_phase_13_q0.read());
}
...
void correlateTop::thread_o_data_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
          ...
          esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_currentState_load_reg_537.read())) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
          esl_seteq<1,1,1>(ap_block_pp0_stage1_flag00000000.read(), ap_const_boolean_0) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter2_currentState_load_reg_537.read())))) {
...
void correlateTop::thread_o_data_data_V_tmp_fu_528_p3() {
    o_data_data_V_tmp_fu_528_p3 = (!tmp_5_fu_523_p2.read()[0].is_01())? sc_lv<32>(): ((tmp_5_fu_523_p2.read()[0].to_bool())? tmp_4_fu_511_p2.read(): ap_const_lv32_0);
}
...
void correlateTop::thread_p_Val2_2_fu_485_p0() {
    p_Val2_2_fu_485_p0 =  (sc_lv<32>) (OP1_V_cast_fu_482_p1.read());
}

void correlateTop::thread_p_Val2_2_fu_485_p1() {
    p_Val2_2_fu_485_p1 =  (sc_lv<32>) (OP1_V_cast_fu_482_p1.read());
}

void correlateTop::thread_p_Val2_2_fu_485_p2() {
    p_Val2_2_fu_485_p2 = (!p_Val2_2_fu_485_p0.read().is_01() || !p_Val2_2_fu_485_p1.read().is_01())? sc_lv<42>(): sc_bigint<32>(p_Val2_2_fu_485_p0.read()) * sc_bigint<32>(p_Val2_2_fu_485_p1.read());
}

void correlateTop::thread_p_Val2_3_2_i_fu_424_p2() {
    p_Val2_3_2_i_fu_424_p2 = (!tmp4_fu_400_p2.read().is_01() || !tmp7_fu_418_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp4_fu_400_p2.read()) + sc_biguint<32>(tmp7_fu_418_p2.read()));
}

void correlateTop::thread_p_Val2_6_i_fu_388_p2() {
    p_Val2_6_i_fu_388_p2 = (!tmp8_fu_364_p2.read().is_01() || !tmp2_fu_382_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp8_fu_364_p2.read()) + sc_biguint<32>(tmp2_fu_382_p2.read()));
}

void correlateTop::thread_p_Val2_9_i_fu_470_p2() {
    p_Val2_9_i_fu_470_p2 = (!p_Val2_6_i_reg_615.read().is_01() || !p_Val2_3_2_i_reg_622.read().is_01())? sc_lv<32>(): (sc_biguint<32>(p_Val2_6_i_reg_615.read()) - sc_biguint<32>(p_Val2_3_2_i_reg_622.read()));
}

void correlateTop::thread_p_Val2_i_fu_466_p2() {
    p_Val2_i_fu_466_p2 = (!p_Val2_3_2_i_reg_622.read().is_01() || !p_Val2_6_i_reg_615.read().is_01())? sc_lv<32>(): (sc_biguint<32>(p_Val2_3_2_i_reg_622.read()) - sc_biguint<32>(p_Val2_6_i_reg_615.read()));
}

void correlateTop::thread_start_V_read_read_fu_108_p2() {
    start_V_read_read_fu_108_p2 = start_V.read();
}

void correlateTop::thread_tmp1_fu_376_p2() {
    tmp1_fu_376_p2 = (!extLd1_fu_350_p1.read().is_01() || !cor_phaseArray_phase_9_q0.read().is_01())? sc_lv<32>(): (sc_biguint<32>(extLd1_fu_350_p1.read()) + sc_biguint<32>(cor_phaseArray_phase_9_q0.read()));
}

void correlateTop::thread_tmp2_fu_382_p2() {
    tmp2_fu_382_p2 = (!tmp_fu_370_p2.read().is_01() || !tmp1_fu_376_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_fu_370_p2.read()) + sc_biguint<32>(tmp1_fu_376_p2.read()));
}

void correlateTop::thread_tmp3_fu_394_p2() {
    tmp3_fu_394_p2 = (!cor_phaseArray_phase_q0.read().is_01() || !extLd3_fu_346_p1.read().is_01())? sc_lv<32>(): (sc_biguint<32>(cor_phaseArray_phase_q0.read()) + sc_biguint<32>(extLd3_fu_346_p1.read()));
}

void correlateTop::thread_tmp4_fu_400_p2() {
    tmp4_fu_400_p2 = (!extLd6_fu_341_p1.read().is_01() || !tmp3_fu_394_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(extLd6_fu_341_p1.read()) + sc_biguint<32>(tmp3_fu_394_p2.read()));
}

void correlateTop::thread_tmp5_fu_406_p2() {
    tmp5_fu_406_p2 = (!cor_phaseArray_phase_12_q0.read().is_01() || !cor_phaseArray_phase_11_q0.read().is_01())? sc_lv<32>(): (sc_biguint<32>(cor_phaseArray_phase_12_q0.read()) + sc_biguint<32>(cor_phaseArray_phase_11_q0.read()));
}

void correlateTop::thread_tmp6_fu_412_p2() {
    tmp6_fu_412_p2 = (!extLd_fu_354_p1.read().is_01() || !cor_phaseArray_phase_8_q0.read().is_01())? sc_lv<32>(): (sc_biguint<32>(extLd_fu_354_p1.read()) + sc_biguint<32>(cor_phaseArray_phase_8_q0.read()));
}

void correlateTop::thread_tmp7_fu_418_p2() {
    tmp7_fu_418_p2 = (!tmp5_fu_406_p2.read().is_01() || !tmp6_fu_412_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp5_fu_406_p2.read()) + sc_biguint<32>(tmp6_fu_412_p2.read()));
}

void correlateTop::thread_tmp8_fu_364_p2() {
    tmp8_fu_364_p2 = (!cor_phaseArray_phase_3_q0.read().is_01() || !tmp9_fu_358_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(cor_phaseArray_phase_3_q0.read()) + sc_biguint<32>(tmp9_fu_358_p2.read()));
}

void correlateTop::thread_tmp9_fu_358_p2() {
    tmp9_fu_358_p2 = (!cor_phaseArray_phase_2_q0.read().is_01() || !cor_phaseArray_phase_4_q0.read().is_01())? sc_lv<32>(): (sc_biguint<32>(cor_phaseArray_phase_2_q0.read()) + sc_biguint<32>(cor_phaseArray_phase_4_q0.read()));
}

void correlateTop::thread_tmp_4_fu_511_p2() {
    tmp_4_fu_511_p2 = (!ap_const_lv32_20.is_01() || !loadCount_V.read().is_01())? sc_lv<32>(): (sc_biguint<32>(ap_const_lv32_20) + sc_biguint<32>(loadCount_V.read()));
}

void correlateTop::thread_tmp_5_fu_523_p2() {
    tmp_5_fu_523_p2 = (!res_V_reg_639.read().is_01() || !ap_const_lv32_32000.is_01())? sc_lv<1>(): (sc_bigint<32>(res_V_reg_639.read()) > sc_bigint<32>(ap_const_lv32_32000));
}

void correlateTop::thread_tmp_5_i_fu_462_p2() {
    tmp_5_i_fu_462_p2 = (!p_Val2_6_i_reg_615.read().is_01() || !p_Val2_3_2_i_reg_622.read().is_01())? sc_lv<1>(): (sc_bigint<32>(p_Val2_6_i_reg_615.read()) > sc_bigint<32>(p_Val2_3_2_i_reg_622.read()));
}

void correlateTop::thread_tmp_fu_370_p2() {
    tmp_fu_370_p2 = (!cor_phaseArray_phase_1_q0.read().is_01() || !cor_phaseArray_phase_10_q0.read().is_01())? sc_lv<32>(): (sc_biguint<32>(cor_phaseArray_phase_1_q0.read()) + sc_biguint<32>(cor_phaseArray_phase_10_q0.read()));
}

void correlateTop::thread_tmp_i_4_fu_474_p3() {
    tmp_i_4_fu_474_p3 = (!tmp_5_i_fu_462_p2.read()[0].is_01())? sc_lv<32>(): ((tmp_5_i_fu_462_p2.read()[0].to_bool())? p_Val2_9_i_fu_470_p2.read(): p_Val2_i_fu_466_p2.read());
}

void correlateTop::thread_tmp_i_fu_323_p1() {
    tmp_i_fu_323_p1 = esl_zext<64,4>(phaseClass_V.read());
}
...
void correlateTop::thread_ap_NS_fsm() {
  ...
  esl_seteq<1,1,1>(ap_const_logic_1, ap_reset_idle_pp0.read())) || (esl_seteq<1,1,1>(ap_block_pp0_stage1_flag00011011.read(), ap_const_boolean_0) && 
