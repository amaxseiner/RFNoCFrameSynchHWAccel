...
#ifndef __correlateTop_mul_rcU__HH__
#define __correlateTop_mul_rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(correlateTop_mul_rcU) {
    ...
    SC_CTOR(correlateTop_mul_rcU):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
