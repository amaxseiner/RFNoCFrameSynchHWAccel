...
#ifndef __correlator_mul_20bkb__HH__
#define __correlator_mul_20bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(correlator_mul_20bkb) {
    ...
    SC_CTOR(correlator_mul_20bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
