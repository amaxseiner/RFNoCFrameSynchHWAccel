...
correlator::correlator(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( currentState_load_reg_486 );
    sensitive << ( tmp_reg_490 );
    sensitive << ( cond_reg_499 );

    SC_METHOD(thread_ap_predicate_op99_write_state3);
    sensitive << ( ap_reg_pp0_iter1_currentState_load_reg_486 );
    sensitive << ( ap_reg_pp0_iter1_tmp_reg_490 );
    sensitive << ( ap_reg_pp0_iter1_cond_reg_499 );
    ...
    SC_METHOD(thread_cond_fu_191_p2);
    ...
    SC_METHOD(thread_p_Result_s_fu_464_p5);
    sensitive << ( p_Val2_3_4_reg_503 );

    SC_METHOD(thread_p_Val2_3_4_fu_383_p2);
    sensitive << ( tmp9_fu_377_p2 );
    sensitive << ( tmp6_fu_359_p2 );
    ...
    SC_METHOD(thread_tmp1_fu_365_p2);
    sensitive << ( phaseClass0_V_12 );
    sensitive << ( phaseClass0_V_9 );

    SC_METHOD(thread_tmp2_fu_371_p2);
    sensitive << ( phaseClass0_V_14 );
    sensitive << ( tmp_1_fu_181_p1 );

    SC_METHOD(thread_tmp6_fu_359_p2);
    sensitive << ( tmp8_fu_353_p2 );
    sensitive << ( tmp7_fu_347_p2 );

    SC_METHOD(thread_tmp7_fu_347_p2);
    sensitive << ( phaseClass0_V_1 );
    sensitive << ( phaseClass0_V_0 );

    SC_METHOD(thread_tmp8_fu_353_p2);
    sensitive << ( phaseClass0_V_7 );
    sensitive << ( phaseClass0_V_2 );

    SC_METHOD(thread_tmp9_fu_377_p2);
    sensitive << ( tmp2_fu_371_p2 );
    sensitive << ( tmp1_fu_365_p2 );
    ...
    sc_trace(mVcdFile, currentState_load_reg_486, "currentState_load_reg_486");
    sc_trace(mVcdFile, tmp_reg_490, "tmp_reg_490");
    sc_trace(mVcdFile, cond_reg_499, "cond_reg_499");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter2, "ap_enable_reg_pp0_iter2");
    sc_trace(mVcdFile, ap_reg_pp0_iter1_currentState_load_reg_486, "ap_reg_pp0_iter1_currentState_load_reg_486");
    sc_trace(mVcdFile, ap_reg_pp0_iter1_tmp_reg_490, "ap_reg_pp0_iter1_tmp_reg_490");
    sc_trace(mVcdFile, ap_reg_pp0_iter1_cond_reg_499, "ap_reg_pp0_iter1_cond_reg_499");
    ...
    sc_trace(mVcdFile, tmp_last_V_reg_494, "tmp_last_V_reg_494");
    sc_trace(mVcdFile, cond_fu_191_p2, "cond_fu_191_p2");
    sc_trace(mVcdFile, p_Val2_3_4_fu_383_p2, "p_Val2_3_4_fu_383_p2");
    sc_trace(mVcdFile, p_Val2_3_4_reg_503, "p_Val2_3_4_reg_503");
    sc_trace(mVcdFile, p_Result_s_fu_464_p5, "p_Result_s_fu_464_p5");
    sc_trace(mVcdFile, ap_block_pp0_stage0_subdone, "ap_block_pp0_stage0_subdone");
    sc_trace(mVcdFile, tmp_1_fu_181_p1, "tmp_1_fu_181_p1");
    sc_trace(mVcdFile, ap_block_pp0_stage0_01001, "ap_block_pp0_stage0_01001");
    sc_trace(mVcdFile, tmp8_fu_353_p2, "tmp8_fu_353_p2");
    sc_trace(mVcdFile, tmp7_fu_347_p2, "tmp7_fu_347_p2");
    sc_trace(mVcdFile, tmp2_fu_371_p2, "tmp2_fu_371_p2");
    sc_trace(mVcdFile, tmp1_fu_365_p2, "tmp1_fu_365_p2");
    sc_trace(mVcdFile, tmp9_fu_377_p2, "tmp9_fu_377_p2");
    sc_trace(mVcdFile, tmp6_fu_359_p2, "tmp6_fu_359_p2");
...
void correlator::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
              ...
              esl_seteq<1,1,1>(ap_const_lv1_0, currentState_load_load_fu_169_p1.read()) && 
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
             ...
             esl_seteq<1,1,1>(ap_const_lv1_1, tmp_nbreadreq_fu_124_p4.read()) && 
             esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
             esl_seteq<1,1,1>(ap_const_lv1_1, cond_fu_191_p2.read()))) {
            phaseClass0_V_0 = tmp_1_fu_181_p1.read();
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        ap_reg_pp0_iter1_cond_reg_499 = cond_reg_499.read();
        ap_reg_pp0_iter1_currentState_load_reg_486 = currentState_load_reg_486.read();
        ap_reg_pp0_iter1_tmp_reg_490 = tmp_reg_490.read();
        currentState_load_reg_486 = currentState.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op12_read_state1.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        cond_reg_499 = cond_fu_191_p2.read();
        tmp_last_V_reg_494 = i_data_TLAST.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_V_data_V_1_load_A.read())) {
        o_data_V_data_V_1_payload_A = p_Result_s_fu_464_p5.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_V_data_V_1_load_B.read())) {
        o_data_V_data_V_1_payload_B = p_Result_s_fu_464_p5.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_V_last_V_1_load_A.read())) {
        o_data_V_last_V_1_payload_A = tmp_last_V_reg_494.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, o_data_V_last_V_1_load_B.read())) {
        o_data_V_last_V_1_payload_B = tmp_last_V_reg_494.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, currentState.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_nbreadreq_fu_124_p4.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, cond_fu_191_p2.read()))) {
        p_Val2_3_4_reg_503 = p_Val2_3_4_fu_383_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, currentState.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_reg_490 = tmp_nbreadreq_fu_124_p4.read();
    }
}
...
void correlator::thread_ap_block_state2_io() {
    ap_block_state2_io = (esl_seteq<1,1,1>(ap_const_logic_0, o_data_V_data_V_1_ack_in.read()) && esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op74_write_state2.read()));
}
...
void correlator::thread_ap_block_state3_io() {
    ap_block_state3_io = (esl_seteq<1,1,1>(ap_const_logic_0, o_data_V_data_V_1_ack_in.read()) && esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op99_write_state3.read()));
}
...
void correlator::thread_ap_predicate_op12_read_state1() {
    ap_predicate_op12_read_state1 = (esl_seteq<1,1,1>(ap_const_lv1_1, currentState.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_nbreadreq_fu_124_p4.read()));
}

void correlator::thread_ap_predicate_op74_write_state2() {
    ap_predicate_op74_write_state2 = (esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_486.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_reg_490.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, cond_reg_499.read()));
}

void correlator::thread_ap_predicate_op99_write_state3() {
    ap_predicate_op99_write_state3 = (esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_currentState_load_reg_486.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_tmp_reg_490.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_cond_reg_499.read()));
}
...
void correlator::thread_cond_fu_191_p2() {
    cond_fu_191_p2 = (!phaseClass_V.read().is_01() || !ap_const_lv4_0.is_01())? sc_lv<1>(): sc_lv<1>(phaseClass_V.read() == ap_const_lv4_0);
}
...
void correlator::thread_o_data_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
          ...
          esl_seteq<1,1,1>(ap_const_lv1_1, currentState_load_reg_486.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, tmp_reg_490.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, cond_reg_499.read())) || 
         (esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_currentState_load_reg_486.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_tmp_reg_490.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, ap_reg_pp0_iter1_cond_reg_499.read())))) {
...
void correlator::thread_p_Result_s_fu_464_p5() {
    p_Result_s_fu_464_p5 = esl_partset<32,32,16,32,32>(ap_const_lv32_0, p_Val2_3_4_reg_503.read(), ap_const_lv32_0, ap_const_lv32_F);
}

void correlator::thread_p_Val2_3_4_fu_383_p2() {
    p_Val2_3_4_fu_383_p2 = (!tmp9_fu_377_p2.read().is_01() || !tmp6_fu_359_p2.read().is_01())? sc_lv<16>(): (sc_biguint<16>(tmp9_fu_377_p2.read()) + sc_biguint<16>(tmp6_fu_359_p2.read()));
}
...
void correlator::thread_tmp1_fu_365_p2() {
    tmp1_fu_365_p2 = (!phaseClass0_V_12.read().is_01() || !phaseClass0_V_9.read().is_01())? sc_lv<16>(): (sc_biguint<16>(phaseClass0_V_12.read()) + sc_biguint<16>(phaseClass0_V_9.read()));
}

void correlator::thread_tmp2_fu_371_p2() {
    tmp2_fu_371_p2 = (!phaseClass0_V_14.read().is_01() || !tmp_1_fu_181_p1.read().is_01())? sc_lv<16>(): (sc_biguint<16>(phaseClass0_V_14.read()) + sc_biguint<16>(tmp_1_fu_181_p1.read()));
}

void correlator::thread_tmp6_fu_359_p2() {
    tmp6_fu_359_p2 = (!tmp8_fu_353_p2.read().is_01() || !tmp7_fu_347_p2.read().is_01())? sc_lv<16>(): (sc_biguint<16>(tmp8_fu_353_p2.read()) + sc_biguint<16>(tmp7_fu_347_p2.read()));
}

void correlator::thread_tmp7_fu_347_p2() {
    tmp7_fu_347_p2 = (!phaseClass0_V_1.read().is_01() || !phaseClass0_V_0.read().is_01())? sc_lv<16>(): (sc_biguint<16>(phaseClass0_V_1.read()) + sc_biguint<16>(phaseClass0_V_0.read()));
}

void correlator::thread_tmp8_fu_353_p2() {
    tmp8_fu_353_p2 = (!phaseClass0_V_2.read().is_01() || !phaseClass0_V_7.read().is_01())? sc_lv<16>(): (sc_biguint<16>(phaseClass0_V_2.read()) + sc_biguint<16>(phaseClass0_V_7.read()));
}

void correlator::thread_tmp9_fu_377_p2() {
    tmp9_fu_377_p2 = (!tmp2_fu_371_p2.read().is_01() || !tmp1_fu_365_p2.read().is_01())? sc_lv<16>(): (sc_biguint<16>(tmp2_fu_371_p2.read()) + sc_biguint<16>(tmp1_fu_365_p2.read()));
}

void correlator::thread_tmp_1_fu_181_p1() {
    tmp_1_fu_181_p1 = i_data_TDATA.read().range(16-1, 0);
}
