...
struct correlator : public sc_module {
    ...
    sc_signal< sc_lv<2> > currentState_load_load_fu_164_p1;
    sc_signal< sc_lv<1> > tmp_nbreadreq_fu_130_p4;
    sc_signal< sc_logic > o_data_TDATA_blk_n;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< sc_lv<2> > currentState_load_reg_517;
    sc_signal< sc_lv<1> > tmp_reg_521;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<2> > ap_reg_pp0_iter1_currentState_load_reg_517;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_tmp_reg_521;
    sc_signal< sc_lv<4> > phaseClass_V_read_reg_508;
    ...
    sc_signal< sc_lv<1> > tmp_last_V_reg_525;
    sc_signal< sc_lv<32> > p_Result_s_fu_496_p5;
    ...
    void thread_currentState_load_load_fu_164_p1();
    ...
    void thread_p_Result_s_fu_496_p5();
