...
struct correlateTop : public sc_module {
    ...
    sc_signal< sc_lv<1> > currentState_load_reg_150;
    sc_signal< sc_lv<1> > tmp_reg_154;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_currentState_load_reg_150;
    ...
    sc_signal< bool > ap_predicate_op40_write_state3;
    sc_signal< bool > ap_block_state3_io;
    sc_signal< bool > ap_block_pp0_stage0_11001;
    sc_signal< sc_lv<32> > tmp_data_V_reg_158;
    sc_signal< sc_lv<1> > tmp_last_V_reg_163;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_lv<4> > tmp_5_fu_138_p2;
    ...
    void thread_ap_predicate_op40_write_state3();
