...
struct correlateTop : public sc_module {
    ...
    sc_signal< sc_lv<1> > currentState_load_load_fu_88_p1;
    sc_signal< sc_lv<1> > tmp_nbreadreq_fu_54_p4;
    sc_signal< sc_logic > o_data_TDATA_blk_n;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< sc_lv<1> > currentState_load_reg_147;
    sc_signal< sc_lv<1> > tmp_reg_151;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_currentState_load_reg_147;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_tmp_reg_151;
    ...
    sc_signal< sc_lv<1> > tmp_last_V_reg_155;
    sc_signal< sc_lv<32> > out_sample_data_V_fu_112_p2;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_lv<4> > tmp_5_fu_135_p2;
    ...
    void thread_currentState_load_load_fu_88_p1();
    ...
    void thread_out_sample_data_V_fu_112_p2();
