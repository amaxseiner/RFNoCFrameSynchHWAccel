...
.preheader1190.preheader:
  ...
  br i1 %corState_load, label %0, label %._crit_edge1452

; <label>:0                                       ; preds = %.preheader1190.preheader
  %corHelperI_V_load = load i32* @corHelperI_V, align 4
  switch i4 %phaseClass_V_read, label %._crit_edge1453 [
...
._crit_edge1452:                                  ; preds = %._crit_edge1453, %.preheader1190.preheader
  %corState_flag = phi i1 [ false, %._crit_edge1453 ], [ true, %.preheader1190.preheader ]
  br i1 %currentState_load, label %3, label %1

; <label>:1                                       ; preds = %._crit_edge1452
  br i1 %start_V_read, label %2, label %._crit_edge1487
...
; <label>:3                                       ; preds = %._crit_edge1452
  ...
  br i1 %tmp, label %4, label %._crit_edge1488
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_113 = trunc i32 %tmp_data_V_1 to i11
  %tmp_s = call i16 @_ssdm_op_BitConcatenate.i16.i11.i5(i11 %tmp_113, i5 0)
  store i16 %tmp_s, i16* @newVal_V, align 2
  switch i4 %phaseClass_V_read, label %._crit_edge1489 [
...
._crit_edge1488:                                  ; preds = %._crit_edge1489, %3
  %corState_flag_1 = phi i1 [ true, %._crit_edge1489 ], [ %corState_flag, %3 ]
  %corState_new_1 = phi i1 [ true, %._crit_edge1489 ], [ false, %3 ]
  store i1 true, i1* @currentState, align 1
  br label %._crit_edge1486

._crit_edge1486:                                  ; preds = %._crit_edge1488, %._crit_edge1487
  %corState_flag_2 = phi i1 [ %corState_flag_1, %._crit_edge1488 ], [ %corState_flag, %._crit_edge1487 ]
  %corState_new_2 = phi i1 [ %corState_new_1, %._crit_edge1488 ], [ false, %._crit_edge1487 ]
  br i1 %corState_flag_2, label %mergeST, label %._crit_edge1486.new
