...
; <label>:0                                       ; preds = %.preheader801.preheader
  br i1 %start_V_read, label %1, label %._crit_edge1060
...
; <label>:2                                       ; preds = %.preheader801.preheader
  ...
  br i1 %tmp, label %3, label %._crit_edge1061
...
.preheader658.0:                                  ; preds = %3
  ...
  %tmp8 = add i16 %phaseClass0_V_1_load, %phaseClass0_V_0_load
  %tmp9 = add i16 %phaseClass0_V_2_load, %phaseClass0_V_7_load
  %tmp7 = add i16 %tmp9, %tmp8
  %tmp1 = add i16 %corHelperI_V_load, %phaseClass0_V_14_loa
  %tmp2 = add i16 %phaseClass0_V_12_loa, %tmp_1
  %tmp3 = add i16 %tmp2, %phaseClass0_V_9_load
