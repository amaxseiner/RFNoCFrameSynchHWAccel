...
.preheader1204.preheader:
  ...
  br i1 %corState_load, label %0, label %._crit_edge1466

; <label>:0                                       ; preds = %.preheader1204.preheader
  %corHelperI_V_load = load i32* @corHelperI_V, align 4
  switch i4 %phaseClass_V_read, label %._crit_edge1467 [
    i4 0, label %.preheader1061.0
    i4 1, label %.preheader1060.0
    i4 2, label %.preheader1059.0
    i4 3, label %.preheader1058.0
    i4 4, label %.preheader1057.0
    i4 5, label %.preheader1056.0
    i4 6, label %.preheader1055.0
    i4 7, label %.preheader1054.0
    i4 -8, label %.preheader1053.0
    i4 -7, label %.preheader1052.0
    i4 -6, label %.preheader1051.0
    i4 -5, label %.preheader1050.0
    i4 -4, label %.preheader1049.0
    i4 -3, label %.preheader1048.0
    i4 -2, label %.preheader1047.0
    i4 -1, label %.preheader1046.0
  ]

.preheader1061.0:                                 ; preds = %0
...
.preheader1059.0:                                 ; preds = %0
  ...
  %tmp14 = add i32 %tmp_46_1_cast, %corHelperI_V_load
  %tmp15 = add i22 %tmp_46_cast, %tmp_46_3_cast
  %tmp34_cast = sext i22 %tmp15 to i32
  %tmp16 = add i32 %tmp14, %tmp34_cast
  %tmp17 = add i22 %tmp_7_cast, %tmp_46_7_cast
  %tmp36_cast = sext i22 %tmp17 to i24
  %tmp18 = add i22 %tmp_46_4_cast, %tmp_46_2_cast
  %tmp38_cast = sext i22 %tmp18 to i23
  %tmp19 = add i23 %tmp_46_5_cast, %tmp38_cast
  %tmp37_cast = sext i23 %tmp19 to i24
  %tmp20 = add i24 %tmp36_cast, %tmp37_cast
  %tmp35_cast = sext i24 %tmp20 to i32
  %p_Val2_8_4 = add i32 %tmp16, %tmp35_cast
...
.preheader1058.0:                                 ; preds = %0
  ...
  %tmp21 = add i32 %tmp_51_1_cast, %corHelperI_V_load
  %tmp22 = add i22 %tmp_51_cast, %tmp_51_3_cast
  %tmp47_cast = sext i22 %tmp22 to i32
  %tmp23 = add i32 %tmp21, %tmp47_cast
  %tmp24 = add i22 %tmp_9_cast, %tmp_51_7_cast
  %tmp49_cast = sext i22 %tmp24 to i24
  %tmp25 = add i22 %tmp_51_4_cast, %tmp_51_2_cast
  %tmp51_cast = sext i22 %tmp25 to i23
  %tmp26 = add i23 %tmp_51_5_cast, %tmp51_cast
  %tmp50_cast = sext i23 %tmp26 to i24
  %tmp27 = add i24 %tmp49_cast, %tmp50_cast
  %tmp48_cast = sext i24 %tmp27 to i32
  %p_Val2_11_4 = add i32 %tmp23, %tmp48_cast
...
.preheader1057.0:                                 ; preds = %0
  ...
  %tmp28 = add i32 %tmp_56_1_cast, %corHelperI_V_load
  %tmp29 = add i22 %tmp_56_cast, %tmp_56_3_cast
  %tmp60_cast = sext i22 %tmp29 to i32
  %tmp30 = add i32 %tmp28, %tmp60_cast
  %tmp31 = add i22 %tmp_11_cast, %tmp_56_7_cast
  %tmp62_cast = sext i22 %tmp31 to i24
  %tmp32 = add i22 %tmp_56_4_cast, %tmp_56_2_cast
  %tmp64_cast = sext i22 %tmp32 to i23
  %tmp33 = add i23 %tmp_56_5_cast, %tmp64_cast
  %tmp63_cast = sext i23 %tmp33 to i24
  %tmp34 = add i24 %tmp62_cast, %tmp63_cast
  %tmp61_cast = sext i24 %tmp34 to i32
  %p_Val2_14_4 = add i32 %tmp30, %tmp61_cast
...
.preheader1056.0:                                 ; preds = %0
  ...
  %tmp35 = add i32 %tmp_61_1_cast, %corHelperI_V_load
  %tmp36 = add i22 %tmp_61_cast, %tmp_61_3_cast
  %tmp73_cast = sext i22 %tmp36 to i32
  %tmp37 = add i32 %tmp35, %tmp73_cast
  %tmp38 = add i22 %tmp_13_cast, %tmp_61_7_cast
  %tmp75_cast = sext i22 %tmp38 to i24
  %tmp39 = add i22 %tmp_61_4_cast, %tmp_61_2_cast
  %tmp77_cast = sext i22 %tmp39 to i23
  %tmp40 = add i23 %tmp_61_5_cast, %tmp77_cast
  %tmp76_cast = sext i23 %tmp40 to i24
  %tmp41 = add i24 %tmp75_cast, %tmp76_cast
  %tmp74_cast = sext i24 %tmp41 to i32
  %p_Val2_17_4 = add i32 %tmp37, %tmp74_cast
...
.preheader1055.0:                                 ; preds = %0
  ...
  %tmp42 = add i32 %tmp_66_1_cast, %corHelperI_V_load
  %tmp43 = add i22 %tmp_66_cast, %tmp_66_3_cast
  %tmp86_cast = sext i22 %tmp43 to i32
  %tmp44 = add i32 %tmp42, %tmp86_cast
  %tmp45 = add i22 %tmp_15_cast, %tmp_66_7_cast
  %tmp88_cast = sext i22 %tmp45 to i24
  %tmp46 = add i22 %tmp_66_4_cast, %tmp_66_2_cast
  %tmp90_cast = sext i22 %tmp46 to i23
  %tmp47 = add i23 %tmp_66_5_cast, %tmp90_cast
  %tmp89_cast = sext i23 %tmp47 to i24
  %tmp48 = add i24 %tmp88_cast, %tmp89_cast
  %tmp87_cast = sext i24 %tmp48 to i32
  %p_Val2_20_4 = add i32 %tmp44, %tmp87_cast
...
.preheader1054.0:                                 ; preds = %0
  ...
  %tmp49 = add i32 %tmp_71_1_cast, %corHelperI_V_load
  %tmp50 = add i22 %tmp_71_cast, %tmp_71_3_cast
  %tmp99_cast = sext i22 %tmp50 to i32
  %tmp51 = add i32 %tmp49, %tmp99_cast
  %tmp52 = add i22 %tmp_17_cast, %tmp_71_7_cast
  %tmp101_cast = sext i22 %tmp52 to i24
  %tmp53 = add i22 %tmp_71_4_cast, %tmp_71_2_cast
  %tmp103_cast = sext i22 %tmp53 to i23
  %tmp54 = add i23 %tmp_71_5_cast, %tmp103_cast
  %tmp102_cast = sext i23 %tmp54 to i24
  %tmp55 = add i24 %tmp101_cast, %tmp102_cast
  %tmp100_cast = sext i24 %tmp55 to i32
  %p_Val2_23_4 = add i32 %tmp51, %tmp100_cast
...
.preheader1053.0:                                 ; preds = %0
  ...
  %tmp56 = add i32 %tmp_76_1_cast, %corHelperI_V_load
  %tmp57 = add i22 %tmp_76_cast, %tmp_76_3_cast
  %tmp112_cast = sext i22 %tmp57 to i32
  %tmp58 = add i32 %tmp56, %tmp112_cast
  %tmp59 = add i22 %tmp_19_cast, %tmp_76_7_cast
  %tmp114_cast = sext i22 %tmp59 to i24
  %tmp60 = add i22 %tmp_76_4_cast, %tmp_76_2_cast
  %tmp116_cast = sext i22 %tmp60 to i23
  %tmp61 = add i23 %tmp_76_5_cast, %tmp116_cast
  %tmp115_cast = sext i23 %tmp61 to i24
  %tmp62 = add i24 %tmp114_cast, %tmp115_cast
  %tmp113_cast = sext i24 %tmp62 to i32
  %p_Val2_26_4 = add i32 %tmp58, %tmp113_cast
...
.preheader1052.0:                                 ; preds = %0
  ...
  %tmp63 = add i32 %tmp_81_1_cast, %corHelperI_V_load
  %tmp64 = add i22 %tmp_81_cast, %tmp_81_3_cast
  %tmp125_cast = sext i22 %tmp64 to i32
  %tmp65 = add i32 %tmp63, %tmp125_cast
  %tmp66 = add i22 %tmp_21_cast, %tmp_81_7_cast
  %tmp127_cast = sext i22 %tmp66 to i24
  %tmp67 = add i22 %tmp_81_4_cast, %tmp_81_2_cast
  %tmp129_cast = sext i22 %tmp67 to i23
  %tmp68 = add i23 %tmp_81_5_cast, %tmp129_cast
  %tmp128_cast = sext i23 %tmp68 to i24
  %tmp69 = add i24 %tmp127_cast, %tmp128_cast
  %tmp126_cast = sext i24 %tmp69 to i32
  %p_Val2_29_4 = add i32 %tmp65, %tmp126_cast
...
.preheader1051.0:                                 ; preds = %0
  ...
  %tmp70 = add i32 %tmp_86_1_cast, %corHelperI_V_load
  %tmp71 = add i22 %tmp_86_cast, %tmp_86_3_cast
  %tmp138_cast = sext i22 %tmp71 to i32
  %tmp72 = add i32 %tmp70, %tmp138_cast
  %tmp73 = add i22 %tmp_23_cast, %tmp_86_7_cast
  %tmp140_cast = sext i22 %tmp73 to i24
  %tmp74 = add i22 %tmp_86_4_cast, %tmp_86_2_cast
  %tmp142_cast = sext i22 %tmp74 to i23
  %tmp75 = add i23 %tmp_86_5_cast, %tmp142_cast
  %tmp141_cast = sext i23 %tmp75 to i24
  %tmp76 = add i24 %tmp140_cast, %tmp141_cast
  %tmp139_cast = sext i24 %tmp76 to i32
  %p_Val2_32_4 = add i32 %tmp72, %tmp139_cast
...
.preheader1050.0:                                 ; preds = %0
  ...
  %tmp77 = add i32 %tmp_91_1_cast, %corHelperI_V_load
  %tmp78 = add i22 %tmp_91_cast, %tmp_91_3_cast
  %tmp151_cast = sext i22 %tmp78 to i32
  %tmp79 = add i32 %tmp77, %tmp151_cast
  %tmp80 = add i22 %tmp_25_cast, %tmp_91_7_cast
  %tmp153_cast = sext i22 %tmp80 to i24
  %tmp81 = add i22 %tmp_91_4_cast, %tmp_91_2_cast
  %tmp155_cast = sext i22 %tmp81 to i23
  %tmp82 = add i23 %tmp_91_5_cast, %tmp155_cast
  %tmp154_cast = sext i23 %tmp82 to i24
  %tmp83 = add i24 %tmp153_cast, %tmp154_cast
  %tmp152_cast = sext i24 %tmp83 to i32
  %p_Val2_35_4 = add i32 %tmp79, %tmp152_cast
...
.preheader1049.0:                                 ; preds = %0
  ...
  %tmp84 = add i32 %tmp_96_1_cast, %corHelperI_V_load
  %tmp85 = add i22 %tmp_96_cast, %tmp_96_3_cast
  %tmp164_cast = sext i22 %tmp85 to i32
  %tmp86 = add i32 %tmp84, %tmp164_cast
  %tmp87 = add i22 %tmp_27_cast, %tmp_96_7_cast
  %tmp166_cast = sext i22 %tmp87 to i24
  %tmp88 = add i22 %tmp_96_4_cast, %tmp_96_2_cast
  %tmp168_cast = sext i22 %tmp88 to i23
  %tmp89 = add i23 %tmp_96_5_cast, %tmp168_cast
  %tmp167_cast = sext i23 %tmp89 to i24
  %tmp90 = add i24 %tmp166_cast, %tmp167_cast
  %tmp165_cast = sext i24 %tmp90 to i32
  %p_Val2_38_4 = add i32 %tmp86, %tmp165_cast
...
.preheader1048.0:                                 ; preds = %0
  ...
  %tmp91 = add i32 %tmp_101_1_cast, %corHelperI_V_load
  %tmp92 = add i22 %tmp_101_cast, %tmp_101_3_cast
  %tmp177_cast = sext i22 %tmp92 to i32
  %tmp93 = add i32 %tmp91, %tmp177_cast
  %tmp94 = add i22 %tmp_29_cast, %tmp_101_7_cast
  %tmp179_cast = sext i22 %tmp94 to i24
  %tmp95 = add i22 %tmp_101_4_cast, %tmp_101_2_cast
  %tmp181_cast = sext i22 %tmp95 to i23
  %tmp96 = add i23 %tmp_101_5_cast, %tmp181_cast
  %tmp180_cast = sext i23 %tmp96 to i24
  %tmp97 = add i24 %tmp179_cast, %tmp180_cast
  %tmp178_cast = sext i24 %tmp97 to i32
  %p_Val2_41_4 = add i32 %tmp93, %tmp178_cast
...
.preheader1047.0:                                 ; preds = %0
  ...
  %tmp98 = add i32 %tmp_106_1_cast, %corHelperI_V_load
  %tmp99 = add i22 %tmp_106_cast, %tmp_106_3_cast
  %tmp190_cast = sext i22 %tmp99 to i32
  %tmp100 = add i32 %tmp98, %tmp190_cast
  %tmp101 = add i22 %tmp_31_cast, %tmp_106_7_cast
  %tmp192_cast = sext i22 %tmp101 to i24
  %tmp102 = add i22 %tmp_106_4_cast, %tmp_106_2_cast
  %tmp194_cast = sext i22 %tmp102 to i23
  %tmp103 = add i23 %tmp_106_5_cast, %tmp194_cast
  %tmp193_cast = sext i23 %tmp103 to i24
  %tmp104 = add i24 %tmp192_cast, %tmp193_cast
  %tmp191_cast = sext i24 %tmp104 to i32
  %p_Val2_44_4 = add i32 %tmp100, %tmp191_cast
...
.preheader1046.0:                                 ; preds = %0
  ...
  %tmp105 = add i32 %tmp_111_1_cast, %corHelperI_V_load
  %tmp106 = add i22 %tmp_111_cast, %tmp_111_3_cast
  %tmp203_cast = sext i22 %tmp106 to i32
  %tmp107 = add i32 %tmp105, %tmp203_cast
  %tmp108 = add i22 %tmp_33_cast, %tmp_111_7_cast
  %tmp205_cast = sext i22 %tmp108 to i24
  %tmp109 = add i22 %tmp_111_4_cast, %tmp_111_2_cast
  %tmp207_cast = sext i22 %tmp109 to i23
  %tmp110 = add i23 %tmp_111_5_cast, %tmp207_cast
  %tmp206_cast = sext i23 %tmp110 to i24
  %tmp111 = add i24 %tmp205_cast, %tmp206_cast
  %tmp204_cast = sext i24 %tmp111 to i32
  %p_Val2_47_4 = add i32 %tmp107, %tmp204_cast
  store i32 %p_Val2_47_4, i32* @corHelperI_V, align 4
  store i32 %p_Val2_47_4, i32* @Phase15_V_0, align 16
  br label %._crit_edge1467

._crit_edge1467:                                  ; preds = %.preheader1046.0, %.preheader1047.0, %.preheader1048.0, %.preheader1049.0, %.preheader1050.0, %.preheader1051.0, %.preheader1052.0, %.preheader1053.0, %.preheader1054.0, %.preheader1055.0, %.preheader1056.0, %.preheader1057.0, %.preheader1058.0, %.preheader1059.0, %.preheader1060.0, %.preheader1061.0, %0
  br label %._crit_edge1466

._crit_edge1466:                                  ; preds = %._crit_edge1467, %.preheader1204.preheader
  %corState_flag = phi i1 [ false, %._crit_edge1467 ], [ true, %.preheader1204.preheader ]
  br i1 %currentState_load, label %3, label %1

; <label>:1                                       ; preds = %._crit_edge1466
  br i1 %start_V_read, label %2, label %._crit_edge1501

; <label>:2                                       ; preds = %1
  store i1 true, i1* @currentState, align 1
  br label %._crit_edge1501

._crit_edge1501:                                  ; preds = %2, %1
  br label %._crit_edge1500

; <label>:3                                       ; preds = %._crit_edge1466
  ...
  switch i4 %phaseClass_V_read, label %._crit_edge1502 [
    i4 0, label %.preheader1045.0
    i4 1, label %.preheader1044.0
    i4 2, label %.preheader1043.0
    i4 3, label %.preheader1042.0
    i4 4, label %.preheader1041.0
    i4 5, label %.preheader1040.0
    i4 6, label %.preheader1039.0
    i4 7, label %.preheader1038.0
    i4 -8, label %.preheader1037.0
    i4 -7, label %.preheader1036.0
    i4 -6, label %.preheader1035.0
    i4 -5, label %.preheader1034.0
    i4 -4, label %.preheader1033.0
    i4 -3, label %.preheader1032.0
    i4 -2, label %.preheader1031.0
    i4 -1, label %.preheader.0
  ]

.preheader1045.0:                                 ; preds = %3
...
._crit_edge1502:                                  ; preds = %.preheader.0, %.preheader1031.0, %.preheader1032.0, %.preheader1033.0, %.preheader1034.0, %.preheader1035.0, %.preheader1036.0, %.preheader1037.0, %.preheader1038.0, %.preheader1039.0, %.preheader1040.0, %.preheader1041.0, %.preheader1042.0, %.preheader1043.0, %.preheader1044.0, %.preheader1045.0, %3
...
._crit_edge1500:                                  ; preds = %._crit_edge1502, %._crit_edge1501
  %corState_flag_1 = phi i1 [ true, %._crit_edge1502 ], [ %corState_flag, %._crit_edge1501 ]
  %corState_new_1 = phi i1 [ true, %._crit_edge1502 ], [ false, %._crit_edge1501 ]
  br i1 %corState_flag_1, label %mergeST, label %._crit_edge1500.new

mergeST:                                          ; preds = %._crit_edge1500
  store i1 %corState_new_1, i1* @corState, align 1
  br label %._crit_edge1500.new

._crit_edge1500.new:                              ; preds = %mergeST, %._crit_edge1500
  ret void
}
...
!opencl.kernels = !{!0, !7, !7, !13, !13, !19, !22, !28, !28, !30, !13, !13, !13, !33, !33, !35, !35, !35, !37, !37, !13, !13, !13, !13, !39, !39, !41, !41, !13, !13, !43, !13, !45, !47, !50, !52, !54, !55, !58, !58, !64, !67, !13, !69, !69, !69, !71, !73, !43, !43, !74, !74, !13, !13, !76, !78, !13, !13, !13, !13, !13, !13, !13, !13, !13, !79, !79, !13, !13, !13, !13, !13, !13, !13, !13, !13, !13, !13, !13}
!hls.encrypted.func = !{}
!llvm.map.gv = !{!80}
...
!48 = metadata !{metadata !"kernel_arg_type", metadata !"const struct rfnoc_axis &"}
!49 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!50 = metadata !{null, metadata !8, metadata !9, metadata !51, metadata !11, metadata !21, metadata !6}
!51 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<1> &"}
!52 = metadata !{null, metadata !8, metadata !9, metadata !36, metadata !11, metadata !53, metadata !6}
!53 = metadata !{metadata !"kernel_arg_name", metadata !"val"}
!54 = metadata !{null, metadata !8, metadata !9, metadata !40, metadata !11, metadata !53, metadata !6}
!55 = metadata !{null, metadata !23, metadata !24, metadata !56, metadata !26, metadata !57, metadata !6}
!56 = metadata !{metadata !"kernel_arg_type", metadata !"int", metadata !"int"}
!57 = metadata !{metadata !"kernel_arg_name", metadata !"Hi", metadata !"Lo"}
!58 = metadata !{null, metadata !59, metadata !60, metadata !61, metadata !62, metadata !63, metadata !6}
!59 = metadata !{metadata !"kernel_arg_addr_space", i32 1, i32 0, i32 0}
...
!63 = metadata !{metadata !"kernel_arg_name", metadata !"bv", metadata !"h", metadata !"l"}
...
!67 = metadata !{null, metadata !8, metadata !9, metadata !48, metadata !11, metadata !68, metadata !6}
...
!70 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_fixed_base<33, 23, true, (enum ap_q_mode)5, (enum ap_o_mode)3, 0> &"}
...
!73 = metadata !{null, metadata !8, metadata !9, metadata !44, metadata !11, metadata !21, metadata !6}
!74 = metadata !{null, metadata !8, metadata !9, metadata !75, metadata !11, metadata !12, metadata !6}
!75 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_fixed_base<32, 22, true, (enum ap_q_mode)5, (enum ap_o_mode)3, 0> &"}
!76 = metadata !{null, metadata !23, metadata !24, metadata !77, metadata !26, metadata !32, metadata !6}
!77 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<1, false> &", metadata !"int"}
!78 = metadata !{null, metadata !8, metadata !9, metadata !34, metadata !11, metadata !21, metadata !6}
!79 = metadata !{null, metadata !8, metadata !9, metadata !29, metadata !11, metadata !53, metadata !6}
