...
.preheader1176.preheader:
  ...
  br i1 %corState_load, label %0, label %._crit_edge1429

; <label>:0                                       ; preds = %.preheader1176.preheader
  %corHelperI_V_load = load i32* @corHelperI_V, align 4
  switch i4 %phaseClass_V_read, label %._crit_edge1430 [
    i4 0, label %.preheader1033.0
    i4 1, label %.preheader1032.0
    i4 2, label %.preheader1031.0
    i4 3, label %.preheader1030.0
    i4 4, label %.preheader1029.0
    i4 5, label %.preheader1028.0
    i4 6, label %.preheader1027.0
    i4 7, label %.preheader1026.0
    i4 -8, label %.preheader1025.0
    i4 -7, label %.preheader1024.0
    i4 -6, label %.preheader1023.0
    i4 -5, label %.preheader1022.0
    i4 -4, label %.preheader1021.0
    i4 -3, label %.preheader1020.0
    i4 -2, label %.preheader1019.0
    i4 -1, label %.preheader1018.0
  ]
...
._crit_edge1430:                                  ; preds = %.preheader1018.0, %.preheader1019.0, %.preheader1020.0, %.preheader1021.0, %.preheader1022.0, %.preheader1023.0, %.preheader1024.0, %.preheader1025.0, %.preheader1026.0, %.preheader1027.0, %.preheader1028.0, %.preheader1029.0, %.preheader1030.0, %.preheader1031.0, %.preheader1032.0, %.preheader1033.0, %0
  br label %._crit_edge1429

._crit_edge1429:                                  ; preds = %._crit_edge1430, %.preheader1176.preheader
  %corState_flag = phi i1 [ false, %._crit_edge1430 ], [ true, %.preheader1176.preheader ]
  br i1 %currentState_load, label %3, label %1

; <label>:1                                       ; preds = %._crit_edge1429
  br i1 %start_V_read, label %2, label %._crit_edge1464

; <label>:2                                       ; preds = %1
  store i1 true, i1* @currentState, align 1
  br label %._crit_edge1464

._crit_edge1464:                                  ; preds = %2, %1
  br label %._crit_edge1463

; <label>:3                                       ; preds = %._crit_edge1429
  %tmp = call i1 @_ssdm_op_NbReadReq.axis.i32P.i1P(i32* %i_data_V_data_V, i1* %i_data_V_last_V, i32 1)
  br i1 %tmp, label %4, label %._crit_edge1465
...
; <label>:4                                       ; preds = %3
  ...
  switch i4 %phaseClass_V_read, label %._crit_edge1466 [
    i4 0, label %.preheader1017.0
    i4 1, label %.preheader1016.0
    i4 2, label %.preheader1015.0
    i4 3, label %.preheader1014.0
    i4 4, label %.preheader1013.0
    i4 5, label %.preheader1012.0
    i4 6, label %.preheader1011.0
    i4 7, label %.preheader1010.0
    i4 -8, label %.preheader1009.0
    i4 -7, label %.preheader1008.0
    i4 -6, label %.preheader1007.0
    i4 -5, label %.preheader1006.0
    i4 -4, label %.preheader1005.0
    i4 -3, label %.preheader1004.0
    i4 -2, label %.preheader1003.0
...
._crit_edge1466:                                  ; preds = %.preheader.0, %.preheader1003.0, %.preheader1004.0, %.preheader1005.0, %.preheader1006.0, %.preheader1007.0, %.preheader1008.0, %.preheader1009.0, %.preheader1010.0, %.preheader1011.0, %.preheader1012.0, %.preheader1013.0, %.preheader1014.0, %.preheader1015.0, %.preheader1016.0, %.preheader1017.0, %4
...
._crit_edge1465:                                  ; preds = %._crit_edge1466, %3
  %corState_flag_1 = phi i1 [ true, %._crit_edge1466 ], [ %corState_flag, %3 ]
  %corState_new_1 = phi i1 [ true, %._crit_edge1466 ], [ false, %3 ]
  store i1 true, i1* @currentState, align 1
  br label %._crit_edge1463

._crit_edge1463:                                  ; preds = %._crit_edge1465, %._crit_edge1464
  %corState_flag_2 = phi i1 [ %corState_flag_1, %._crit_edge1465 ], [ %corState_flag, %._crit_edge1464 ]
  %corState_new_2 = phi i1 [ %corState_new_1, %._crit_edge1465 ], [ false, %._crit_edge1464 ]
  br i1 %corState_flag_2, label %mergeST, label %._crit_edge1463.new

mergeST:                                          ; preds = %._crit_edge1463
  store i1 %corState_new_2, i1* @corState, align 1
  br label %._crit_edge1463.new

._crit_edge1463.new:                              ; preds = %mergeST, %._crit_edge1463
  ret void
}
...
!opencl.kernels = !{!0, !7, !7, !13, !13, !19, !25, !25, !27, !13, !13, !13, !30, !30, !32, !35, !35, !35, !37, !37, !13, !13, !13, !13, !39, !39, !41, !41, !13, !13, !43, !13, !45, !47, !50, !50, !56, !59, !61, !64, !13, !13, !66, !66, !66, !68, !70, !43, !43, !71, !71, !13, !13, !73, !75, !13, !13, !13, !13, !13, !13, !13, !13, !13, !76, !76, !13, !13, !13, !13, !13, !13, !13, !13, !13, !13, !13, !13}
!hls.encrypted.func = !{}
!llvm.map.gv = !{!78}
...
!22 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<32, true> &", metadata !"int"}
...
!27 = metadata !{null, metadata !20, metadata !21, metadata !28, metadata !23, metadata !29, metadata !6}
!28 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<32, true> &", metadata !"const ap_int_base<32, true> &"}
...
!47 = metadata !{null, metadata !20, metadata !21, metadata !48, metadata !23, metadata !49, metadata !6}
...
!53 = metadata !{metadata !"kernel_arg_type", metadata !"ap_int_base<32, true>*", metadata !"int", metadata !"int"}
...
!64 = metadata !{null, metadata !8, metadata !9, metadata !57, metadata !11, metadata !65, metadata !6}
...
!67 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_fixed_base<33, 23, true, (enum ap_q_mode)5, (enum ap_o_mode)3, 0> &"}
...
!70 = metadata !{null, metadata !8, metadata !9, metadata !44, metadata !11, metadata !34, metadata !6}
!71 = metadata !{null, metadata !8, metadata !9, metadata !72, metadata !11, metadata !12, metadata !6}
!72 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_fixed_base<32, 22, true, (enum ap_q_mode)5, (enum ap_o_mode)3, 0> &"}
!73 = metadata !{null, metadata !20, metadata !21, metadata !74, metadata !23, metadata !29, metadata !6}
!74 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<1, false> &", metadata !"int"}
!75 = metadata !{null, metadata !8, metadata !9, metadata !31, metadata !11, metadata !34, metadata !6}
!76 = metadata !{null, metadata !8, metadata !9, metadata !26, metadata !11, metadata !77, metadata !6}
